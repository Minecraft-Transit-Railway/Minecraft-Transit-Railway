...
public class MTRClient implements IPacket {
	...
	public static void init() {
		if (!Keys.LIFTS_ONLY) {
			...
			RegistryClient.registerTileEntityRenderer(BlockEntityTypes.SPIDS_1_TILE_ENTITY.get(), dispatcher -> new RenderPIDS<>(dispatcher, BlockSPIDS1.TileEntityBlockSPIDS1.MAX_ARRIVALS, BlockSPIDS1.TileEntityBlockSPIDS1.LINES_PER_ARRIVAL, 2F, 14F, 15, 28F, 12, false, false, PIDSType.SPIDS, 0xFF9900, 0xFF9900));
