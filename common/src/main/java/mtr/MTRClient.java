...
public class MTRClient implements IPacket {
	...
	public static void init() {
		...
		RegistryClient.registerNetworkReceiver(PACKET_OPEN_COMPANY_DASHBOARD_SCREEN, packet -> PacketTrainDataGuiClient.openCompanyDashboardScreenS2C(Minecraft.getInstance(), packet));
		...
		RegistryClient.registerNetworkReceiver(PACKET_UPDATE_COMPANY, packet -> PacketTrainDataGuiClient.receiveUpdateOrDeleteS2C(Minecraft.getInstance(), packet, ClientData.COMPANIES, ClientData.DATA_CACHE.companyIdMap, (id, transportMode) -> new Company(id), false));
		...
		RegistryClient.registerNetworkReceiver(PACKET_DELETE_COMPANY, packet -> PacketTrainDataGuiClient.receiveUpdateOrDeleteS2C(Minecraft.getInstance(), packet, ClientData.COMPANIES, ClientData.DATA_CACHE.companyIdMap, (id, transportMode) -> new Company(id), true));
