...
public interface Blocks {
	...
	RegistryObject<Block> APG_DOOR = new RegistryObject<>(() -> new BlockAPGDoor());
	RegistryObject<Block> APG_GLASS = new RegistryObject<>(() -> new BlockAPGGlass());
	RegistryObject<Block> APG_GLASS_END = new RegistryObject<>(() -> new BlockAPGGlassEnd());
	RegistryObject<Block> ARRIVAL_PROJECTOR_1_SMALL = new RegistryObject<>(() -> new BlockArrivalProjector1Small());
	RegistryObject<Block> ARRIVAL_PROJECTOR_1_MEDIUM = new RegistryObject<>(() -> new BlockArrivalProjector1Medium());
	RegistryObject<Block> ARRIVAL_PROJECTOR_1_LARGE = new RegistryObject<>(() -> new BlockArrivalProjector1Large());
	...
	RegistryObject<Block> ESCALATOR_SIDE = new RegistryObject<>(() -> new BlockEscalatorSide());
	RegistryObject<Block> ESCALATOR_STEP = new RegistryObject<>(() -> new BlockEscalatorStep());
	RegistryObject<Block> GLASS_FENCE_CIO = new RegistryObject<>(() -> new BlockGlassFence());
	RegistryObject<Block> GLASS_FENCE_CKT = new RegistryObject<>(() -> new BlockGlassFence());
	RegistryObject<Block> GLASS_FENCE_HEO = new RegistryObject<>(() -> new BlockGlassFence());
	RegistryObject<Block> GLASS_FENCE_MOS = new RegistryObject<>(() -> new BlockGlassFence());
	RegistryObject<Block> GLASS_FENCE_PLAIN = new RegistryObject<>(() -> new BlockGlassFence());
	RegistryObject<Block> GLASS_FENCE_SHM = new RegistryObject<>(() -> new BlockGlassFence());
	RegistryObject<Block> GLASS_FENCE_STAINED = new RegistryObject<>(() -> new BlockGlassFence());
	RegistryObject<Block> GLASS_FENCE_STW = new RegistryObject<>(() -> new BlockGlassFence());
	RegistryObject<Block> GLASS_FENCE_TSH = new RegistryObject<>(() -> new BlockGlassFence());
	RegistryObject<Block> GLASS_FENCE_WKS = new RegistryObject<>(() -> new BlockGlassFence());
	...
	RegistryObject<Block> PSD_TOP = new RegistryObject<>(() -> new BlockPSDTop());
	RegistryObject<Block> RAIL_NODE = new RegistryObject<>(() -> new BlockNode(TransportMode.TRAIN));
	RegistryObject<Block> BOAT_NODE = new RegistryObject<>(() -> new BlockNode.BlockBoatNode());
