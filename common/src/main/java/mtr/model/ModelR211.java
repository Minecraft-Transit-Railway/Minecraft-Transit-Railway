...
public class ModelR211 extends ModelTrainBase {
    ...
    private final ModelMapper handrail_up_8_r1;
    private final ModelMapper handrail_up_7_r1;
    ...
    private final ModelMapper door_edge_1_r1;
    ...
    public ModelR211(boolean OpenGangway) {
        ...
        headrail_right.setPos(-39.95F, -9.875F, 34.6F);
        window_handrails.addChild(headrail_right);
        headrail_right.texOffs(359, 30).addBox(28.3078F, -15.1636F, -10.2F, 0, 19, 0, 0.2F, false);
        ...
        handrail_right_3_r1.texOffs(343, 0).addBox(4, -5, 1.6F, 0, 0, 0, 0.2F, false);
        ...
        handrail_right_1_r1.texOffs(343, 0).addBox(-1, 0, 0, 3, 0, 0, 0.2F, false);
        ...
        handrail_turn_4_r1.texOffs(343, 0).addBox(0, 0, 0, 0, 0, 0, 0.2F, false);
        ...
        handrail_turn_3_r1.texOffs(343, 0).addBox(0, 0, -1, 0, 0, 2, 0.2F, false);
        ...
        handrail_turn_2_r1.texOffs(343, 0).addBox(0, 0, 0, 0, 0, 0, 0.2F, false);

        handrail_turn_1_r1 = new ModelMapper(modelDataWrapper);
        handrail_turn_1_r1.setPos(27.25F, -21.4912F, -11.9782F);
        headrail_right.addChild(handrail_turn_1_r1);
        setRotationAngle(handrail_turn_1_r1, -0.6584F, 0.1103F, -0.0706F);
        handrail_turn_1_r1.texOffs(343, 0).addBox(0, 0, -0.5F, 0, 0, 1, 0.2F, false);

        headrail_left = new ModelMapper(modelDataWrapper);
        headrail_left.setPos(-39.95F, -9.875F, 41.6F);
        window_handrails.addChild(headrail_left);
        headrail_left.texOffs(359, 30).addBox(28.3078F, -15.1636F, -66, 0, 19, 0, 0.2F, false);
        ...
        handrail_left_3_r1.texOffs(343, 0).addBox(4, -5, -1.6F, 0, 0, 0, 0.2F, false);
        ...
        handrail_left_1_r1.texOffs(343, 0).addBox(-1, 0, 0, 3, 0, 0, 0.2F, false);
        ...
        handrail_turn_4_r2.texOffs(343, 0).addBox(0, 0, 0, 0, 0, 0, 0.2F, false);
        ...
        handrail_turn_3_r2.texOffs(343, 0).addBox(0, 0, -1, 0, 0, 2, 0.2F, false);
        ...
        handrail_turn_2_r2.texOffs(343, 0).addBox(0, 0, 0, 0, 0, 0, 0.2F, false);

        handrail_turn_1_r2 = new ModelMapper(modelDataWrapper);
        handrail_turn_1_r2.setPos(27.25F, -21.4912F, -64.2218F);
        headrail_left.addChild(handrail_turn_1_r2);
        setRotationAngle(handrail_turn_1_r2, 0.6584F, -0.1103F, -0.0706F);
        handrail_turn_1_r2.texOffs(343, 0).addBox(0, 0, -0.5F, 0, 0, 1, 0.2F, false);

        seat = new ModelMapper(modelDataWrapper);
        seat.setPos(0, 0, 0.75F);
        window_handrails.addChild(seat);
        seat.texOffs(122, 168).addBox(-19.9F, -10.75F, -24.75F, 2, 5, 48, 0, false);
        seat.texOffs(175, 174).addBox(-19.55F, -6, -24.25F, 3, 4, 47, 0, false);

        seat_bottom_r1 = new ModelMapper(modelDataWrapper);
        seat_bottom_r1.setPos(0, -1.75F, 1.75F);
        ...
        seat_back_3_r1.setPos(-17.9F, -10.75F, 1.75F);
        ...
        handrail_top_1_r1.texOffs(359, 30).addBox(0, -22, 0, 0, 44, 0, 0.2F, false);

        handrail_mid = new ModelMapper(modelDataWrapper);
        handrail_mid.setPos(-39.95F, -9.875F, 32.35F);
        handrail_window.addChild(handrail_mid);
        handrail_mid.texOffs(343, 0).addBox(23.5101F, 5.4649F, -38.1F, 5, 0, 0, 0.2F, false);
        handrail_mid.texOffs(359, 30).addBox(29.5F, -13.525F, -38.1F, 0, 18, 0, 0.2F, false);

        handrail_middle_4_r1 = new ModelMapper(modelDataWrapper);
        handrail_middle_4_r1.setPos(27.0309F, -18.5313F, -38.1F);
        handrail_mid.addChild(handrail_middle_4_r1);
        setRotationAngle(handrail_middle_4_r1, 0, 0, -0.4102F);
        handrail_middle_4_r1.texOffs(359, 27).addBox(1.5F, -3, 0, 0, 3, 0, 0.2F, false);
        ...
        handrail_middle_3_r1.texOffs(342, 0).addBox(-5.2F, 0.2F, 0, 5, 0, 0, 0.2F, false);

        handrail_turn_1_r3 = new ModelMapper(modelDataWrapper);
        handrail_turn_1_r3.setPos(29.7F, 4.675F, -38.3F);
        handrail_mid.addChild(handrail_turn_1_r3);
        setRotationAngle(handrail_turn_1_r3, 0, -1.5708F, 2.3562F);
        handrail_turn_1_r3.texOffs(343, 0).addBox(0.2F, 0.2F, -1.2F, 0, 0, 1, 0.2F, false);

        headrail_up = new ModelMapper(modelDataWrapper);
        headrail_up.setPos(-40.95F, -12.875F, 38.1F);
        handrail_window.addChild(headrail_up);
        headrail_up.texOffs(343, 0).addBox(30.35F, -22.375F, -16.3F, 0, 1, 0, 0.2F, false);
        headrail_up.texOffs(355, 0).addBox(30.35F, -22.375F, -59.9F, 0, 1, 0, 0.2F, false);
        headrail_up.texOffs(359, 28).addBox(30.35F, -22.375F, -38.1F, 0, 1, 0, 0.2F, false);

        handrail_up_8_r1 = new ModelMapper(modelDataWrapper);
        handrail_up_8_r1.setPos(37.479F, -8.7545F, -29.4F);
        headrail_up.addChild(handrail_up_8_r1);
        setRotationAngle(handrail_up_8_r1, 0, 0, 0.6109F);
        handrail_up_8_r1.texOffs(359, 28).addBox(-13, -6, -8.7F, 0, 1, 0, 0.2F, false);
        handrail_up_8_r1.texOffs(343, 0).addBox(-13, -6, -30.5F, 0, 1, 0, 0.2F, false);
        handrail_up_8_r1.texOffs(343, 0).addBox(-13, -6, 13.1F, 0, 1, 0, 0.2F, false);

        handrail_up_7_r1 = new ModelMapper(modelDataWrapper);
        handrail_up_7_r1.setPos(34.65F, -6.875F, -29.4F);
        headrail_up.addChild(handrail_up_7_r1);
        setRotationAngle(handrail_up_7_r1, 0, 0, 0.7854F);
        handrail_up_7_r1.texOffs(359, 28).addBox(-13, -6, -8.7F, 0, 2, 0, 0.2F, false);
        handrail_up_7_r1.texOffs(343, 0).addBox(-13, -6, -30.5F, 0, 2, 0, 0.2F, false);
        handrail_up_7_r1.texOffs(343, 0).addBox(-13, -6, 13.1F, 0, 2, 0, 0.2F, false);
        ...
        side_panel.texOffs(0, 0).addBox(-20, -32, 0, 9, 29, 0, 0, false);
        ...
        end.texOffs(122, 167).addBox(-20.3159F, -34, -8, 3, 21, 16, 0, false);
        end.texOffs(122, 167).addBox(17.3049F, -33.885F, -8, 3, 21, 16, 0, true);
        ...
        door_edge_4_r1.setPos(-33.9288F, -14.3589F, 15.5F);
        door.addChild(door_edge_4_r1);
        setRotationAngle(door_edge_4_r1, 0, 1.5708F, 0.1047F);
        door_edge_4_r1.texOffs(0, 90).addBox(0.5F, -21, 13, 2, 21, 2, 0, false);
        ...
        door_edge_1_r1 = new ModelMapper(modelDataWrapper);
        door_edge_1_r1.setPos(-31.8367F, -24.6968F, -14);
        door.addChild(door_edge_1_r1);
        setRotationAngle(door_edge_1_r1, 0, 1.5708F, 0.1047F);
        door_edge_1_r1.texOffs(0, 90).addBox(-1, -10.5F, 12, 2, 21, 2, 0, true);
        ...
        door_side_top_2_r1.setPos(-17.9149F, -32.7859F, 0);
        door_sides.addChild(door_side_top_2_r1);
        setRotationAngle(door_side_top_2_r1, 0, 0, 0.0698F);
        door_side_top_2_r1.texOffs(98, 100).addBox(-2, 0, -13, 2, 0, 26, 0, false);
        ...
        door_sides_end.texOffs(98, 100).addBox(-20, -33, -13, 2, 0, 26, 0, false);
        ...
        upper_wall_2_r5.setPos(19.511F, -12.7909F, 23);
        head.addChild(upper_wall_2_r5);
        setRotationAngle(upper_wall_2_r5, 0, 0, -0.1047F);
        upper_wall_2_r5.texOffs(8, 90).addBox(0.5F, -21, -16, 1, 21, 2, 0, true);

        upper_wall_1_r4 = new ModelMapper(modelDataWrapper);
        upper_wall_1_r4.setPos(-21.5F, -13, 24);
        head.addChild(upper_wall_1_r4);
        setRotationAngle(upper_wall_1_r4, 0, 0, 0.1047F);
        upper_wall_1_r4.texOffs(8, 90).addBox(0.5F, -21, -17, 1, 21, 2, 0, false);
        ...
        headlights_2_r1.setPos(-24.0483F, -17, -18.7384F);
        headlights.addChild(headlights_2_r1);
        setRotationAngle(headlights_2_r1, 0, -0.3491F, 0);
        headlights_2_r1.texOffs(0, 29).addBox(32, 4, -14.0616F, 10, 10, 0, 0, true);

        headlights_1_r1 = new ModelMapper(modelDataWrapper);
        headlights_1_r1.setPos(-10.8191F, -20, -20.9739F);
        headlights.addChild(headlights_1_r1);
        setRotationAngle(headlights_1_r1, 0, 0.3491F, 0);
        headlights_1_r1.texOffs(0, 29).addBox(-10, 7, -0.0261F, 10, 10, 0, 0, false);
        ...
        tail_lights_2_r1.setPos(-24.0483F, -17, -18.7384F);
        tail_lights.addChild(tail_lights_2_r1);
        setRotationAngle(tail_lights_2_r1, 0, -0.3491F, 0);
        tail_lights_2_r1.texOffs(96, 43).addBox(38, 4, -14.0616F, 4, 4, 0, 0, true);

        tail_lights_1_r1 = new ModelMapper(modelDataWrapper);
        tail_lights_1_r1.setPos(-10.8191F, -20, -20.9739F);
        tail_lights.addChild(tail_lights_1_r1);
        setRotationAngle(tail_lights_1_r1, 0, 0.3491F, 0);
        tail_lights_1_r1.texOffs(96, 43).addBox(-10, 7, -0.0261F, 4, 4, 0, 0, false);
        ...
        switch (renderStage) {
            ...
            case INTERIOR:
                ...
                if (renderDetails) {
                    ...
                    renderMirror(side_panel, matrices, vertices, light, position + 24.375F);
                    renderMirror(side_panel, matrices, vertices, light, position - 24.375F);
                }
                break;
            case EXTERIOR:
