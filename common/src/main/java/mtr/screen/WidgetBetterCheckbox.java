...
public class WidgetBetterCheckbox extends Checkbox implements IGui {
	...
	public void render(PoseStack matrices, int mouseX, int mouseY, float delta) {
		...
		if (showLabel) drawString(matrices, Minecraft.getInstance().font, getMessage(), UtilitiesClient.getWidgetX(this) + 24, UtilitiesClient.getWidgetY(this) + (height - 8) / 2, ARGB_WHITE);
	}
