...
public interface Items {
	...
	RegistryObject<Item> RAIL_CONNECTOR_20 = new RegistryObject<>(() -> new ItemRailModifier(false, RailType.WOODEN));
	RegistryObject<Item> RAIL_CONNECTOR_20_ONE_WAY = new RegistryObject<>(() -> new ItemRailModifier(true, RailType.WOODEN));
	RegistryObject<Item> RAIL_CONNECTOR_40 = new RegistryObject<>(() -> new ItemRailModifier(false, RailType.STONE));
	RegistryObject<Item> RAIL_CONNECTOR_40_ONE_WAY = new RegistryObject<>(() -> new ItemRailModifier(true, RailType.STONE));
	RegistryObject<Item> RAIL_CONNECTOR_60 = new RegistryObject<>(() -> new ItemRailModifier(false, RailType.EMERALD));
	RegistryObject<Item> RAIL_CONNECTOR_60_ONE_WAY = new RegistryObject<>(() -> new ItemRailModifier(true, RailType.EMERALD));
	RegistryObject<Item> RAIL_CONNECTOR_80 = new RegistryObject<>(() -> new ItemRailModifier(false, RailType.IRON));
	RegistryObject<Item> RAIL_CONNECTOR_80_ONE_WAY = new RegistryObject<>(() -> new ItemRailModifier(true, RailType.IRON));
	RegistryObject<Item> RAIL_CONNECTOR_120 = new RegistryObject<>(() -> new ItemRailModifier(false, RailType.OBSIDIAN));
	RegistryObject<Item> RAIL_CONNECTOR_120_ONE_WAY = new RegistryObject<>(() -> new ItemRailModifier(true, RailType.OBSIDIAN));
	RegistryObject<Item> RAIL_CONNECTOR_160 = new RegistryObject<>(() -> new ItemRailModifier(false, RailType.BLAZE));
	RegistryObject<Item> RAIL_CONNECTOR_160_ONE_WAY = new RegistryObject<>(() -> new ItemRailModifier(true, RailType.BLAZE));
	RegistryObject<Item> RAIL_CONNECTOR_200 = new RegistryObject<>(() -> new ItemRailModifier(false, RailType.QUARTZ));
	RegistryObject<Item> RAIL_CONNECTOR_200_ONE_WAY = new RegistryObject<>(() -> new ItemRailModifier(true, RailType.QUARTZ));
	RegistryObject<Item> RAIL_CONNECTOR_300 = new RegistryObject<>(() -> new ItemRailModifier(false, RailType.DIAMOND));
	RegistryObject<Item> RAIL_CONNECTOR_300_ONE_WAY = new RegistryObject<>(() -> new ItemRailModifier(true, RailType.DIAMOND));
	RegistryObject<Item> RAIL_CONNECTOR_PLATFORM = new RegistryObject<>(() -> new ItemRailModifier(false, RailType.PLATFORM));
	RegistryObject<Item> RAIL_CONNECTOR_SIDING = new RegistryObject<>(() -> new ItemRailModifier(false, RailType.SIDING));
	RegistryObject<Item> RAIL_CONNECTOR_TURN_BACK = new RegistryObject<>(() -> new ItemRailModifier(false, RailType.TURN_BACK));
	RegistryObject<Item> RAIL_CONNECTOR_CABLE_CAR = new RegistryObject<>(() -> new ItemRailModifier(true, RailType.CABLE_CAR));
