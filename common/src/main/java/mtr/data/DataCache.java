...
public class DataCache {
	...
	public final Map<Long, Company> companyIdMap = new HashMap<>();
	...
	protected final Set<Company> companies;

	public DataCache(Set<Station> stations, Set<Platform> platforms, Set<Siding> sidings, Set<Route> routes, Set<Depot> depots, Set<Company> companies) {
