...
public class TrainProperties {
    ...
    public TrainProperties(String baseTrainType, Component name, Component description, int color, float riderOffset, float bogiePosition, boolean isJacobsBogie, boolean hasGangwayConnection, TrainRendererBase renderer, TrainSoundBase sound) {
    ...
    public static TrainProperties getBlankProperties() {
        return new TrainProperties(
                "", Text.translatable(""), null, 0, 0, 0, false, false,
