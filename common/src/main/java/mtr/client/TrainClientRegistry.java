...
public class TrainClientRegistry {
	...
	public static void reset() {
		...
		register("light_rail_1", TrainType.LIGHT_RAIL_1, new ModelLightRail(1), "mtr:textures/entity/light_rail_1", "light_rail_aeg", "light_rail_1", null, 0xD2A825, 48, 1, false);
		register("light_rail_1r", TrainType.LIGHT_RAIL_1R, new ModelLightRail(4), "mtr:textures/entity/light_rail_1r", "light_rail_aeg", "light_rail_1", null, 0xD2A825, 48, 1, false);
		register("light_rail_2", TrainType.LIGHT_RAIL_2, new ModelLightRail(2), "mtr:textures/entity/light_rail_2", "light_rail_aeg", "light_rail_3", null, 0xD2A825, 48, 1, false);
		register("light_rail_3", TrainType.LIGHT_RAIL_3, new ModelLightRail(3), "mtr:textures/entity/light_rail_3", "light_rail_mitsubishi", "light_rail_3", null, 0xD2A825, 45, 1, false);
		register("light_rail_4", TrainType.LIGHT_RAIL_4, new ModelLightRail(4), "mtr:textures/entity/light_rail_4", "light_rail_mitsubishi", "light_rail_4", null, 0xD2A825, 45, 1, false);
		register("light_rail_5", TrainType.LIGHT_RAIL_5, new ModelLightRail(5), "mtr:textures/entity/light_rail_5", "light_rail_mitsubishi", "light_rail_4", null, 0xD2A825, 45, 1, false);
		register("light_rail_1r_old", TrainType.LIGHT_RAIL_1R_OLD, new ModelLightRail(4), "mtr:textures/entity/light_rail_1r_old", "light_rail_aeg", "light_rail_1", null, 0xD2A825, 48, 1, false);
		register("light_rail_4_old", TrainType.LIGHT_RAIL_4_OLD, new ModelLightRail(4), "mtr:textures/entity/light_rail_4_old", "light_rail_mitsubishi", "light_rail_4", null, 0xD2A825, 45, 1, false);
		register("light_rail_5_old", TrainType.LIGHT_RAIL_5_OLD, new ModelLightRail(5), "mtr:textures/entity/light_rail_5_old", "light_rail_mitsubishi", "light_rail_4", null, 0xD2A825, 45, 1, false);
		register("light_rail_1_orange", TrainType.LIGHT_RAIL_1_ORANGE, new ModelLightRail(1), "mtr:textures/entity/light_rail_1_orange", "light_rail_aeg", "light_rail_1", null, 0xD2A825, 48, 1, false);
		register("light_rail_1r_orange", TrainType.LIGHT_RAIL_1R_ORANGE, new ModelLightRail(4), "mtr:textures/entity/light_rail_1r_orange", "light_rail_aeg", "light_rail_1", null, 0xD2A825, 48, 1, false);
		register("light_rail_2_orange", TrainType.LIGHT_RAIL_2_ORANGE, new ModelLightRail(2), "mtr:textures/entity/light_rail_2_orange", "light_rail_aeg", "light_rail_3", null, 0xD2A825, 48, 1, false);
		register("light_rail_3_orange", TrainType.LIGHT_RAIL_3_ORANGE, new ModelLightRail(3), "mtr:textures/entity/light_rail_3_orange", "light_rail_mitsubishi", "light_rail_3", null, 0xD2A825, 45, 1, false);
		register("light_rail_4_orange", TrainType.LIGHT_RAIL_4_ORANGE, new ModelLightRail(4), "mtr:textures/entity/light_rail_4_orange", "light_rail_mitsubishi", "light_rail_4", null, 0xD2A825, 45, 1, false);
		...
		register("class_802_gwr", TrainType.CLASS_802_GWR, new ModelClass802(), "mtr:textures/entity/class_802_gwr", "k_train", "class_802", null, 0x021E15, 66, 1, false);
		register("class_802_gwr_mini", TrainType.CLASS_802_GWR_MINI, new ModelClass802Mini(), "mtr:textures/entity/class_802_gwr", "k_train", "class_802", null, 0x021E15, 66, 1, false);
		register("class_802_tpe", TrainType.CLASS_802_TPE, new ModelClass802(), "mtr:textures/entity/class_802_tpe", "k_train", "class_802", null, 0x00A6E6, 66, 1, false);
		register("class_802_tpe_mini", TrainType.CLASS_802_TPE_MINI, new ModelClass802Mini(), "mtr:textures/entity/class_802_tpe", "k_train", "class_802", null, 0x00A6E6, 66, 1, false);
		...
		register("ngong_ping_360_normal_red", TrainType.NGONG_PING_360_NORMAL_RED, new ModelNgongPing360(), "mtr:textures/entity/ngong_ping_360_normal_red", null, null, null, 0x062540, 0, 0.5F, false);
		...
		register("ngong_ping_360_normal_light_blue", TrainType.NGONG_PING_360_NORMAL_LIGHT_BLUE, new ModelNgongPing360(), "mtr:textures/entity/ngong_ping_360_normal_light_blue", null, null, null, 0x062540, 0, 0.5F, false);
	}
