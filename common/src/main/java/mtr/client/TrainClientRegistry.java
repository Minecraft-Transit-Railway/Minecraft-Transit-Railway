...
public class TrainClientRegistry {
	...
	public static void reset() {
		...
		register(TrainType.MLR, "MTR_Metro_Cammell_EMU_(AC)", new ModelMLR(), "mtr:textures/entity/mlr", 0x6CB5E2, "mtr:textures/entity/m_train", "mtr:textures/entity/mlr", 8.5F, false, "mlr", new JonTrainSound.JonTrainSoundConfig("mlr", 93, 0.5F, true));
		register(TrainType.MLR_SMALL, "MTR_Metro_Cammell_EMU_(AC)", new ModelMLRSmall(), "mtr:textures/entity/mlr", 0x6CB5E2, "mtr:textures/entity/m_train", "mtr:textures/entity/mlr", 6F, false, "mlr", new JonTrainSound.JonTrainSoundConfig("mlr", 93, 0.5F, true));
		register(TrainType.MLR_MINI, "MTR_Metro_Cammell_EMU_(AC)", new ModelMLRMini(), "mtr:textures/entity/mlr", 0x6CB5E2, "mtr:textures/entity/m_train", "mtr:textures/entity/mlr", 3F, true, "mlr", new JonTrainSound.JonTrainSoundConfig("mlr", 93, 0.5F, true));
		register(TrainType.MLR_CHRISTMAS, "MTR_Metro_Cammell_EMU_(AC)", new ModelMLRChristmas(), "mtr:textures/entity/mlr_christmas", 0x00873E, "mtr:textures/entity/m_train", "mtr:textures/entity/mlr", 8.5F, false, "mlr", new JonTrainSound.JonTrainSoundConfig("mlr", 93, 0.5F, true));
		register(TrainType.MLR_CHRISTMAS_SMALL, "MTR_Metro_Cammell_EMU_(AC)", new ModelMLRChristmasSmall(), "mtr:textures/entity/mlr_christmas", 0x00873E, "mtr:textures/entity/m_train", "mtr:textures/entity/mlr", 6F, false, "mlr", new JonTrainSound.JonTrainSoundConfig("mlr", 93, 0.5F, true));
		register(TrainType.MLR_CHRISTMAS_MINI, "MTR_Metro_Cammell_EMU_(AC)", new ModelMLRChristmasMini(), "mtr:textures/entity/mlr_christmas", 0x00873E, "mtr:textures/entity/m_train", "mtr:textures/entity/mlr", 3F, true, "mlr", new JonTrainSound.JonTrainSoundConfig("mlr", 93, 0.5F, true));
