...
public class TrainClientRegistry {
	...
	public static void reset() {
		...
		register(TrainType.LIGHT_RAIL_3R, "Light_Rail_(MTR)", new ModelLightRail(7, false), "mtr:textures/entity/light_rail_3", 0xD2A825, "", "", 6.25F, false, "light_rail_mitsubishi", new JonTrainSound.JonTrainSoundConfig("light_rail_3", 45, 1, false));
		register(TrainType.LIGHT_RAIL_3R_RHT, "Light_Rail_(MTR)", new ModelLightRail(7, true), "mtr:textures/entity/light_rail_3", 0xD2A825, "", "", 6.25F, false, "light_rail_mitsubishi", new JonTrainSound.JonTrainSoundConfig("light_rail_3", 45, 1, false));
