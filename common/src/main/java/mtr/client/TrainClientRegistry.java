...
public class TrainClientRegistry {
	...
	public static void register(String key, TrainType baseTrainType, ModelTrainBase model, String textureId, String speedSoundBaseId, String doorSoundBaseId, String name, int color, boolean hasGangwayConnection, boolean trainBarrierOption, int speedSoundCount, float doorCloseSoundTime, boolean useAccelerationSoundsWhenCoasting) {
		...
		if (!KEY_ORDERS.containsKey(baseTrainType.transportMode) && !trainBarrierOption) {
			KEY_ORDERS.put(baseTrainType.transportMode, new ArrayList<>());
		}
		if (!KEY_ORDERS.get(baseTrainType.transportMode).contains(keyLower) && !trainBarrierOption) {
			KEY_ORDERS.get(baseTrainType.transportMode).add(keyLower);
		}
		REGISTRY.put(keyLower, new TrainProperties(baseTrainType, model, textureId, speedSoundBaseId, doorSoundBaseId, new TranslatableComponent(name == null ? "train.mtr." + keyLower : name), color, hasGangwayConnection, trainBarrierOption, speedSoundCount, doorCloseSoundTime, useAccelerationSoundsWhenCoasting));
	}
	...
	public static void reset() {
		...
		register("sp1900_small", TrainType.SP1900_SMALL, new ModelSP1900Small(false), "mtr:textures/entity/sp1900", "sp1900", "sp1900", null, 0x003399, true,  false, 120, 0.5F, false);
		...
		register("c1141a_small", TrainType.C1141A_SMALL, new ModelSP1900Small(true), "mtr:textures/entity/c1141a", "c1141a", "sp1900", null, 0xB42249, true,  false, 96, 0.5F, false);
		...
		register("m_train_small", TrainType.M_TRAIN_SMALL, new ModelMTrainSmall(), "mtr:textures/entity/m_train", "m_train", "m_train", null, 0x999999, true,  false, 90, 0.5F, false);
		...
		register("mlr_small", TrainType.MLR_SMALL, new ModelMLRSmall(), "mtr:textures/entity/mlr", "mlr", "mlr", null, 0x6CB5E2, true,  false, 93, 0.5F, true);
		...
		register("drl", TrainType.DRL, new ModelDRL(), "mtr:textures/entity/drl", "m_train", null, null, 0xF287B7, true,  false, 90, 0.5F, false);
		...
		register("k_train_small", TrainType.K_TRAIN_SMALL, new ModelKTrainSmall(false), "mtr:textures/entity/k_train", "k_train", "k_train", null, 0x0EAB52, true,  false, 66, 1, false);
		...
		register("k_train_tcl_small", TrainType.K_TRAIN_TCL_SMALL, new ModelKTrainSmall(true), "mtr:textures/entity/k_train_tcl", "k_train", "k_train", null, 0x0EAB52, true,  false, 66, 1, false);
		...
		register("k_train_ael_small", TrainType.K_TRAIN_AEL_SMALL, new ModelKTrainSmall(true), "mtr:textures/entity/k_train_ael", "k_train", "k_train", null, 0x0EAB52, true,  false, 66, 1, false);
		...
		register("c_train", TrainType.C_TRAIN, new ModelCTrain(), "mtr:textures/entity/c_train", "c_train", "sp1900", null, 0xFDD900, true,  false, 69, 0.5F, false);
		register("c_train_small", TrainType.C_TRAIN_SMALL, new ModelCTrainSmall(), "mtr:textures/entity/c_train", "c_train", "sp1900", null, 0xFDD900, true,  false, 69, 0.5F, false);
		register("c_train_mini", TrainType.C_TRAIN_MINI, new ModelCTrainMini(), "mtr:textures/entity/c_train", "c_train", "sp1900", null, 0xFDD900, true,  false, 69, 0.5F, false);
		...
		register("a_train_tcl_small", TrainType.A_TRAIN_TCL_SMALL, new ModelATrainSmall(false), "mtr:textures/entity/a_train_tcl", "a_train", "a_train", null, 0xF69447, true,  false, 78, 0.5F, false);
		...
		register("light_rail_1", TrainType.LIGHT_RAIL_1, new ModelLightRail(1), "mtr:textures/entity/light_rail_1", "light_rail_aeg", "light_rail_1", null, 0xD2A825, false,  false, 48, 1, false);
		register("light_rail_1r", TrainType.LIGHT_RAIL_1R, new ModelLightRail(4), "mtr:textures/entity/light_rail_1r", "light_rail_aeg", "light_rail_1", null, 0xD2A825, false,  false, 48, 1, false);
		register("light_rail_2", TrainType.LIGHT_RAIL_2, new ModelLightRail(2), "mtr:textures/entity/light_rail_2", "light_rail_aeg", "light_rail_3", null, 0xD2A825, false,  false, 48, 1, false);
		register("light_rail_3", TrainType.LIGHT_RAIL_3, new ModelLightRail(3), "mtr:textures/entity/light_rail_3", "light_rail_mitsubishi", "light_rail_3", null, 0xD2A825, false,  false, 45, 1, false);
		register("light_rail_4", TrainType.LIGHT_RAIL_4, new ModelLightRail(4), "mtr:textures/entity/light_rail_4", "light_rail_mitsubishi", "light_rail_4", null, 0xD2A825, false,  false, 45, 1, false);
		register("light_rail_5", TrainType.LIGHT_RAIL_5, new ModelLightRail(5), "mtr:textures/entity/light_rail_5", "light_rail_mitsubishi", "light_rail_4", null, 0xD2A825, false,  false, 45, 1, false);
		register("light_rail_1r_old", TrainType.LIGHT_RAIL_1R_OLD, new ModelLightRail(4), "mtr:textures/entity/light_rail_1r_old", "light_rail_aeg", "light_rail_1", null, 0xD2A825, false,  false, 48, 1, false);
		register("light_rail_4_old", TrainType.LIGHT_RAIL_4_OLD, new ModelLightRail(4), "mtr:textures/entity/light_rail_4_old", "light_rail_mitsubishi", "light_rail_4", null, 0xD2A825, false,  false, 45, 1, false);
		register("light_rail_5_old", TrainType.LIGHT_RAIL_5_OLD, new ModelLightRail(5), "mtr:textures/entity/light_rail_5_old", "light_rail_mitsubishi", "light_rail_4", null, 0xD2A825, false,  false, 45, 1, false);
		register("light_rail_1_orange", TrainType.LIGHT_RAIL_1_ORANGE, new ModelLightRail(1), "mtr:textures/entity/light_rail_1_orange", "light_rail_aeg", "light_rail_1", null, 0xD2A825, false,  false, 48, 1, false);
		register("light_rail_1r_orange", TrainType.LIGHT_RAIL_1R_ORANGE, new ModelLightRail(4), "mtr:textures/entity/light_rail_1r_orange", "light_rail_aeg", "light_rail_1", null, 0xD2A825, false,  false, 48, 1, false);
		register("light_rail_2_orange", TrainType.LIGHT_RAIL_2_ORANGE, new ModelLightRail(2), "mtr:textures/entity/light_rail_2_orange", "light_rail_aeg", "light_rail_3", null, 0xD2A825, false,  false, 48, 1, false);
		register("light_rail_3_orange", TrainType.LIGHT_RAIL_3_ORANGE, new ModelLightRail(3), "mtr:textures/entity/light_rail_3_orange", "light_rail_mitsubishi", "light_rail_3", null, 0xD2A825, false,  false, 45, 1, false);
		register("light_rail_4_orange", TrainType.LIGHT_RAIL_4_ORANGE, new ModelLightRail(4), "mtr:textures/entity/light_rail_4_orange", "light_rail_mitsubishi", "light_rail_4", null, 0xD2A825, false,  false, 45, 1, false);
		register("light_rail_5_orange", TrainType.LIGHT_RAIL_5_ORANGE, new ModelLightRail(5), "mtr:textures/entity/light_rail_5_orange", "light_rail_mitsubishi", "light_rail_4", null, 0xD2A825, false,  false, 45, 1, false);
		register("london_underground_d78", TrainType.LONDON_UNDERGROUND_D78, new ModelLondonUndergroundD78(), "mtr:textures/entity/london_underground_d78", "mlr", "london_underground_d78", null, 0x007229, false,  false, 93, 1, true);
		register("london_underground_d78_mini", TrainType.LONDON_UNDERGROUND_D78_MINI, new ModelLondonUndergroundD78Mini(), "mtr:textures/entity/london_underground_d78", "mlr", "london_underground_d78", null, 0x007229, false,  false, 93, 1, true);
		...
		register("london_underground_1996", TrainType.LONDON_UNDERGROUND_1996, new ModelLondonUnderground1995(), "mtr:textures/entity/london_underground_1996", "london_underground_1995", "london_underground_1995", null, 0xA1A5A7, false,  false, 27, 0.5F, false);
		...
		register("minecart", TrainType.MINECART, null, "textures/entity/minecart", null, null, null, 0x666666, false,  false, 0, 0.5F, false);
		register("oak_boat", TrainType.OAK_BOAT, null, "textures/entity/boat/oak", null, null, null, 0x8F7748, false,  false, 0, 0.5F, false);
		register("spruce_boat", TrainType.SPRUCE_BOAT, null, "textures/entity/boat/spruce", null, null, null, 0x8F7748, false,  false, 0, 0.5F, false);
		register("birch_boat", TrainType.BIRCH_BOAT, null, "textures/entity/boat/birch", null, null, null, 0x8F7748, false,  false, 0, 0.5F, false);
		register("jungle_boat", TrainType.JUNGLE_BOAT, null, "textures/entity/boat/jungle", null, null, null, 0x8F7748, false,  false, 0, 0.5F, false);
		register("acacia_boat", TrainType.ACACIA_BOAT, null, "textures/entity/boat/acacia", null, null, null, 0x8F7748, false,  false, 0, 0.5F, false);
		register("dark_oak_boat", TrainType.DARK_OAK_BOAT, null, "textures/entity/boat/dark_oak", null, null, null, 0x8F7748, false,  false, 0, 0.5F, false);
	}
	...
	private static TrainProperties getBlankProperties(TrainType baseTrainType) {
		return new TrainProperties(baseTrainType, null, null, null, null, new TranslatableComponent(""), 0, false, false, 0, 0.5F, false);
	}
	...
	public static class TrainProperties {
		...
		private TrainProperties(TrainType baseTrainType, ModelTrainBase model, String textureId, String speedSoundBaseId, String doorSoundBaseId, TranslatableComponent name, int color, boolean hasGangwayConnection, boolean trainBarrierOption, int speedSoundCount, float doorCloseSoundTime, boolean useAccelerationSoundsWhenCoasting) {
