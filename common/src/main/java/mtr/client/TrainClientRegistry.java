...
public class TrainClientRegistry {
	...
	public static void reset() {
		...
		register(TrainType.A_TRAIN_TCL, new ModelATrain(false), "mtr:textures/entity/a_train_tcl", 0xF69447, "mtr:textures/entity/a_train", "", 8.5F, false, "a_train_bve", null);
		register(TrainType.A_TRAIN_TCL_SMALL, new ModelATrainSmall(false), "mtr:textures/entity/a_train_tcl", 0xF69447, "mtr:textures/entity/a_train", "", 6F, false, "a_train_bve", null);
		register(TrainType.A_TRAIN_TCL_MINI, new ModelATrainMini(false), "mtr:textures/entity/a_train_tcl", 0xF69447, "mtr:textures/entity/a_train", "", 2.5F, true, "a_train_bve", null);
		register(TrainType.A_TRAIN_AEL, new ModelATrain(true), "mtr:textures/entity/a_train_ael", 0x008D8D, "mtr:textures/entity/a_train", "", 8.5F, false, "a_train_bve", null);
		register(TrainType.A_TRAIN_AEL_MINI, new ModelATrainMini(true), "mtr:textures/entity/a_train_ael", 0x008D8D, "mtr:textures/entity/a_train", "", 5F, true, "a_train_bve", null);
