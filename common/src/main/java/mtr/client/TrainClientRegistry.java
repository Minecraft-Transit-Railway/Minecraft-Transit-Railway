...
public class TrainClientRegistry {
	...
	public static void reset() {
		...
		register(TrainType.BR_423, "DBAG_Class_423", new ModelBR423(), "mtr:textures/entity/br_423", 0xE3010F, "mtr:textures/entity/sp1900", "", 7, true, "mpl_85", new JonTrainSound.JonTrainSoundConfig("mpl_85", 48, 1, false));
