...
public class TrainClientRegistry {
	...
	public static void reset() {
		...
		register(TrainType.LONDON_UNDERGROUND_D78, new ModelLondonUndergroundD78(), "mtr:textures/entity/london_underground_d78", 0x007229, "", "mtr:textures/entity/london_underground_d78", 5.75F, false, "mlr", new JonTrainSound.JonTrainSoundConfig("london_underground_d78", 93, 1, true));
		register(TrainType.LONDON_UNDERGROUND_D78_MINI, new ModelLondonUndergroundD78Mini(), "mtr:textures/entity/london_underground_d78", 0x007229, "", "mtr:textures/entity/london_underground_d78", 2F, true, "mlr", new JonTrainSound.JonTrainSoundConfig("london_underground_d78", 93, 1, true));
		register(TrainType.LONDON_UNDERGROUND_1995, new ModelLondonUnderground1995(), "mtr:textures/entity/london_underground_1995", 0x333333, "", "", 6F, false, "london_underground_1995", new JonTrainSound.JonTrainSoundConfig("london_underground_1995", 72, 0.5F, false));
		register(TrainType.LONDON_UNDERGROUND_1996, new ModelLondonUnderground1995(), "mtr:textures/entity/london_underground_1996", 0xA1A5A7, "", "", 6F, false, "london_underground_1996", new JonTrainSound.JonTrainSoundConfig("london_underground_1995", 93, 0.5F, false));
