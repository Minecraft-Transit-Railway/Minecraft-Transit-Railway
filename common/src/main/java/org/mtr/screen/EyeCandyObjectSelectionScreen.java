...
public class EyeCandyObjectSelectionScreen extends DashboardListSelectorScreen {
	...
	public EyeCandyObjectSelectionScreen(ObjectImmutableList<DashboardListItem> allData, LongCollection selectedIds, Runnable updateData, WindowBase previousScreen) {
