...
export class ManageResourcesDialog {
    ...
    protected readonly data = inject<{
        ...
        listCustomSupplier: () => string[],
        listMinecraftSupplier: () => string[]
    }>(MAT_DIALOG_DATA);
    ...
    constructor(private readonly dataService: DataService, private translate: TranslateService) {
    ...
    validateFiles(fileNames: [string, string][]) {
        ...
        if (JSON.stringify(matchingPairsObj.sort()) === JSON.stringify(matchingPairsMtl.sort())) {
            ...
            return this.translate.instant("design.obj_with_mtl");
        }
    }
