...
public final class Items {
	...
	static {
		...
		RAIL_CONNECTOR_250 = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "rail_connector_250"), itemSettings -> new Item(new ItemRailModifier(true, false, true, false, RailType.PACKEDICE, itemSettings)), CreativeModeTabs.CORE);
		RAIL_CONNECTOR_250_ONE_WAY = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "rail_connector_250_one_way"), itemSettings -> new Item(new ItemRailModifier(true, false, true, true, RailType.PACKEDICE, itemSettings)), CreativeModeTabs.CORE);
