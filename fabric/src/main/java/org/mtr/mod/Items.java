...
public final class Items {
	...
	static {
		...
		RAIL_CONNECTOR_100 = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "rail_connector_100"), itemSettings -> new Item(new ItemRailModifier(true, false, true, false, RailType.GOLD, itemSettings)), CreativeModeTabs.CORE);
		RAIL_CONNECTOR_100_ONE_WAY = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "rail_connector_100_one_way"), itemSettings -> new Item(new ItemRailModifier(true, false, true, true, RailType.GOLD, itemSettings)), CreativeModeTabs.CORE);
		...
		RAIL_CONNECTOR_250 = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "rail_connector_250"), itemSettings -> new Item(new ItemRailModifier(true, false, true, false, RailType.PACKETICE, itemSettings)), CreativeModeTabs.CORE);
		RAIL_CONNECTOR_250_ONE_WAY = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "rail_connector_250_one_way"), itemSettings -> new Item(new ItemRailModifier(true, false, true, true, RailType.PACKETICE, itemSettings)), CreativeModeTabs.CORE);
		...
		RAIL_CONNECTOR_400 = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "rail_connector_400"), itemSettings -> new Item(new ItemRailModifier(true, false, true, false, RailType.NETHERINT, itemSettings)), CreativeModeTabs.CORE);
		RAIL_CONNECTOR_400_ONE_WAY = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "rail_connector_400_one_way"), itemSettings -> new Item(new ItemRailModifier(true, false, true, true, RailType.NETHERINT, itemSettings)), CreativeModeTabs.CORE);
		...
		// Signal connectors
		SIGNAL_CONNECTOR_WHITE = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_connector_white"), itemSettings -> new Item(new ItemSignalModifier(true, MapColor.getWhiteMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_CONNECTOR_ORANGE = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_connector_orange"), itemSettings -> new Item(new ItemSignalModifier(true, MapColor.getOrangeMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_CONNECTOR_MAGENTA = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_connector_magenta"), itemSettings -> new Item(new ItemSignalModifier(true, MapColor.getMagentaMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_CONNECTOR_LIGHT_BLUE = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_connector_light_blue"), itemSettings -> new Item(new ItemSignalModifier(true, MapColor.getLightBlueMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_CONNECTOR_YELLOW = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_connector_yellow"), itemSettings -> new Item(new ItemSignalModifier(true, MapColor.getYellowMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_CONNECTOR_LIME = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_connector_lime"), itemSettings -> new Item(new ItemSignalModifier(true, MapColor.getLimeMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_CONNECTOR_PINK = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_connector_pink"), itemSettings -> new Item(new ItemSignalModifier(true, MapColor.getPinkMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_CONNECTOR_GRAY = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_connector_gray"), itemSettings -> new Item(new ItemSignalModifier(true, MapColor.getGrayMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_CONNECTOR_LIGHT_GRAY = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_connector_light_gray"), itemSettings -> new Item(new ItemSignalModifier(true, MapColor.getLightGrayMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_CONNECTOR_CYAN = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_connector_cyan"), itemSettings -> new Item(new ItemSignalModifier(true, MapColor.getCyanMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_CONNECTOR_PURPLE = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_connector_purple"), itemSettings -> new Item(new ItemSignalModifier(true, MapColor.getPurpleMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_CONNECTOR_BLUE = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_connector_blue"), itemSettings -> new Item(new ItemSignalModifier(true, MapColor.getBlueMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_CONNECTOR_BROWN = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_connector_brown"), itemSettings -> new Item(new ItemSignalModifier(true, MapColor.getBrownMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_CONNECTOR_GREEN = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_connector_green"), itemSettings -> new Item(new ItemSignalModifier(true, MapColor.getGreenMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_CONNECTOR_RED = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_connector_red"), itemSettings -> new Item(new ItemSignalModifier(true, MapColor.getRedMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_CONNECTOR_BLACK = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_connector_black"), itemSettings -> new Item(new ItemSignalModifier(true, MapColor.getBlackMapped(), itemSettings)), CreativeModeTabs.CORE);

		// Signal removers
		SIGNAL_REMOVER_WHITE = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_remover_white"), itemSettings -> new Item(new ItemSignalModifier(false, MapColor.getWhiteMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_REMOVER_ORANGE = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_remover_orange"), itemSettings -> new Item(new ItemSignalModifier(false, MapColor.getOrangeMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_REMOVER_MAGENTA = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_remover_magenta"), itemSettings -> new Item(new ItemSignalModifier(false, MapColor.getMagentaMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_REMOVER_LIGHT_BLUE = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_remover_light_blue"), itemSettings -> new Item(new ItemSignalModifier(false, MapColor.getLightBlueMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_REMOVER_YELLOW = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_remover_yellow"), itemSettings -> new Item(new ItemSignalModifier(false, MapColor.getYellowMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_REMOVER_LIME = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_remover_lime"), itemSettings -> new Item(new ItemSignalModifier(false, MapColor.getLimeMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_REMOVER_PINK = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_remover_pink"), itemSettings -> new Item(new ItemSignalModifier(false, MapColor.getPinkMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_REMOVER_GRAY = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_remover_gray"), itemSettings -> new Item(new ItemSignalModifier(false, MapColor.getGrayMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_REMOVER_LIGHT_GRAY = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_remover_light_gray"), itemSettings -> new Item(new ItemSignalModifier(false, MapColor.getLightGrayMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_REMOVER_CYAN = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_remover_cyan"), itemSettings -> new Item(new ItemSignalModifier(false, MapColor.getCyanMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_REMOVER_PURPLE = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_remover_purple"), itemSettings -> new Item(new ItemSignalModifier(false, MapColor.getPurpleMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_REMOVER_BLUE = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_remover_blue"), itemSettings -> new Item(new ItemSignalModifier(false, MapColor.getBlueMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_REMOVER_BROWN = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_remover_brown"), itemSettings -> new Item(new ItemSignalModifier(false, MapColor.getBrownMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_REMOVER_GREEN = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_remover_green"), itemSettings -> new Item(new ItemSignalModifier(false, MapColor.getGreenMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_REMOVER_RED = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_remover_red"), itemSettings -> new Item(new ItemSignalModifier(false, MapColor.getRedMapped(), itemSettings)), CreativeModeTabs.CORE);
		SIGNAL_REMOVER_BLACK = Init.REGISTRY.registerItem(new Identifier(Init.MOD_ID, "signal_remover_black"), itemSettings -> new Item(new ItemSignalModifier(false, MapColor.getBlackMapped(), itemSettings)), CreativeModeTabs.CORE);
	...
	public static final ItemRegistryObject RAIL_CONNECTOR_250;
	public static final ItemRegistryObject RAIL_CONNECTOR_250_ONE_WAY;
	...
	public static final ItemRegistryObject RAIL_CONNECTOR_400;
	public static final ItemRegistryObject RAIL_CONNECTOR_400_ONE_WAY;
