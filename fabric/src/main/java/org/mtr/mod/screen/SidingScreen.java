...
public class SidingScreen extends SavedRailScreenBase<Siding, Depot> implements Icons {
	...
	public SidingScreen(Siding siding, TransportMode transportMode, DashboardScreen dashboardScreen) {
		super(siding, transportMode, dashboardScreen, SELECTED_TRAIN_TEXT, MAX_TRAINS_TEXT, ACCELERATION_CONSTANT_TEXT, BRAKING_POWER_CONSTANT_TEXT, MANUAL_TO_AUTOMATIC_TIME, MAX_MANUAL_SPEED);
		...
		sliderAccelerationConstant = new WidgetShorterSlider(0, MAX_TRAINS_WIDTH, (int) Math.round((Siding.MAX_BRAKING_POWER - Siding.MIN_BRAKING_POWER) * SLIDER_SCALE), this::brakingPowerSliderFormatter, null);
	...
	public void onClose2() {
		...
		savedRailBase.setBrakingPower(accelerationConstant);
