...
public enum RailType implements IGui {
	...
	BRICKS(100, MapColor.getBrownMapped(), false, true, true, Rail.Shape.QUADRATIC),
	OBSIDIAN(120, MapColor.getPurpleMapped(), false, true, true, Rail.Shape.QUADRATIC),
	PRISMARINE(140, MapColor.getCyanMapped(), false, true, true, Rail.Shape.QUADRATIC),
	...
	BLUEICE(250, MapColor.getOffBlueMapped(), false, true, true, Rail.Shape.QUADRATIC),
	DIAMOND(300, MapColor.getDiamondBlueMapped(), false, true, true, Rail.Shape.QUADRATIC),
	NETHERINT(400, MapColor.getDarkBrownMapped(), false, true, true, Rail.Shape.QUADRATIC),
