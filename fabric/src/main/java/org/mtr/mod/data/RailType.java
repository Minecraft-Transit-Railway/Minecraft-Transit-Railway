...
public enum RailType implements IGui {
	...
	STONE(70, MapColor.getEmeraldGreenMapped(), false, true, true, Rail.Shape.CURVE),
	IRON(80, MapColor.getIronGrayMapped(), false, true, true, Rail.Shape.CURVE),
	GOLD(100, MapColor.getGoldYellowMapped(), false, true, true, Rail.Shape.CURVE),
	OBSIDIAN(120, MapColor.getPurpleMapped(), false, true, true, Rail.Shape.CURVE),
	ICE(150, MapColor.getDarkBlueMapped(), false, true, true, Rail.Shape.CURVE),
	...
	BLUEICE(250, MapColor.getOffLightBlueMapped(), false, true, true, Rail.Shape.CURVE),
	DIAMOND(300, MapColor.getDiamondBlueMapped(), false, true, true, Rail.Shape.CURVE),
        NETHERRITERITE(320, MapColor.getDarkRedMapped(), false, true, true, Rail.Shape.CURVE),
