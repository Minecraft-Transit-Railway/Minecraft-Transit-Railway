...
public final class PacketFetchArrivals extends PacketRequestResponseBase implements Utilities {
	...
	public PacketFetchArrivals(long requestKey, LongImmutableList platformIds, int maxCountPerPlatform, int maxCountTotal) {
		super(Utilities.getJsonObjectFromData(new ArrivalsRequest(platformIds, maxCountPerPlatform, maxCountTotal)).toString());
