...
public final class InitClient {
	...
	public static void init() {
		...
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_150, new Identifier(Init.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_150_ONE_WAY, new Identifier(Init.MOD_ID, "selected"), checkItemPredicateTag());
		...
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_250, new Identifier(Init.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_250_ONE_WAY, new Identifier(Init.MOD_ID, "selected"), checkItemPredicateTag());
		...
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_320, new Identifier(Init.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_320_ONE_WAY, new Identifier(Init.MOD_ID, "selected"), checkItemPredicateTag());
