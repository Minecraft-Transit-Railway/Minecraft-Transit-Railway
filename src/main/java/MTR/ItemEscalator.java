...
public class ItemEscalator extends Item {
	...
	public static final String name5 = "ItemEscalator5";
	public static final String name10 = "ItemEscalator10";
	public static final String name20 = "ItemEscalator20";
	public static final String name50 = "ItemEscalator50";
	...
	public static String getName20() {
		return name20;
	}

	public static String getName50() {
		return name50;
	}
}
