...
public class GUINextTrain extends GuiScreen {
	...
	public GUINextTrain(TileEntityNextTrainEntity tileEntityNextTrainEntity) {
		te = tileEntityNextTrainEntity;
	...
	protected void actionPerformed(GuiButton button) {
		...
		case 1:
			...
			MTR.network.sendToServer(
					new MessageRouteChanger(te.getPos().getX(), te.getPos().getY(), te.getPos().getZ(), 0));
