...
public class MTR implements ModInitializer, IPacket {
	...
	public void onInitialize() {
		...
		registerBlock("na_platform_1", Blocks.NA_PLATFORM_1, ItemGroups.STATION_BUILDING_BLOCKS);
		registerBlock("na_platform_2", Blocks.NA_PLATFORM_2, ItemGroups.STATION_BUILDING_BLOCKS);
