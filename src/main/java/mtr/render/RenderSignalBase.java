...
public abstract class RenderSignalBase<T extends BlockEntity> implements IBlock, IGui, BlockEntityRenderer<T> {

	protected final boolean isSingleSided;

	public RenderSignalBase(boolean isSingleSided) {
		super();
