...
public class BlockPoleSignEven extends HorizontalFacingBlock {
    public static final IntProperty TYPE = IntProperty.of("type", 0, 3);
    public BlockPoleSignEven(Settings settings) {
        super(settings);
    }
