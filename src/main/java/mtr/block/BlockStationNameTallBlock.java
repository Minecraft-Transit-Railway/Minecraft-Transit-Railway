...
public class BlockStationNameTallBlock extends BlockStationNameTallBase {
	...
	public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
		...
		return VoxelShapes.union(IBlock.getVoxelShapeByDirection(2, bounds.getLeft(), 5, 14, bounds.getRight(), 11, IBlock.getStatePropertySafe(state, FACING)), BlockPole.getStationPoleShape());
	}
	...
	public static class TileEntityStationNameTallBlock extends TileEntityStationNameTallBase {
		...
		public TileEntityStationNameTallBlock(BlockPos pos, BlockState state) {
			super(MTR.STATION_NAME_TALL_BLOCK_TILE_ENTITY, 0.6875F, pos, state);
		}
	}
}
