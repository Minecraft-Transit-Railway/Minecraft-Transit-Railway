...
public class BlockRailwaySign extends HorizontalFacingBlock implements BlockEntityProvider, IBlock {
	...
	public enum SignType {
		...
		AIRPORT_EXPRESS_IN_TOWN_CHECKIN("airport_express_itc", true, false, true),
		AIRPORT_EXPRESS_IN_TOWN_CHECKIN_FLIPPED("airport_express_itc", true, true, true),
		AIRPORT_EXPRESS_IN_TOWN_CHECKIN_PASSENGER("airport_express_itc_passenger", true, false, true),
		AIRPORT_EXPRESS_IN_TOWN_CHECKIN_PASSENGER_FLIPPED("airport_express_itc_passenger", true, true, true),
