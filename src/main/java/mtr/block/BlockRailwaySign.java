...
public class BlockRailwaySign extends HorizontalFacingBlock implements BlockEntityProvider, IBlock {
	...
	public enum SignType {
		...
		SP1900_1("sp1900_1", true, false),
		SP1900_2("sp1900_2", true, false),
		...
		AIRPORT_EXPRESS_TRAINS_City("airport_express_cty", true, false, true),
		AIRPORT_EXPRESS_TRAINS_City_FLIPPED("airport_express_cty", true, true, true),
		AIRPORT_EXPRESS_IN_TOWN_CHECKIN("airport_express_itc", false, false, true),
		AIRPORT_EXPRESS_IN_TOWN_CHECKIN_FLIPPED("airport_express_itc", false, true, true),
		AIRPORT_EXPRESS_IN_TOWN_CHECKIN_PASSENGER("airport_express_itc_passenger", false, false, true),
		AIRPORT_EXPRESS_IN_TOWN_CHECKIN_PASSENGER_FLIPPED("airport_express_itc_passenger", false, true, true),
