...
public class BlockPlatform extends HorizontalFacingBlock {
	...
	private BlockState getActualState(WorldAccess world, BlockPos pos, BlockState state) {
		...
		if (blockAbove instanceof BlockPSDDoor2 || blockAbove instanceof BlockPSDGlass2 || blockAbove instanceof BlockPSDGlassEnd || blockAbove instanceof BlockPSDDoor ||blockAbove instanceof BlockPSDGlass) {
