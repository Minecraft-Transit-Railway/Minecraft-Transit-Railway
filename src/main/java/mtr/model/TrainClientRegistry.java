...
public class TrainClientRegistry {
	...
	public static void reset() {
		...
		register("light_rail_1r_old", TrainType.LIGHT_RAIL_1R_OLD, new ModelLightRail(4), "mtr:textures/entity/light_rail_1r_old", "light_rail", "light_rail_1", null, 0xD2A825, false, false, 48, 1, false);
		register("light_rail_4_old", TrainType.LIGHT_RAIL_4_OLD, new ModelLightRail(4), "mtr:textures/entity/light_rail_4_old", "light_rail", "light_rail_4", null, 0xD2A825, false, false, 48, 1, false);
		register("light_rail_5_old", TrainType.LIGHT_RAIL_5_OLD, new ModelLightRail(5), "mtr:textures/entity/light_rail_5_old", "light_rail", "light_rail_4", null, 0xD2A825, false, false, 48, 1, false);
		register("light_rail_1_orange", TrainType.LIGHT_RAIL_1_ORANGE, new ModelLightRail(1), "mtr:textures/entity/light_rail_1_orange", "light_rail", "light_rail_1", null, 0xD2A825, false, false, 48, 1, false);
		register("light_rail_1r_orange", TrainType.LIGHT_RAIL_1R_ORANGE, new ModelLightRail(4), "mtr:textures/entity/light_rail_1r_orange", "light_rail", "light_rail_1", null, 0xD2A825, false, false, 48, 1, false);
		register("light_rail_2_orange", TrainType.LIGHT_RAIL_2_ORANGE, new ModelLightRail(2), "mtr:textures/entity/light_rail_2_orange", "light_rail", "light_rail_3", null, 0xD2A825, false, false, 48, 1, false);
		register("light_rail_3_orange", TrainType.LIGHT_RAIL_3_ORANGE, new ModelLightRail(3), "mtr:textures/entity/light_rail_3_orange", "light_rail", "light_rail_3", null, 0xD2A825, false, false, 48, 1, false);
	...
	private static TrainProperties getBlankProperties(TrainType baseTrainType) {
		return new TrainProperties(baseTrainType, null, null, null, null, new TranslatableText(""), 0, false, false, 0, 0.5F, false);
	}
