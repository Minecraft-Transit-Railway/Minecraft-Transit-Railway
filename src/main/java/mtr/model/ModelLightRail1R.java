...
public class ModelLightRail1R extends ModelTrainBase {
    ...
    private final ModelPart head_exterior_1R;
    ...
    public ModelLightRail1R() {
        ...
        door_handrails.setTextureOffset(4, 6).addCuboid(-15.8F, -17.0F, -15.0F, 0.0F, 4.0F, 0.0F, 0.2F, false);
        door_handrails.setTextureOffset(4, 6).addCuboid(-15.8F, -17.0F, 15.0F, 0.0F, 4.0F, 0.0F, 0.2F, false);
        door_handrails.setTextureOffset(0, 75).addCuboid(-5.0F, -32.0F, -12.0F, 4.0F, 5.0F, 0.0F, 0.0F, false);
        door_handrails.setTextureOffset(0, 75).addCuboid(-5.0F, -32.0F, -4.0F, 4.0F, 5.0F, 0.0F, 0.0F, false);
        door_handrails.setTextureOffset(0, 75).addCuboid(-5.0F, -32.0F, 4.0F, 4.0F, 5.0F, 0.0F, 0.0F, false);
        door_handrails.setTextureOffset(0, 75).addCuboid(-5.0F, -32.0F, 12.0F, 4.0F, 5.0F, 0.0F, 0.0F, false);
        door_handrails.setTextureOffset(0, 75).addCuboid(-5.0F, -32.0F, 20.0F, 4.0F, 5.0F, 0.0F, 0.0F, false);
        door_handrails.setTextureOffset(0, 75).addCuboid(-5.0F, -32.0F, 28.0F, 4.0F, 5.0F, 0.0F, 0.0F, false);
        door_handrails.setTextureOffset(0, 75).addCuboid(-5.0F, -32.0F, 36.0F, 4.0F, 5.0F, 0.0F, 0.0F, false);
        door_handrails.setTextureOffset(0, 75).addCuboid(-5.0F, -32.0F, 44.0F, 4.0F, 5.0F, 0.0F, 0.0F, false);
        door_handrails.setTextureOffset(0, 75).addCuboid(-5.0F, -32.0F, -44.0F, 4.0F, 5.0F, 0.0F, 0.0F, false);
        door_handrails.setTextureOffset(0, 75).addCuboid(-5.0F, -32.0F, -36.0F, 4.0F, 5.0F, 0.0F, 0.0F, false);
        door_handrails.setTextureOffset(0, 75).addCuboid(-5.0F, -32.0F, -28.0F, 4.0F, 5.0F, 0.0F, 0.0F, false);
        door_handrails.setTextureOffset(0, 75).addCuboid(-5.0F, -32.0F, -20.0F, 4.0F, 5.0F, 0.0F, 0.0F, false);
        door_handrails.setTextureOffset(358, 0).addCuboid(-20.0F, -32.0F, 14.0F, 3.0F, 32.0F, 2.0F, 0.0F, false);
        door_handrails.setTextureOffset(346, 0).addCuboid(-20.0F, -32.0F, -16.0F, 3.0F, 32.0F, 2.0F, 0.0F, false);

        handrail_6_r1 = new ModelPart(this);
        handrail_6_r1.setPivot(-15.6F, -17.2F, 14.8F);
        door_handrails.addChild(handrail_6_r1);
        setRotationAngle(handrail_6_r1, 0.0F, 0.0F, -0.3491F);
        handrail_6_r1.setTextureOffset(4, 6).addCuboid(-0.2F, -5.2F, 0.2F, 0.0F, 5.0F, 0.0F, 0.2F, false);
        ...
        door_handrails.addChild(handrail_3_r1);
        ...
        door_window_handrails.setTextureOffset(0, 98).addCuboid(5.0F, -13.0F, 16.0F, 13.0F, 11.0F, 0.0F, 0.0F, false);
        door_window_handrails.setTextureOffset(0, 98).addCuboid(5.0F, -13.0F, -16.0F, 13.0F, 11.0F, 0.0F, 0.0F, false);
        door_window_handrails.setTextureOffset(0, 9).addCuboid(5.6F, -27.25F, -16.0F, 0.0F, 15.0F, 0.0F, 0.2F, false);
        door_window_handrails.setTextureOffset(0, 9).addCuboid(5.6F, -27.25F, 16.0F, 0.0F, 15.0F, 0.0F, 0.2F, false);
        door_window_handrails.setTextureOffset(0, 75).addCuboid(4.4F, -32.0F, 8.0F, 4.0F, 5.0F, 0.0F, 0.0F, false);
        door_window_handrails.setTextureOffset(0, 75).addCuboid(4.4F, -32.0F, 0.0F, 4.0F, 5.0F, 0.0F, 0.0F, false);
        door_window_handrails.setTextureOffset(0, 75).addCuboid(4.4F, -32.0F, -8.0F, 4.0F, 5.0F, 0.0F, 0.0F, false);

        handrail_12_r1 = new ModelPart(this);
        handrail_12_r1.setPivot(0.0F, 0.0F, 0.0F);
        door_window_handrails.addChild(handrail_12_r1);
        ...
        door_window_handrails.addChild(handrail_9_r1);
        ...
        door_window_handrails.addChild(handrail_7_r1);
        ...
        head_exterior_1R = new ModelPart(this);
        head_exterior_1R.setPivot(0.0F, 24.0F, 0.0F);
        head_exterior_1R.setTextureOffset(0, 75).addCuboid(-10.0F, -38.8073F, -43.2695F, 20.0F, 7.0F, 9.0F, 0.0F, false);

        front_middle_r1 = new ModelPart(this);
        front_middle_r1.setPivot(0.0F, -14.0F, -46.0F);
        head_exterior_1R.addChild(front_middle_r1);
        ...
        head_exterior_1R.addChild(front_top_r1);
        ...
        head_exterior_1R.addChild(destination_board_r1);
    ...
    protected void renderDoorPositions(MatrixStack matrices, VertexConsumer vertices, RenderStage renderStage, int light, int position, boolean renderDetails, float doorLeftX, float doorRightX, float doorLeftZ, float doorRightZ, boolean isEnd1Head, boolean isEnd2Head) {
        switch (renderStage) {
            ...
            case INTERIOR:
                ...
                if (renderDetails) {
                    renderOnceFlipped(door_handrails, matrices, vertices, light, position);
                    renderOnceFlipped(door_window_handrails, matrices, vertices, light, position);
    ...
    protected void renderHeadPosition1(MatrixStack matrices, VertexConsumer vertices, RenderStage renderStage, int light, int position, boolean renderDetails, boolean useHeadlights) {
        switch (renderStage) {
            ...
            case INTERIOR:
                ...
                break;
            case EXTERIOR:
                renderOnce(head_exterior_1R, matrices, vertices, light, position);
