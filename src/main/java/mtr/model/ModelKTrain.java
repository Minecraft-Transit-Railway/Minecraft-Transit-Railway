...
public class ModelKTrain extends ModelTrainBase {
	...
	public ModelKTrain(boolean isTcl) {
		...
		window_handrail = new ModelMapper(modelPartData);
		...
		window_exterior_end = new ModelMapper(modelPartData);
		...
		lower_wall_1_r2 = new ModelMapper(modelPartData);
		...
		window_handrail.setModelPart(modelPart);
