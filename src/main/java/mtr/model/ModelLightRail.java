...
public class ModelLightRail extends ModelTrainBase {
	...
	public ModelLightRail(int phase) {
		...
		door_5 = new ModelMapper(modelPartData);
		door_5.setPivot(0, 24, 0);
		door_5.setTextureOffset(206, 65).addCuboid(-20, 0, -16, 20, 1, 32, 0, false);

		door_left_5 = new ModelMapper(modelPartData);
		door_left_5.setPivot(0, 0, 0);
		door_5.addChild(door_left_5);
		door_left_5.setTextureOffset(167, 217).addCuboid(-20, -32, 0, 0, 32, 16, 0, false);

		door_right_5 = new ModelMapper(modelPartData);
		door_right_5.setPivot(0, 0, 0);
		door_5.addChild(door_right_5);
		door_right_5.setTextureOffset(205, 114).addCuboid(-20, -32, -16, 0, 32, 16, 0, false);
		...
		door_handrails_5 = new ModelMapper(modelPartData);
		...
		door_edge_8_r1 = new ModelMapper(modelPartData);
		...
		door_edge_7_r1 = new ModelMapper(modelPartData);
		...
		door_exterior_5 = new ModelMapper(modelPartData);
		...
		door_left_exterior_5 = new ModelMapper(modelPartData);
		...
		door_right_exterior_5 = new ModelMapper(modelPartData);
		...
		door_window_handrails_5 = new ModelMapper(modelPartData);
		...
		handrail_14_r1 = new ModelMapper(modelPartData);
		...
		handrail_7_r2 = new ModelMapper(modelPartData);
		...
		handrail_6_r4 = new ModelMapper(modelPartData);
		...
		roof_light_5 = new ModelMapper(modelPartData);
		...
		head_exterior_3_5 = new ModelMapper(modelPartData);
		...
		door_5.setModelPart(modelPart);
		door_left_5.setModelPart(modelPart.getChild(door_5.name));
		door_right_5.setModelPart(modelPart.getChild(door_5.name));
		door_handrails.setModelPart(modelPart);
		door_handrails_4.setModelPart(modelPart);
		door_handrails_5.setModelPart(modelPart);
		...
		door_window_handrails_5.setModelPart(modelPart);
		...
		roof_light_5.setModelPart(modelPart);
		...
		head_exterior_3_5.setModelPart(modelPart);
