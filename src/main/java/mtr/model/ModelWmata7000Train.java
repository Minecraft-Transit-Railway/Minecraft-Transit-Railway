...
public ModelWmata7000Train() {
		...
		walls_window.setTextureOffset(98, 73).addCuboid(-21.0F, 1.0F, -39.0F, 42.0F, 1.0F, 80.0F, 0.0F, false);
		walls_window.setTextureOffset(0, 51).addCuboid(-22.15F, -9.9F, -44.0F, 2.0F, 11.0F, 90.0F, 0.0F, false);
		walls_window.setTextureOffset(0, 51).addCuboid(20.15F, -9.9F, -44.0F, 2.0F, 11.0F, 90.0F, 0.0F, true);
		...
		wall_right_2_r1.setTextureOffset(0, 51).addCuboid(22.9978F, -24.0059F, -36.0F, 2.0F, 29.0F, 90.0F, 0.0F, true);

		wall_left_1_r1 = new ModelPart(this);
		wall_left_1_r1.setPivot(3.2878F, -11.5941F, -8.0F);
		walls_window.addChild(wall_left_1_r1);
		setRotationAngle(wall_left_1_r1, 0.0F, 0.0F, 0.1309F);
		wall_left_1_r1.setTextureOffset(0, 51).addCuboid(-24.9978F, -24.0059F, -36.0F, 2.0F, 29.0F, 90.0F, 0.0F, false);

		window_bottom_side = new ModelPart(this);
		window_bottom_side.setPivot(0.0F, 0.0F, 43.0F);
		window.addChild(window_bottom_side);
		window_bottom_side.setTextureOffset(0, 0).addCuboid(18.0F, -4.0F, -12.0F, 3.0F, 4.0F, 14.0F, 0.0F, false);
		window_bottom_side.setTextureOffset(0, 0).addCuboid(-21.0F, -4.0F, -12.0F, 3.0F, 4.0F, 14.0F, 0.0F, true);

		bottom_wall_3_right_r1 = new ModelPart(this);
		bottom_wall_3_right_r1.setPivot(-19.75F, -4.25F, -4.5F);
		...
		window_bottom_side2.setTextureOffset(0, 0).addCuboid(18.0F, -4.0F, -18.0F, 3.0F, 4.0F, 14.0F, 0.0F, false);
		window_bottom_side2.setTextureOffset(0, 0).addCuboid(-21.0F, -4.0F, -18.0F, 3.0F, 4.0F, 14.0F, 0.0F, true);

		bottom_wall_2_right_r1 = new ModelPart(this);
		bottom_wall_2_right_r1.setPivot(-19.75F, -4.25F, -11.5F);
		...
		window_exterior.setTextureOffset(121, 115).addCuboid(20.75F, 0.0F, -40.0F, 1.0F, 3.0F, 80.0F, 0.0F, true);
		window_exterior.setTextureOffset(121, 115).addCuboid(-21.75F, 0.0F, -40.0F, 1.0F, 3.0F, 80.0F, 0.0F, false);
		window_exterior.setTextureOffset(0, 51).addCuboid(-22.151F, -10.9F, -45.0F, 2.0F, 11.0F, 90.0F, 0.0F, false);
		window_exterior.setTextureOffset(0, 51).addCuboid(20.151F, -10.9F, -45.0F, 2.0F, 11.0F, 90.0F, 0.0F, true);
		...
		wall_right_2_r2.setTextureOffset(0, 51).addCuboid(23.0F, -24.0F, -44.0F, 2.0F, 29.0F, 90.0F, 0.0F, true);
		...
		wall_left_1_r2.setTextureOffset(0, 51).addCuboid(-25.0F, -24.0F, -44.0F, 2.0F, 29.0F, 90.0F, 0.0F, false);
		...
		bottom_wall_right_r1.setTextureOffset(0, 51).addCuboid(-52.0068F, -6.9977F, 21.0F, 80.0F, 3.0F, 0.0F, 0.0F, true);
		...
		bottom_wall_left_r1.setTextureOffset(0, 51).addCuboid(-27.9932F, -6.9977F, 21.0F, 80.0F, 3.0F, 0.0F, 0.0F, false);
		...
		end.setTextureOffset(0, 60).addCuboid(-20.5F, 0.0F, -42.0F, 41.0F, 1.0F, 50.0F, 0.0F, false);
		end.setTextureOffset(0, 51).addCuboid(-22.15F, -10.9F, -44.0F, 2.0F, 11.0F, 57.0F, 0.0F, false);
		end.setTextureOffset(0, 51).addCuboid(20.15F, -10.9F, -44.0F, 2.0F, 11.0F, 57.0F, 0.0F, true);
		...
		wall_right_2_r3.setTextureOffset(0, 51).addCuboid(22.9978F, -24.0059F, -45.0F, 2.0F, 29.0F, 57.0F, 0.0F, true);
		...
		wall_left_1_r3.setTextureOffset(0, 51).addCuboid(-24.9978F, -24.0059F, -45.0F, 2.0F, 29.0F, 57.0F, 0.0F, false);
		...
		cab_door_back2.setTextureOffset(121, 115).addCuboid(-7.0F, -36.0F, 5.5F, 14.0F, 36.0F, 0.0F, 0.0F, false);
		cab_door_back2.setTextureOffset(145, 115).addCuboid(-22.0F, -36.0F, 4.0F, 15.0F, 36.0F, 0.0F, 0.0F, false);
		cab_door_back2.setTextureOffset(145, 115).addCuboid(-21.0F, -13.0F, -3.0F, 14.0F, 13.0F, 7.0F, 0.0F, false);
		cab_door_back2.setTextureOffset(145, 115).addCuboid(7.0F, -13.0F, -3.0F, 14.0F, 13.0F, 7.0F, 0.0F, true);
		cab_door_back2.setTextureOffset(145, 115).addCuboid(7.0F, -36.0F, 4.0F, 15.0F, 36.0F, 0.0F, 0.0F, false);
		cab_door_back2.setTextureOffset(145, 115).addCuboid(-22.0F, -39.0F, 4.0F, 44.0F, 3.0F, 0.0F, 0.0F, false);
		...
		wall_end_back_side_2_r1.setTextureOffset(121, 115).addCuboid(4.0F, -36.0F, -6.0F, 2.0F, 36.0F, 0.0F, 0.0F, false);
		...
		wall_end_back_side_1_r1.setTextureOffset(121, 115).addCuboid(4.0F, -36.0F, 6.0F, 2.0F, 36.0F, 0.0F, 0.0F, false);
		...
		wall_end_top_r1.setTextureOffset(0, 33).addCuboid(-7.0F, -43.0F, -22.0F, 14.0F, 2.0F, 0.0F, 0.0F, false);

		end_bottom = new ModelPart(this);
		end_bottom.setPivot(0.0F, 0.0F, 20.0F);
		end.addChild(end_bottom);
		end_bottom.setTextureOffset(0, 0).addCuboid(18.0F, -4.0F, -21.0F, 3.0F, 4.0F, 14.0F, 0.0F, false);
		end_bottom.setTextureOffset(0, 0).addCuboid(-21.0F, -4.0F, -21.0F, 3.0F, 4.0F, 14.0F, 0.0F, true);

		bottom_wall_2_right_r2 = new ModelPart(this);
		bottom_wall_2_right_r2.setPivot(-19.75F, -4.25F, -13.5F);
		...
		end_exterior.setTextureOffset(0, 51).addCuboid(-22.15F, -10.9F, -44.0F, 2.0F, 11.0F, 57.0F, 0.0F, false);
		end_exterior.setTextureOffset(0, 51).addCuboid(20.15F, -10.9F, -44.0F, 2.0F, 11.0F, 57.0F, 0.0F, true);
		end_exterior.setTextureOffset(114, 0).addCuboid(-6.5F, 0.0F, -47.0F, 13.0F, 3.0F, 7.0F, 0.0F, false);
		end_exterior.setTextureOffset(114, 0).addCuboid(-21.5F, 0.0F, -44.0F, 7.0F, 3.0F, 6.0F, 0.0F, false);
		end_exterior.setTextureOffset(114, 0).addCuboid(14.5F, 0.0F, -44.0F, 7.0F, 3.0F, 6.0F, 0.0F, false);
		end_exterior.setTextureOffset(39, 91).addCuboid(20.75F, 0.0F, -38.0F, 1.0F, 3.0F, 46.0F, 0.0F, false);
		end_exterior.setTextureOffset(0, 124).addCuboid(-21.75F, 0.0F, -38.0F, 1.0F, 3.0F, 46.0F, 0.0F, false);
		end_exterior.setTextureOffset(145, 115).addCuboid(-22.0F, -42.0F, -44.0F, 15.0F, 42.0F, 0.0F, 0.0F, false);
		end_exterior.setTextureOffset(0, 33).addCuboid(-7.0F, -42.0F, -44.0F, 14.0F, 6.0F, 0.0F, 0.0F, false);
		end_exterior.setTextureOffset(137, 115).addCuboid(7.0F, -42.0F, -44.0F, 15.0F, 42.0F, 0.0F, 0.0F, false);
		end_exterior.setTextureOffset(121, 115).addCuboid(-7.0F, -36.0F, -42.0F, 14.0F, 36.0F, 0.0F, 0.0F, false);
		...
		bottom_wall_right_r3.setPivot(0.4068F, 4.1977F, -14.0F);
		end_exterior.addChild(bottom_wall_right_r3);
		setRotationAngle(bottom_wall_right_r3, -0.1309F, 1.5708F, 0.0F);
		bottom_wall_right_r3.setTextureOffset(0, 51).addCuboid(-22.0068F, -7.0007F, 21.0F, 52.0F, 3.0F, 0.0F, 0.0F, true);
		...
		bottom_wall_left_r2.setTextureOffset(0, 51).addCuboid(-29.9932F, -7.0007F, 21.0F, 52.0F, 3.0F, 0.0F, 0.0F, false);
		...
		wall_left_1_r4.setPivot(3.2878F, -12.5941F, 1.0F);
		end_exterior.addChild(wall_left_1_r4);
		setRotationAngle(wall_left_1_r4, 0.0F, 0.0F, 0.1309F);
		wall_left_1_r4.setTextureOffset(0, 51).addCuboid(-24.9978F, -24.0059F, -45.0F, 2.0F, 29.0F, 57.0F, 0.0F, false);

		wall_right_2_r4 = new ModelPart(this);
		wall_right_2_r4.setPivot(-3.2878F, -12.5941F, 1.0F);
		end_exterior.addChild(wall_right_2_r4);
		setRotationAngle(wall_right_2_r4, 0.0F, 0.0F, -0.1309F);
		wall_right_2_r4.setTextureOffset(0, 51).addCuboid(22.9978F, -24.0059F, -45.0F, 2.0F, 29.0F, 57.0F, 0.0F, true);
		...
		end_seat_right.setPivot(0.25F, -1.75F, -7.0F);
		end_seat_handrail.addChild(end_seat_right);
		end_seat_right.setTextureOffset(0, 0).addCuboid(-19.75F, -17.25F, 7.0F, 1.0F, 13.0F, 12.0F, 0.0F, true);

		cube_r1 = new ModelPart(this);
		cube_r1.setPivot(1.5F, 0.0F, -10.0F);
		...
		top_handrails.setTextureOffset(0, 0).addCuboid(9.5F, -39.25F, 44.5F, 0.0F, 2.0F, 0.0F, 0.2F, false);
		top_handrails.setTextureOffset(0, 0).addCuboid(9.5F, -39.25F, 31.5F, 0.0F, 2.0F, 0.0F, 0.2F, false);
		top_handrails.setTextureOffset(0, 0).addCuboid(9.5F, -39.25F, 15.75F, 0.0F, 2.0F, 0.0F, 0.2F, false);
		top_handrails.setTextureOffset(0, 0).addCuboid(9.5F, -39.25F, 0.0F, 0.0F, 2.0F, 0.0F, 0.2F, false);
		top_handrails.setTextureOffset(0, 0).addCuboid(9.5F, -39.25F, -16.75F, 0.0F, 2.0F, 0.0F, 0.2F, false);
		top_handrails.setTextureOffset(0, 0).addCuboid(9.5F, -39.25F, -31.5F, 0.0F, 2.0F, 0.0F, 0.2F, false);
		top_handrails.setTextureOffset(0, 0).addCuboid(9.5F, -39.25F, -44.5F, 0.0F, 2.0F, 0.0F, 0.2F, false);
		top_handrails.setTextureOffset(0, 0).addCuboid(-9.5F, -39.25F, 44.5F, 0.0F, 2.0F, 0.0F, 0.2F, true);
		top_handrails.setTextureOffset(0, 0).addCuboid(-9.5F, -39.25F, 31.5F, 0.0F, 2.0F, 0.0F, 0.2F, true);
		top_handrails.setTextureOffset(0, 0).addCuboid(-9.5F, -39.25F, 15.75F, 0.0F, 2.0F, 0.0F, 0.2F, true);
		top_handrails.setTextureOffset(0, 0).addCuboid(-9.5F, -39.25F, 0.0F, 0.0F, 2.0F, 0.0F, 0.2F, true);
		top_handrails.setTextureOffset(0, 0).addCuboid(-9.5F, -39.25F, -16.75F, 0.0F, 2.0F, 0.0F, 0.2F, true);
		top_handrails.setTextureOffset(0, 0).addCuboid(-9.5F, -39.25F, -31.5F, 0.0F, 2.0F, 0.0F, 0.2F, true);
		top_handrails.setTextureOffset(0, 0).addCuboid(-9.5F, -39.25F, -44.5F, 0.0F, 2.0F, 0.0F, 0.2F, true);
		top_handrails.setTextureOffset(0, 0).addCuboid(9.5F, -37.06F, -44.5F, 0.0F, 0.0F, 89.0F, 0.2F, false);
		top_handrails.setTextureOffset(0, 0).addCuboid(-9.5F, -37.06F, -44.5F, 0.0F, 0.0F, 89.0F, 0.2F, true);

		win_seat_left = new ModelPart(this);
		win_seat_left.setPivot(-0.25F, -1.75F, 24.0F);
		window_seat_handrail.addChild(win_seat_left);
		win_seat_left.setTextureOffset(0, 0).addCuboid(18.75F, -17.25F, 8.0F, 1.0F, 13.0F, 12.0F, 0.0F, false);

		cube_r23 = new ModelPart(this);
		cube_r23.setPivot(-1.5F, 0.0F, -9.0F);
		win_seat_left.addChild(cube_r23);
		setRotationAngle(cube_r23, 0.0F, 0.0F, 0.0873F);
		cube_r23.setTextureOffset(0, 0).addCuboid(13.0F, -7.0F, 17.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);

		win_seat_right = new ModelPart(this);
		win_seat_right.setPivot(0.25F, -1.75F, 23.0F);
		window_seat_handrail.addChild(win_seat_right);
		win_seat_right.setTextureOffset(0, 0).addCuboid(-19.75F, -17.25F, 9.0F, 1.0F, 13.0F, 12.0F, 0.0F, true);

		cube_r24 = new ModelPart(this);
		cube_r24.setPivot(1.5F, 0.0F, -8.0F);
		win_seat_right.addChild(cube_r24);
		setRotationAngle(cube_r24, 0.0F, 0.0F, -0.0873F);
		cube_r24.setTextureOffset(0, 0).addCuboid(-20.0F, -7.0F, 17.0F, 7.0F, 1.0F, 12.0F, 0.0F, true);

		win_seat_left6 = new ModelPart(this);
		win_seat_left6.setPivot(-0.25F, -1.75F, -70.0F);
		window_seat_handrail.addChild(win_seat_left6);
		win_seat_left6.setTextureOffset(0, 0).addCuboid(18.75F, -17.25F, 26.0F, 1.0F, 13.0F, 12.0F, 0.0F, false);

		cube_r25 = new ModelPart(this);
		cube_r25.setPivot(-1.5F, 0.0F, 10.0F);
		win_seat_left6.addChild(cube_r25);
		setRotationAngle(cube_r25, 0.0F, 0.0F, 0.0873F);
		cube_r25.setTextureOffset(0, 0).addCuboid(13.0F, -7.0F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		win_seat_left2.setTextureOffset(0, 0).addCuboid(13.75F, -17.25F, 16.0F, 1.0F, 13.0F, 12.0F, 0.0F, false);

		cube_r26 = new ModelPart(this);
		cube_r26.setPivot(-0.5F, 0.0F, 0.0F);
		win_seat_left2.addChild(cube_r26);
		setRotationAngle(cube_r26, 0.0F, 0.0F, 0.0873F);
		cube_r26.setTextureOffset(0, 0).addCuboid(7.01F, -6.47F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		win_seat_left3.addChild(cube_r27);
		setRotationAngle(cube_r27, 0.0F, 0.0F, 0.0873F);
		cube_r27.setTextureOffset(0, 0).addCuboid(2.04F, -6.04F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		win_seat_left4.addChild(cube_r28);
		setRotationAngle(cube_r28, 0.0F, 0.0F, 0.0873F);
		cube_r28.setTextureOffset(0, 0).addCuboid(23.95F, -7.95F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		win_seat_right2.addChild(cube_r29);
		setRotationAngle(cube_r29, 0.0F, 0.0F, 0.0873F);
		cube_r29.setTextureOffset(0, 0).addCuboid(6.03F, -6.38F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		win_seat_right3.addChild(cube_r30);
		setRotationAngle(cube_r30, 0.0F, 0.0F, 0.0873F);
		cube_r30.setTextureOffset(0, 0).addCuboid(5.04F, -6.3F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		win_seat_right4.addChild(cube_r31);
		setRotationAngle(cube_r31, 0.0F, 0.0F, 0.0873F);
		cube_r31.setTextureOffset(0, 0).addCuboid(20.96F, -7.69F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		win_seat_right5.setTextureOffset(0, 0).addCuboid(29.75F, -17.25F, 16.0F, 1.0F, 13.0F, 12.0F, 0.0F, false);

		cube_r32 = new ModelPart(this);
		cube_r32.setPivot(-0.5F, 0.0F, 0.0F);
		win_seat_right5.addChild(cube_r32);
		setRotationAngle(cube_r32, 0.0F, 0.0F, 0.0873F);
		cube_r32.setTextureOffset(0, 0).addCuboid(22.95F, -7.8643F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		win_seat_left5.setTextureOffset(0, 0).addCuboid(29.75F, -17.25F, 16.0F, 1.0F, 13.0F, 12.0F, 0.0F, false);

		cube_r33 = new ModelPart(this);
		cube_r33.setPivot(-0.5F, 0.0F, 0.0F);
		win_seat_left5.addChild(cube_r33);
		setRotationAngle(cube_r33, 0.0F, 0.0F, 0.0873F);
		cube_r33.setTextureOffset(0, 0).addCuboid(22.95F, -7.8643F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		handrail_window_left7.setTextureOffset(0, 0).addCuboid(11.0F, -33.06F, -19.5F, 0.0F, 26.0F, 0.0F, 0.2F, false);

		cube_r34 = new ModelPart(this);
		cube_r34.setPivot(10.25F, -35.185F, -19.5F);
		handrail_window_left7.addChild(cube_r34);
		setRotationAngle(cube_r34, 0.0F, 0.0F, -0.3622F);
		cube_r34.setTextureOffset(0, 0).addCuboid(0.0F, -2.0F, 0.0F, 0.0F, 4.0F, 0.0F, 0.2F, true);

		cube_r35 = new ModelPart(this);
		cube_r35.setPivot(10.6875F, -6.95F, -19.55F);
		handrail_window_left7.addChild(cube_r35);
		setRotationAngle(cube_r35, 0.8598F, -0.6048F, 3.0693F);
		cube_r35.setTextureOffset(0, 0).addCuboid(-0.2075F, 0.2F, 0.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);

		cube_r36 = new ModelPart(this);
		cube_r36.setPivot(12.375F, -7.3125F, -13.8125F);
		handrail_window_left7.addChild(cube_r36);
		setRotationAngle(cube_r36, 1.399F, -1.1819F, -1.3833F);
		cube_r36.setTextureOffset(0, 0).addCuboid(-3.0F, 0.0025F, 0.0025F, 2.0F, 0.0F, 0.0F, 0.2F, false);

		cube_r37 = new ModelPart(this);
		cube_r37.setPivot(12.75F, -6.125F, -14.9375F);
		handrail_window_left7.addChild(cube_r37);
		setRotationAngle(cube_r37, 0.0F, -1.2654F, 0.0F);
		cube_r37.setTextureOffset(0, 0).addCuboid(-4.0F, 0.0F, 0.0075F, 2.0F, 0.0F, 0.0F, 0.2F, false);
		...
		handrail_window_left6.setTextureOffset(0, 0).addCuboid(11.0F, -33.06F, 49.5F, 0.0F, 26.0F, 0.0F, 0.2F, false);
		handrail_window_left6.setTextureOffset(0, 0).addCuboid(18.93F, -13.62F, 48.5F, 0.0F, 0.0F, 1.0F, 0.2F, false);
		handrail_window_left6.setTextureOffset(0, 0).addCuboid(12.5F, -9.31F, 49.5F, 0.0F, 1.0F, 0.0F, 0.2F, false);
		handrail_window_left6.setTextureOffset(0, 0).addCuboid(12.5F, -8.06F, 49.5F, 4.0F, 0.0F, 0.0F, 0.2F, false);
		handrail_window_left6.setTextureOffset(0, 0).addCuboid(16.5F, -12.06F, 49.5F, 0.0F, 4.0F, 0.0F, 0.2F, false);

		cube_r38 = new ModelPart(this);
		cube_r38.setPivot(10.25F, -35.185F, 49.5F);
		handrail_window_left6.addChild(cube_r38);
		setRotationAngle(cube_r38, 0.0F, 0.0F, -0.3622F);
		cube_r38.setTextureOffset(0, 0).addCuboid(0.0F, -2.0F, 0.0F, 0.0F, 4.0F, 0.0F, 0.2F, true);

		cube_r39 = new ModelPart(this);
		cube_r39.setPivot(12.5F, -9.5625F, 49.5F);
		handrail_window_left6.addChild(cube_r39);
		setRotationAngle(cube_r39, 0.0F, 0.0F, 1.0036F);
		cube_r39.setTextureOffset(0, 0).addCuboid(0.0F, -7.4975F, 0.0F, 0.0F, 9.0F, 0.0F, 0.2F, false);

		cube_r40 = new ModelPart(this);
		cube_r40.setPivot(10.6875F, -6.95F, 49.55F);
		handrail_window_left6.addChild(cube_r40);
		setRotationAngle(cube_r40, -0.8598F, 0.6048F, 3.0693F);
		cube_r40.setTextureOffset(0, 0).addCuboid(-0.2075F, 0.2F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);

		cube_r41 = new ModelPart(this);
		cube_r41.setPivot(12.375F, -7.3125F, 43.8125F);
		handrail_window_left6.addChild(cube_r41);
		setRotationAngle(cube_r41, -1.399F, 1.1819F, -1.3833F);
		cube_r41.setTextureOffset(0, 0).addCuboid(-3.0F, 0.0025F, 0.0075F, 2.0F, 0.0F, 0.0F, 0.2F, false);

		cube_r42 = new ModelPart(this);
		cube_r42.setPivot(12.75F, -6.125F, 44.9375F);
		handrail_window_left6.addChild(cube_r42);
		setRotationAngle(cube_r42, 0.0F, 1.2654F, 0.0F);
		cube_r42.setTextureOffset(0, 0).addCuboid(-4.0F, 0.0F, 0.0025F, 2.0F, 0.0F, 0.0F, 0.2F, false);
		...
		handrail_window_left5.setTextureOffset(0, 0).addCuboid(11.0F, -33.31F, 33.0F, 0.0F, 16.0F, 0.0F, 0.2F, false);

		cube_r43 = new ModelPart(this);
		cube_r43.setPivot(11.75F, -35.185F, 33.0F);
		handrail_window_left5.addChild(cube_r43);
		setRotationAngle(cube_r43, 0.0F, 0.0F, 0.3622F);
		cube_r43.setTextureOffset(0, 0).addCuboid(0.0F, -2.0F, 0.0F, 0.0F, 4.0F, 0.0F, 0.2F, false);

		cube_r44 = new ModelPart(this);
		cube_r44.setPivot(10.75F, -17.1375F, 32.8F);
		handrail_window_left5.addChild(cube_r44);
		setRotationAngle(cube_r44, 0.0F, 1.5708F, -2.4871F);
		cube_r44.setTextureOffset(0, 0).addCuboid(-0.2F, 0.2375F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);
		...
		handrail_window_left4.addChild(cube_r45);
		setRotationAngle(cube_r45, 0.0F, 0.0F, 0.3622F);
		cube_r45.setTextureOffset(0, 0).addCuboid(0.0F, -2.0F, 0.0F, 0.0F, 4.0F, 0.0F, 0.2F, false);
		...
		cube_r46.setTextureOffset(0, 0).addCuboid(-0.2F, 0.2375F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);
		...
		handrail_window_left3.setTextureOffset(0, 0).addCuboid(11.0F, -33.31F, 27.75F, 0.0F, 16.0F, 0.0F, 0.2F, false);

		cube_r47 = new ModelPart(this);
		cube_r47.setPivot(11.75F, -35.185F, 27.75F);
		handrail_window_left3.addChild(cube_r47);
		setRotationAngle(cube_r47, 0.0F, 0.0F, 0.3622F);
		cube_r47.setTextureOffset(0, 0).addCuboid(0.0F, -2.0F, 0.0F, 0.0F, 4.0F, 0.0F, 0.2F, false);

		cube_r48 = new ModelPart(this);
		cube_r48.setPivot(10.75F, -17.1375F, 27.55F);
		handrail_window_left3.addChild(cube_r48);
		setRotationAngle(cube_r48, 0.0F, 1.5708F, -2.4871F);
		cube_r48.setTextureOffset(0, 0).addCuboid(-0.2F, 0.2075F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);
		...
		handrail_window_left2.setTextureOffset(0, 0).addCuboid(11.0F, -33.06F, -41.5F, 0.0F, 26.0F, 0.0F, 0.2F, false);
		handrail_window_left2.setTextureOffset(0, 0).addCuboid(18.93F, -13.6F, -41.5F, 0.0F, 0.0F, 1.0F, 0.2F, false);
		handrail_window_left2.setTextureOffset(0, 0).addCuboid(12.5F, -9.31F, -41.5F, 0.0F, 1.0F, 0.0F, 0.2F, false);
		handrail_window_left2.setTextureOffset(0, 0).addCuboid(12.5F, -8.06F, -41.5F, 4.0F, 0.0F, 0.0F, 0.2F, false);
		handrail_window_left2.setTextureOffset(0, 0).addCuboid(16.5F, -12.06F, -41.5F, 0.0F, 4.0F, 0.0F, 0.2F, false);

		cube_r49 = new ModelPart(this);
		cube_r49.setPivot(10.25F, -35.185F, -41.5F);
		handrail_window_left2.addChild(cube_r49);
		setRotationAngle(cube_r49, 0.0F, 0.0F, -0.3622F);
		cube_r49.setTextureOffset(0, 0).addCuboid(0.0F, -2.0F, 0.0F, 0.0F, 4.0F, 0.0F, 0.2F, true);

		cube_r50 = new ModelPart(this);
		cube_r50.setPivot(12.5F, -9.5625F, -41.5F);
		handrail_window_left2.addChild(cube_r50);
		setRotationAngle(cube_r50, 0.0F, 0.0F, 1.0036F);
		cube_r50.setTextureOffset(0, 0).addCuboid(0.0F, -7.4975F, 0.0F, 0.0F, 9.0F, 0.0F, 0.2F, false);

		cube_r51 = new ModelPart(this);
		cube_r51.setPivot(10.6875F, -6.95F, -41.55F);
		handrail_window_left2.addChild(cube_r51);
		setRotationAngle(cube_r51, 0.8598F, -0.6048F, 3.0693F);
		cube_r51.setTextureOffset(0, 0).addCuboid(-0.2075F, 0.2F, 0.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);

		cube_r52 = new ModelPart(this);
		cube_r52.setPivot(12.375F, -7.3125F, -35.8125F);
		handrail_window_left2.addChild(cube_r52);
		setRotationAngle(cube_r52, 1.399F, -1.1819F, -1.3833F);
		cube_r52.setTextureOffset(0, 0).addCuboid(-3.005F, 0.0025F, -0.0075F, 2.0F, 0.0F, 0.0F, 0.2F, false);

		cube_r53 = new ModelPart(this);
		cube_r53.setPivot(12.75F, -6.125F, -36.9375F);
		handrail_window_left2.addChild(cube_r53);
		setRotationAngle(cube_r53, 0.0F, -1.2654F, 0.0F);
		cube_r53.setTextureOffset(0, 0).addCuboid(-4.0F, 0.005F, -0.0025F, 2.0F, 0.0F, 0.0F, 0.2F, false);
		...
		handrail_window_left1.setTextureOffset(0, 0).addCuboid(11.0F, -33.06F, 27.5F, 0.0F, 26.0F, 0.0F, 0.2F, false);

		cube_r54 = new ModelPart(this);
		cube_r54.setPivot(10.25F, -35.185F, 27.5F);
		handrail_window_left1.addChild(cube_r54);
		setRotationAngle(cube_r54, 0.0F, 0.0F, -0.3622F);
		cube_r54.setTextureOffset(0, 0).addCuboid(0.0F, -2.0F, 0.0F, 0.0F, 4.0F, 0.0F, 0.2F, true);

		cube_r55 = new ModelPart(this);
		cube_r55.setPivot(10.6875F, -6.95F, 27.55F);
		handrail_window_left1.addChild(cube_r55);
		setRotationAngle(cube_r55, -0.8598F, 0.6048F, 3.0693F);
		cube_r55.setTextureOffset(0, 0).addCuboid(-0.2075F, 0.2F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);

		cube_r56 = new ModelPart(this);
		cube_r56.setPivot(12.375F, -7.3125F, 21.8125F);
		handrail_window_left1.addChild(cube_r56);
		setRotationAngle(cube_r56, -1.399F, 1.1819F, -1.3833F);
		cube_r56.setTextureOffset(0, 0).addCuboid(-3.075F, 0.0025F, -0.0025F, 2.0F, 0.0F, 0.0F, 0.2F, false);

		cube_r57 = new ModelPart(this);
		cube_r57.setPivot(12.75F, -6.125F, 22.9375F);
		handrail_window_left1.addChild(cube_r57);
		setRotationAngle(cube_r57, 0.0F, 1.2654F, 0.0F);
		cube_r57.setTextureOffset(0, 0).addCuboid(-4.0F, 0.025F, -0.0075F, 2.0F, 0.0F, 0.0F, 0.2F, false);
		...
		handrail_window_right5.setTextureOffset(0, 0).addCuboid(-11.0F, -33.31F, 27.75F, 0.0F, 16.0F, 0.0F, 0.2F, true);

		cube_r58 = new ModelPart(this);
		cube_r58.setPivot(-11.75F, -35.185F, 27.75F);
		handrail_window_right5.addChild(cube_r58);
		setRotationAngle(cube_r58, 0.0F, 0.0F, -0.3622F);
		cube_r58.setTextureOffset(0, 0).addCuboid(0.0F, -2.0F, 0.0F, 0.0F, 4.0F, 0.0F, 0.2F, true);

		cube_r59 = new ModelPart(this);
		cube_r59.setPivot(-10.75F, -17.1375F, 27.55F);
		handrail_window_right5.addChild(cube_r59);
		setRotationAngle(cube_r59, 0.0F, -1.5708F, 2.4871F);
		cube_r59.setTextureOffset(0, 0).addCuboid(0.2F, 0.2075F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, false);
		...
		cube_r60.setPivot(-11.75F, -35.185F, 30.75F);
		handrail_window_right4.addChild(cube_r60);
		setRotationAngle(cube_r60, 0.0F, 0.0F, -0.3622F);
		cube_r60.setTextureOffset(0, 0).addCuboid(0.0F, -2.0F, 0.0F, 0.0F, 4.0F, 0.0F, 0.2F, true);

		cube_r61 = new ModelPart(this);
		cube_r61.setPivot(-10.75F, -17.1375F, 30.55F);
		handrail_window_right4.addChild(cube_r61);
		...
		handrail_window_right3.addChild(cube_r62);
		...
		handrail_window_right3.addChild(cube_r63);
		...
		handrail_window_right2.setTextureOffset(0, 0).addCuboid(-11.0F, -33.06F, -44.5F, 0.0F, 26.0F, 0.0F, 0.2F, true);
		handrail_window_right2.setTextureOffset(0, 0).addCuboid(-18.93F, -13.6F, -44.5F, 0.0F, 0.0F, 1.0F, 0.2F, true);
		handrail_window_right2.setTextureOffset(0, 0).addCuboid(-12.5F, -9.31F, -44.5F, 0.0F, 1.0F, 0.0F, 0.2F, true);
		handrail_window_right2.setTextureOffset(0, 0).addCuboid(-16.5F, -8.06F, -44.5F, 4.0F, 0.0F, 0.0F, 0.2F, true);
		handrail_window_right2.setTextureOffset(0, 0).addCuboid(-16.5F, -12.06F, -44.5F, 0.0F, 4.0F, 0.0F, 0.2F, true);

		cube_r64 = new ModelPart(this);
		cube_r64.setPivot(-12.5F, -9.5625F, -44.5F);
		handrail_window_right2.addChild(cube_r64);
		setRotationAngle(cube_r64, 0.0F, 0.0F, -1.0036F);
		cube_r64.setTextureOffset(0, 0).addCuboid(0.0F, -7.4975F, 0.0F, 0.0F, 9.0F, 0.0F, 0.2F, true);

		cube_r65 = new ModelPart(this);
		cube_r65.setPivot(-10.25F, -35.185F, -44.5F);
		handrail_window_right2.addChild(cube_r65);
		setRotationAngle(cube_r65, 0.0F, 0.0F, 0.3622F);
		cube_r65.setTextureOffset(0, 0).addCuboid(0.0F, -2.0F, 0.0F, 0.0F, 4.0F, 0.0F, 0.2F, false);

		cube_r66 = new ModelPart(this);
		cube_r66.setPivot(-10.6875F, -6.95F, -44.55F);
		handrail_window_right2.addChild(cube_r66);
		setRotationAngle(cube_r66, 0.8598F, 0.6048F, -3.0693F);
		cube_r66.setTextureOffset(0, 0).addCuboid(0.2075F, 0.2F, 0.2F, 0.0F, 0.0F, 1.0F, 0.2F, false);

		cube_r67 = new ModelPart(this);
		cube_r67.setPivot(-12.375F, -7.3125F, -38.8125F);
		handrail_window_right2.addChild(cube_r67);
		setRotationAngle(cube_r67, 1.399F, 1.1819F, 1.3833F);
		cube_r67.setTextureOffset(0, 0).addCuboid(1.0F, 0.0025F, -0.0875F, 2.0F, 0.0F, 0.0F, 0.2F, true);

		cube_r68 = new ModelPart(this);
		cube_r68.setPivot(-12.75F, -6.125F, -39.9375F);
		handrail_window_right2.addChild(cube_r68);
		setRotationAngle(cube_r68, 0.0F, 1.2654F, 0.0F);
		cube_r68.setTextureOffset(0, 0).addCuboid(2.0F, 0.0F, -0.0025F, 2.0F, 0.0F, 0.0F, 0.2F, true);
		...
		handrail_window_right1.setTextureOffset(0, 0).addCuboid(-11.0F, -33.06F, 27.5F, 0.0F, 26.0F, 0.0F, 0.2F, true);

		cube_r69 = new ModelPart(this);
		cube_r69.setPivot(-10.6875F, -6.95F, 27.55F);
		handrail_window_right1.addChild(cube_r69);
		setRotationAngle(cube_r69, -0.8598F, -0.6048F, -3.0693F);
		cube_r69.setTextureOffset(0, 0).addCuboid(0.2075F, 0.2F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, false);

		cube_r70 = new ModelPart(this);
		cube_r70.setPivot(-12.375F, -7.3125F, 21.8125F);
		handrail_window_right1.addChild(cube_r70);
		setRotationAngle(cube_r70, -1.399F, -1.1819F, 1.3833F);
		cube_r70.setTextureOffset(0, 0).addCuboid(1.075F, 0.0025F, -0.0025F, 2.0F, 0.0F, 0.0F, 0.2F, true);

		cube_r71 = new ModelPart(this);
		cube_r71.setPivot(-12.75F, -6.125F, 22.9375F);
		handrail_window_right1.addChild(cube_r71);
		setRotationAngle(cube_r71, 0.0F, -1.2654F, 0.0F);
		cube_r71.setTextureOffset(0, 0).addCuboid(2.0F, 0.025F, -0.0075F, 2.0F, 0.0F, 0.0F, 0.2F, true);

		cube_r72 = new ModelPart(this);
		cube_r72.setPivot(-10.25F, -35.185F, 27.5F);
		handrail_window_right1.addChild(cube_r72);
		setRotationAngle(cube_r72, 0.0F, 0.0F, 0.3622F);
		cube_r72.setTextureOffset(0, 0).addCuboid(0.0F, -2.0F, 0.0F, 0.0F, 4.0F, 0.0F, 0.2F, false);

		blue_floor = new ModelPart(this);
		blue_floor.setPivot(0.0F, 0.0F, -1.0F);
		window_seat_handrail.addChild(blue_floor);
		blue_floor.setTextureOffset(0, 0).addCuboid(-18.0F, -0.125F, -44.0F, 10.0F, 0.0F, 14.0F, 0.0F, false);
		...
		roof_head.setTextureOffset(98, 73).addCuboid(-17.5F, -39.0F, -44.0F, 35.0F, 0.0F, 57.0F, 0.0F, false);
		...
		roof_window.setTextureOffset(98, 73).addCuboid(-17.5F, -39.0F, -45.0F, 35.0F, 0.0F, 90.0F, 0.0F, false);

		roof_end = new ModelPart(this);
		roof_end.setPivot(0.0F, 24.0F, 0.0F);
		roof_end.setTextureOffset(98, 73).addCuboid(-17.5F, -39.0F, -44.0F, 35.0F, 0.0F, 57.0F, 0.0F, false);
		roof_end.setTextureOffset(98, 73).addCuboid(-17.5F, -39.0F, -41.0F, 35.0F, 3.0F, 65.0F, 0.0F, false);
		...
		head.setTextureOffset(0, 51).addCuboid(-22.15F, -10.9F, -44.0F, 2.0F, 11.0F, 57.0F, 0.0F, false);
		head.setTextureOffset(0, 51).addCuboid(20.15F, -10.9F, -44.0F, 2.0F, 11.0F, 57.0F, 0.0F, true);
		...
		wall_right_2_r5.setTextureOffset(0, 51).addCuboid(22.9978F, -24.0059F, -47.0F, 2.0F, 29.0F, 57.0F, 0.0F, true);
		...
		wall_left_1_r5.setTextureOffset(0, 51).addCuboid(-24.9978F, -23.9959F, -47.0F, 2.0F, 29.0F, 57.0F, 0.0F, false);
		...
		front_bottom_3_r1.setTextureOffset(0, 0).addCuboid(-1.5F, -1.0F, -18.5F, 3.0F, 2.0F, 19.0F, 0.0F, true);
		...
		front_bottom_2_r1.setTextureOffset(0, 0).addCuboid(-1.5F, -1.0F, -13.5F, 3.0F, 2.0F, 19.0F, 0.0F, false);
		...
		cab_door_back.setTextureOffset(121, 115).addCuboid(-7.0F, -36.0F, -3.0F, 14.0F, 36.0F, 0.0F, 0.0F, false);
		cab_door_back.setTextureOffset(145, 115).addCuboid(-22.0F, -36.0F, -8.0F, 15.0F, 36.0F, 0.0F, 0.0F, false);
		cab_door_back.setTextureOffset(145, 115).addCuboid(7.0F, -36.0F, -8.0F, 15.0F, 36.0F, 0.0F, 0.0F, false);
		cab_door_back.setTextureOffset(145, 115).addCuboid(-22.0F, -39.0F, -8.0F, 44.0F, 3.0F, 0.0F, 0.0F, false);
		...
		front_inside_2_r1.setTextureOffset(121, 115).addCuboid(-8.0F, -36.0F, -6.0F, 5.0F, 36.0F, 0.0F, 0.0F, false);
		...
		front_inside_1_r1.setTextureOffset(121, 115).addCuboid(-8.0F, -36.0F, 6.0F, 5.0F, 36.0F, 0.0F, 0.0F, false);

		head_exterior = new ModelPart(this);
		head_exterior.setPivot(0.0F, 24.0F, 0.0F);
		head_exterior.setTextureOffset(0, 124).addCuboid(-21.75F, 0.0F, -37.0F, 1.0F, 3.0F, 45.0F, 0.0F, false);
		head_exterior.setTextureOffset(39, 91).addCuboid(20.75F, 0.0F, -44.0F, 1.0F, 3.0F, 52.0F, 0.0F, false);
		head_exterior.setTextureOffset(39, 91).addCuboid(16.8F, 3.0F, -44.0F, 4.0F, 3.0F, 20.0F, 0.0F, false);
		head_exterior.setTextureOffset(39, 91).addCuboid(-20.8F, 3.0F, -44.0F, 4.0F, 3.0F, 20.0F, 0.0F, true);
		...
		buttom_panel_6_r2.setTextureOffset(114, 0).addCuboid(0.0F, -4.1F, -14.0F, 1.0F, 3.0F, 13.0F, 0.0F, true);

		buttom_panel_5_r2 = new ModelPart(this);
		buttom_panel_5_r2.setPivot(21.5625F, 4.1F, -30.0F);
		...
		floor_5_r1.setTextureOffset(39, 91).addCuboid(-0.925F, -1.5F, -26.0F, 2.0F, 3.0F, 20.0F, 0.0F, true);
		...
		floor_4_r1.setTextureOffset(39, 91).addCuboid(-1.075F, -1.5F, -26.0F, 2.0F, 3.0F, 20.0F, 0.0F, false);

		head_bottom_out = new ModelPart(this);
		head_bottom_out.setPivot(0.0F, 0.1F, -23.0F);
		head_exterior.addChild(head_bottom_out);
		head_bottom_out.setTextureOffset(114, 0).addCuboid(-6.5F, -0.1F, -24.0F, 13.0F, 3.0F, 9.0F, 0.0F, false);
		head_bottom_out.setTextureOffset(114, 0).addCuboid(-21.5F, -0.1F, -21.0F, 7.0F, 3.0F, 8.0F, 0.0F, false);
		head_bottom_out.setTextureOffset(114, 0).addCuboid(14.5F, -0.1F, -21.0F, 7.0F, 3.0F, 8.0F, 0.0F, false);
		...
		walls.setTextureOffset(0, 51).addCuboid(-22.15F, -9.9F, -44.0F, 2.0F, 11.0F, 57.0F, 0.0F, false);
		walls.setTextureOffset(0, 51).addCuboid(20.15F, -9.9F, -44.0F, 2.0F, 11.0F, 57.0F, 0.0F, true);

		bottom_wall_right_r4 = new ModelPart(this);
		bottom_wall_right_r4.setPivot(0.4068F, 5.1977F, -12.0F);
		walls.addChild(bottom_wall_right_r4);
		setRotationAngle(bottom_wall_right_r4, -0.1309F, 1.5708F, 0.0F);
		bottom_wall_right_r4.setTextureOffset(0, 51).addCuboid(-20.0068F, -7.0007F, 21.0F, 52.0F, 3.0F, 0.0F, 0.0F, true);
		...
		bottom_wall_left_r3.setTextureOffset(0, 51).addCuboid(-32.0032F, -7.0007F, 21.0F, 52.0F, 3.0F, 0.0F, 0.0F, false);
		...
		wall_right_2_r6.setTextureOffset(0, 51).addCuboid(22.9978F, -23.9959F, -47.0F, 2.0F, 29.0F, 57.0F, 0.0F, true);
		...
		wall_left_1_r6.setTextureOffset(0, 51).addCuboid(-24.9978F, -23.9959F, -47.0F, 2.0F, 29.0F, 57.0F, 0.0F, false);

		exteror_cab_front = new ModelPart(this);
		exteror_cab_front.setPivot(0.0F, 0.0F, -9.0F);
		head_exterior.addChild(exteror_cab_front);
		exteror_cab_front.setTextureOffset(145, 115).addCuboid(-22.0F, -42.0F, -35.0F, 15.0F, 42.0F, 0.0F, 0.0F, false);
		exteror_cab_front.setTextureOffset(145, 115).addCuboid(7.0F, -42.0F, -35.0F, 15.0F, 42.0F, 0.0F, 0.0F, false);
		exteror_cab_front.setTextureOffset(0, 33).addCuboid(-7.0F, -42.0F, -35.0F, 14.0F, 6.0F, 0.0F, 0.0F, false);
		...
		cab_door.setTextureOffset(121, 115).addCuboid(-7.0F, -36.0F, -31.0F, 14.0F, 36.0F, 0.0F, 0.0F, false);
		...
		front_train_barrier.setTextureOffset(0, 0).addCuboid(-20.75F, -14.0F, -47.0F, 0.0F, 10.0F, 3.0F, 0.3F, false);
		front_train_barrier.setTextureOffset(0, 0).addCuboid(-7.75F, -14.0F, -47.0F, 0.0F, 5.0F, 3.0F, 0.3F, false);
		front_train_barrier.setTextureOffset(0, 0).addCuboid(20.75F, -14.0F, -47.0F, 0.0F, 10.0F, 3.0F, 0.3F, true);
		front_train_barrier.setTextureOffset(0, 0).addCuboid(7.75F, -14.0F, -47.0F, 0.0F, 13.0F, 3.0F, 0.3F, true);

		roof_window_light = new ModelPart(this);
		roof_window_light.setPivot(0.0F, 24.0F, 0.0F);
		roof_window_light.setTextureOffset(98, 73).addCuboid(11.75F, -39.5F, -45.0F, 2.0F, 1.0F, 90.0F, 0.0F, false);
		roof_window_light.setTextureOffset(98, 73).addCuboid(-13.75F, -39.5F, -45.0F, 2.0F, 1.0F, 90.0F, 0.0F, true);
		...
		roof_head_light.setTextureOffset(98, 73).addCuboid(11.75F, -36.5F, -6.0F, 2.0F, 1.0F, 30.0F, 0.0F, false);
		roof_head_light.setTextureOffset(98, 73).addCuboid(-13.75F, -36.5F, -6.0F, 2.0F, 1.0F, 30.0F, 0.0F, true);

		roof_end_light = new ModelPart(this);
		roof_end_light.setPivot(0.0F, 24.0F, 0.0F);
		roof_end_light.setTextureOffset(98, 73).addCuboid(11.75F, -36.5F, -40.0F, 2.0F, 1.0F, 64.0F, 0.0F, false);
		roof_end_light.setTextureOffset(98, 73).addCuboid(-13.75F, -36.5F, -40.0F, 2.0F, 1.0F, 64.0F, 0.0F, true);

		tail_lights = new ModelPart(this);
		tail_lights.setPivot(0.0F, 24.0F, 0.0F);
		tail_lights.setTextureOffset(0, 0).addCuboid(-19.0F, -10.0F, -44.25F, 4.0F, 4.0F, 0.0F, 0.0F, false);
		tail_lights.setTextureOffset(0, 0).addCuboid(15.0F, -10.0F, -44.25F, 4.0F, 4.0F, 0.0F, 0.0F, false);
		tail_lights.setTextureOffset(0, 0).addCuboid(-17.0F, -39.0F, -44.25F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		tail_lights.setTextureOffset(0, 0).addCuboid(14.0F, -39.0F, -44.25F, 3.0F, 3.0F, 0.0F, 0.0F, false);

		headlights = new ModelPart(this);
		headlights.setPivot(0.0F, 24.0F, 0.0F);
		headlights.setTextureOffset(0, 0).addCuboid(10.5F, -8.0F, -44.25F, 4.0F, 4.0F, 0.0F, 0.0F, false);
		headlights.setTextureOffset(0, 0).addCuboid(-14.5F, -8.0F, -44.25F, 4.0F, 4.0F, 0.0F, 0.0F, false);
		headlights.setTextureOffset(0, 0).addCuboid(-13.5F, -39.0F, -44.25F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		headlights.setTextureOffset(0, 0).addCuboid(10.5F, -39.0F, -44.25F, 3.0F, 3.0F, 0.0F, 0.0F, false);

		headlights_end = new ModelPart(this);
		headlights_end.setPivot(0.0F, 24.0F, 0.0F);
		headlights_end.setTextureOffset(0, 0).addCuboid(10.5F, -8.0F, -44.25F, 4.0F, 4.0F, 0.0F, 0.0F, false);
		headlights_end.setTextureOffset(0, 0).addCuboid(-14.5F, -8.0F, -44.25F, 4.0F, 4.0F, 0.0F, 0.0F, false);
		headlights_end.setTextureOffset(0, 0).addCuboid(-13.5F, -39.0F, -44.25F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		headlights_end.setTextureOffset(0, 0).addCuboid(10.5F, -39.0F, -44.25F, 3.0F, 3.0F, 0.0F, 0.0F, false);

		tail_lights_end = new ModelPart(this);
		tail_lights_end.setPivot(0.0F, 24.0F, 0.0F);
		tail_lights_end.setTextureOffset(0, 0).addCuboid(-19.0F, -10.0F, -44.25F, 4.0F, 4.0F, 0.0F, 0.0F, false);
		tail_lights_end.setTextureOffset(0, 0).addCuboid(15.0F, -10.0F, -44.25F, 4.0F, 4.0F, 0.0F, 0.0F, false);
		tail_lights_end.setTextureOffset(0, 0).addCuboid(-17.0F, -39.0F, -44.25F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		tail_lights_end.setTextureOffset(0, 0).addCuboid(14.0F, -39.0F, -44.25F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		...
		top_roof_r1.setTextureOffset(80, 56).addCuboid(-33.0F, -3.0F, -48.0F, 0.0F, 4.0F, 90.0F, 0.0F, false);
		top_roof_r1.setTextureOffset(80, 64).addCuboid(-33.0F, -7.0F, -48.0F, 0.0F, 4.0F, 90.0F, 0.0F, false);
		...
		top_roof_r2.setTextureOffset(80, 72).addCuboid(-33.0F, -8.0F, -48.0F, 0.0F, 4.0F, 90.0F, 0.0F, false);
		...
		top_slant_right_r1.setTextureOffset(78, 46).addCuboid(0.0F, -3.5F, -37.0F, 0.0F, 7.0F, 90.0F, 0.0F, true);
		...
		top_roof_r3.setTextureOffset(80, 72).addCuboid(33.0F, -8.0F, -48.0F, 0.0F, 4.0F, 90.0F, 0.0F, true);
		...
		top_roof_r4.setTextureOffset(80, 64).addCuboid(33.0F, -7.0F, -48.0F, 0.0F, 4.0F, 90.0F, 0.0F, true);
		top_roof_r4.setTextureOffset(80, 56).addCuboid(33.0F, -3.0F, -48.0F, 0.0F, 4.0F, 90.0F, 0.0F, true);
		...
		top_slant_left_r1.setTextureOffset(78, 46).addCuboid(0.0F, -3.5F, -37.0F, 0.0F, 7.0F, 90.0F, 0.0F, false);
		...
		top_roof_r5.setTextureOffset(80, 56).addCuboid(-33.0F, -3.0F, -61.0F, 0.0F, 4.0F, 57.0F, 0.0F, false);
		top_roof_r5.setTextureOffset(80, 64).addCuboid(-33.0F, -7.0F, -61.0F, 0.0F, 4.0F, 57.0F, 0.0F, false);
		...
		top_roof_r6.setTextureOffset(80, 72).addCuboid(-33.0F, -8.0F, -61.0F, 0.0F, 4.0F, 57.0F, 0.0F, false);
		...
		top_slant_right_r2.setTextureOffset(78, 46).addCuboid(0.0F, -3.5F, -50.0F, 0.0F, 7.0F, 57.0F, 0.0F, true);
		...
		top_roof_r7.setTextureOffset(80, 72).addCuboid(33.0F, -8.0F, -61.0F, 0.0F, 4.0F, 57.0F, 0.0F, true);
		...
		top_roof_r8.setTextureOffset(80, 64).addCuboid(33.0F, -7.0F, -61.0F, 0.0F, 4.0F, 57.0F, 0.0F, true);
		top_roof_r8.setTextureOffset(80, 56).addCuboid(33.0F, -3.0F, -61.0F, 0.0F, 4.0F, 57.0F, 0.0F, true);
		...
		top_slant_left_r2.setTextureOffset(78, 46).addCuboid(0.0F, -3.5F, -50.0F, 0.0F, 7.0F, 57.0F, 0.0F, false);
		...
		top_roof_r9.setTextureOffset(80, 56).addCuboid(-33.0F, -3.0F, -61.0F, 0.0F, 4.0F, 57.0F, 0.0F, false);
		top_roof_r9.setTextureOffset(80, 64).addCuboid(-33.0F, -7.0F, -61.0F, 0.0F, 4.0F, 57.0F, 0.0F, false);
		...
		top_roof_r10.setTextureOffset(80, 72).addCuboid(-33.0F, -8.0F, -61.0F, 0.0F, 4.0F, 57.0F, 0.0F, false);
		...
		top_slant_right_r3.setTextureOffset(78, 46).addCuboid(0.0F, -3.5F, -50.0F, 0.0F, 7.0F, 57.0F, 0.0F, true);
		...
		top_roof_r11.setTextureOffset(80, 72).addCuboid(33.0F, -8.0F, -61.0F, 0.0F, 4.0F, 57.0F, 0.0F, true);
		...
		top_roof_r12.setTextureOffset(80, 64).addCuboid(33.0F, -7.0F, -61.0F, 0.0F, 4.0F, 57.0F, 0.0F, true);
		top_roof_r12.setTextureOffset(80, 56).addCuboid(33.0F, -3.0F, -61.0F, 0.0F, 4.0F, 57.0F, 0.0F, true);
		...
		top_slant_left_r3.setTextureOffset(78, 46).addCuboid(0.0F, -3.5F, -50.0F, 0.0F, 7.0F, 57.0F, 0.0F, false);
		...
		window_side_panels.setTextureOffset(0, 0).addCuboid(11.0F, -25.0F, -44.5F, 9.0F, 19.0F, 0.0F, 0.0F, false);
		window_side_panels.setTextureOffset(0, 0).addCuboid(11.0F, -25.0F, 44.5F, 9.0F, 19.0F, 0.0F, 0.0F, false);
		window_side_panels.setTextureOffset(0, 0).addCuboid(-20.0F, -25.0F, 44.5F, 9.0F, 19.0F, 0.0F, 0.0F, true);
