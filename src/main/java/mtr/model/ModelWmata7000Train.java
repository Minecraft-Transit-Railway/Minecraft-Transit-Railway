...
private final ModelPart window;
	...
	private final ModelPart train_barrier_1;
	private final ModelPart train_barrier_2;
public ModelWmata7000Train() {
		...
		cube_r23.setPivot(-1.5F, 0.0F, -1.0F);
		...
		cube_r24.setPivot(1.5F, 0.0F, 0.0F);
		...
		cube_r25.setPivot(-1.5F, 0.0F, 2.0F);
		...
		cube_r26.setTextureOffset(0, 0).addCuboid(4.03F, -6.21F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		cube_r28.setTextureOffset(0, 0).addCuboid(23.95F, -8.95F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		cube_r29.setTextureOffset(0, 0).addCuboid(3.04F, -6.12F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		handrail_window_left7.setTextureOffset(0, 0).addCuboid(11.0F, -39.06F, -24.5F, 0.0F, 32.0F, 0.0F, 0.2F, false);

		cube_r34 = new ModelPart(this);
		cube_r34.setPivot(10.6875F, -6.95F, -24.55F);
		handrail_window_left7.addChild(cube_r34);
		setRotationAngle(cube_r34, 0.8598F, -0.6048F, 3.0693F);
		cube_r34.setTextureOffset(0, 0).addCuboid(-0.2075F, 0.2F, 0.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);

		cube_r35 = new ModelPart(this);
		cube_r35.setPivot(12.375F, -7.3125F, -18.8125F);
		handrail_window_left7.addChild(cube_r35);
		setRotationAngle(cube_r35, 1.399F, -1.1819F, -1.3833F);
		cube_r35.setTextureOffset(0, 0).addCuboid(-3.0F, 0.0025F, 0.0025F, 2.0F, 0.0F, 0.0F, 0.2F, false);

		cube_r36 = new ModelPart(this);
		cube_r36.setPivot(12.75F, -6.125F, -19.9375F);
		handrail_window_left7.addChild(cube_r36);
		setRotationAngle(cube_r36, 0.0F, -1.2654F, 0.0F);
		cube_r36.setTextureOffset(0, 0).addCuboid(-4.0F, 0.0F, 0.0075F, 2.0F, 0.0F, 0.0F, 0.2F, false);
		...
		handrail_window_left6.setTextureOffset(0, 0).addCuboid(11.0F, -39.06F, 44.5F, 0.0F, 32.0F, 0.0F, 0.2F, false);
		...
		cube_r37.setPivot(12.5F, -9.5625F, 44.5F);
		handrail_window_left6.addChild(cube_r37);
		setRotationAngle(cube_r37, 0.0F, 0.0F, 1.0036F);
		cube_r37.setTextureOffset(0, 0).addCuboid(0.0F, -7.4975F, 0.0F, 0.0F, 9.0F, 0.0F, 0.2F, false);

		cube_r38 = new ModelPart(this);
		cube_r38.setPivot(10.6875F, -6.95F, 44.55F);
		handrail_window_left6.addChild(cube_r38);
		setRotationAngle(cube_r38, -0.8598F, 0.6048F, 3.0693F);
		cube_r38.setTextureOffset(0, 0).addCuboid(-0.2075F, 0.2F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);

		cube_r39 = new ModelPart(this);
		cube_r39.setPivot(12.375F, -7.3125F, 38.8125F);
		handrail_window_left6.addChild(cube_r39);
		setRotationAngle(cube_r39, -1.399F, 1.1819F, -1.3833F);
		cube_r39.setTextureOffset(0, 0).addCuboid(-3.0F, 0.0025F, 0.0075F, 2.0F, 0.0F, 0.0F, 0.2F, false);

		cube_r40 = new ModelPart(this);
		cube_r40.setPivot(12.75F, -6.125F, 39.9375F);
		handrail_window_left6.addChild(cube_r40);
		setRotationAngle(cube_r40, 0.0F, 1.2654F, 0.0F);
		cube_r40.setTextureOffset(0, 0).addCuboid(-4.0F, 0.0F, 0.0025F, 2.0F, 0.0F, 0.0F, 0.2F, false);
		...
		handrail_window_left5.setTextureOffset(0, 0).addCuboid(11.0F, -39.31F, 30.75F, 0.0F, 22.0F, 0.0F, 0.2F, false);

		cube_r41 = new ModelPart(this);
		cube_r41.setPivot(10.75F, -17.1375F, 30.55F);
		handrail_window_left5.addChild(cube_r41);
		setRotationAngle(cube_r41, 0.0F, 1.5708F, -2.4871F);
		cube_r41.setTextureOffset(0, 0).addCuboid(-0.2F, 0.2375F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);
		...
		handrail_window_left4.setTextureOffset(0, 0).addCuboid(11.0F, -39.31F, 30.75F, 0.0F, 22.0F, 0.0F, 0.2F, false);

		cube_r42 = new ModelPart(this);
		cube_r42.setPivot(10.75F, -17.1375F, 30.55F);
		handrail_window_left4.addChild(cube_r42);
		setRotationAngle(cube_r42, 0.0F, 1.5708F, -2.4871F);
		cube_r42.setTextureOffset(0, 0).addCuboid(-0.2F, 0.2375F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);
		...
		handrail_window_left3.setTextureOffset(0, 0).addCuboid(11.0F, -39.31F, 30.75F, 0.0F, 22.0F, 0.0F, 0.2F, false);

		cube_r43 = new ModelPart(this);
		cube_r43.setPivot(10.75F, -17.1375F, 30.55F);
		handrail_window_left3.addChild(cube_r43);
		setRotationAngle(cube_r43, 0.0F, 1.5708F, -2.4871F);
		cube_r43.setTextureOffset(0, 0).addCuboid(-0.2F, 0.2075F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);
		...
		handrail_window_left2.setTextureOffset(0, 0).addCuboid(11.0F, -39.06F, -36.5F, 0.0F, 32.0F, 0.0F, 0.2F, false);
		...
		cube_r44.setPivot(12.5F, -9.5625F, -36.5F);
		handrail_window_left2.addChild(cube_r44);
		setRotationAngle(cube_r44, 0.0F, 0.0F, 1.0036F);
		cube_r44.setTextureOffset(0, 0).addCuboid(0.0F, -7.4975F, 0.0F, 0.0F, 9.0F, 0.0F, 0.2F, false);

		cube_r45 = new ModelPart(this);
		cube_r45.setPivot(10.6875F, -6.95F, -36.55F);
		handrail_window_left2.addChild(cube_r45);
		setRotationAngle(cube_r45, 0.8598F, -0.6048F, 3.0693F);
		cube_r45.setTextureOffset(0, 0).addCuboid(-0.2075F, 0.2F, 0.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);

		cube_r46 = new ModelPart(this);
		cube_r46.setPivot(12.375F, -7.3125F, -30.8125F);
		handrail_window_left2.addChild(cube_r46);
		setRotationAngle(cube_r46, 1.399F, -1.1819F, -1.3833F);
		cube_r46.setTextureOffset(0, 0).addCuboid(-3.005F, 0.0025F, -0.0075F, 2.0F, 0.0F, 0.0F, 0.2F, false);

		cube_r47 = new ModelPart(this);
		cube_r47.setPivot(12.75F, -6.125F, -31.9375F);
		handrail_window_left2.addChild(cube_r47);
		setRotationAngle(cube_r47, 0.0F, -1.2654F, 0.0F);
		cube_r47.setTextureOffset(0, 0).addCuboid(-4.0F, 0.005F, -0.0025F, 2.0F, 0.0F, 0.0F, 0.2F, false);
		...
		handrail_window_left1.setTextureOffset(0, 0).addCuboid(11.0F, -39.06F, 32.5F, 0.0F, 32.0F, 0.0F, 0.2F, false);

		cube_r48 = new ModelPart(this);
		cube_r48.setPivot(10.6875F, -6.95F, 32.55F);
		handrail_window_left1.addChild(cube_r48);
		setRotationAngle(cube_r48, -0.8598F, 0.6048F, 3.0693F);
		cube_r48.setTextureOffset(0, 0).addCuboid(-0.2075F, 0.2F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);

		cube_r49 = new ModelPart(this);
		cube_r49.setPivot(12.375F, -7.3125F, 26.8125F);
		handrail_window_left1.addChild(cube_r49);
		setRotationAngle(cube_r49, -1.399F, 1.1819F, -1.3833F);
		cube_r49.setTextureOffset(0, 0).addCuboid(-3.075F, 0.0025F, -0.0025F, 2.0F, 0.0F, 0.0F, 0.2F, false);

		cube_r50 = new ModelPart(this);
		cube_r50.setPivot(12.75F, -6.125F, 27.9375F);
		handrail_window_left1.addChild(cube_r50);
		setRotationAngle(cube_r50, 0.0F, 1.2654F, 0.0F);
		cube_r50.setTextureOffset(0, 0).addCuboid(-4.0F, 0.025F, -0.0075F, 2.0F, 0.0F, 0.0F, 0.2F, false);
		...
		handrail_window_right5.setTextureOffset(0, 0).addCuboid(-11.0F, -39.31F, 30.75F, 0.0F, 22.0F, 0.0F, 0.2F, true);

		cube_r51 = new ModelPart(this);
		cube_r51.setPivot(-10.75F, -17.1375F, 30.55F);
		handrail_window_right5.addChild(cube_r51);
		setRotationAngle(cube_r51, 0.0F, -1.5708F, 2.4871F);
		cube_r51.setTextureOffset(0, 0).addCuboid(0.2F, 0.2075F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, false);
		...
		handrail_window_right4.setTextureOffset(0, 0).addCuboid(-11.0F, -39.3F, 30.75F, 0.0F, 22.0F, 0.0F, 0.2F, true);

		cube_r52 = new ModelPart(this);
		cube_r52.setPivot(-10.75F, -17.1375F, 30.55F);
		handrail_window_right4.addChild(cube_r52);
		setRotationAngle(cube_r52, 0.0F, -1.5708F, 2.4871F);
		cube_r52.setTextureOffset(0, 0).addCuboid(0.2F, 0.2075F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, false);
		...
		handrail_window_right3.setTextureOffset(0, 0).addCuboid(-11.0F, -39.31F, 30.75F, 0.0F, 22.0F, 0.0F, 0.2F, true);

		cube_r53 = new ModelPart(this);
		cube_r53.setPivot(-10.75F, -17.1375F, 30.55F);
		handrail_window_right3.addChild(cube_r53);
		setRotationAngle(cube_r53, 0.0F, -1.5708F, 2.4871F);
		cube_r53.setTextureOffset(0, 0).addCuboid(0.2F, 0.2075F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, false);
		...
		handrail_window_right2.setTextureOffset(0, 0).addCuboid(-11.0F, -39.06F, -36.5F, 0.0F, 32.0F, 0.0F, 0.2F, true);
		...
		cube_r54.setPivot(-12.5F, -9.5625F, -36.5F);
		handrail_window_right2.addChild(cube_r54);
		setRotationAngle(cube_r54, 0.0F, 0.0F, -1.0036F);
		cube_r54.setTextureOffset(0, 0).addCuboid(0.0F, -7.4975F, 0.0F, 0.0F, 9.0F, 0.0F, 0.2F, true);

		cube_r55 = new ModelPart(this);
		cube_r55.setPivot(-10.6875F, -6.95F, -36.55F);
		handrail_window_right2.addChild(cube_r55);
		setRotationAngle(cube_r55, 0.8598F, 0.6048F, -3.0693F);
		cube_r55.setTextureOffset(0, 0).addCuboid(0.2075F, 0.2F, 0.2F, 0.0F, 0.0F, 1.0F, 0.2F, false);

		cube_r56 = new ModelPart(this);
		cube_r56.setPivot(-12.375F, -7.3125F, -30.8125F);
		handrail_window_right2.addChild(cube_r56);
		setRotationAngle(cube_r56, 1.399F, 1.1819F, 1.3833F);
		cube_r56.setTextureOffset(0, 0).addCuboid(1.0F, 0.0025F, -0.0875F, 2.0F, 0.0F, 0.0F, 0.2F, true);

		cube_r57 = new ModelPart(this);
		cube_r57.setPivot(-12.75F, -6.125F, -31.9375F);
		handrail_window_right2.addChild(cube_r57);
		setRotationAngle(cube_r57, 0.0F, 1.2654F, 0.0F);
		cube_r57.setTextureOffset(0, 0).addCuboid(2.0F, 0.0F, -0.0025F, 2.0F, 0.0F, 0.0F, 0.2F, true);
		...
		handrail_window_right1.setTextureOffset(0, 0).addCuboid(-11.0F, -39.06F, 32.5F, 0.0F, 32.0F, 0.0F, 0.2F, true);

		cube_r58 = new ModelPart(this);
		cube_r58.setPivot(-10.6875F, -6.95F, 32.55F);
		handrail_window_right1.addChild(cube_r58);
		setRotationAngle(cube_r58, -0.8598F, -0.6048F, -3.0693F);
		cube_r58.setTextureOffset(0, 0).addCuboid(0.2075F, 0.2F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, false);

		cube_r59 = new ModelPart(this);
		cube_r59.setPivot(-12.375F, -7.3125F, 26.8125F);
		handrail_window_right1.addChild(cube_r59);
		setRotationAngle(cube_r59, -1.399F, -1.1819F, 1.3833F);
		cube_r59.setTextureOffset(0, 0).addCuboid(1.075F, 0.0025F, -0.0025F, 2.0F, 0.0F, 0.0F, 0.2F, true);

		cube_r60 = new ModelPart(this);
		cube_r60.setPivot(-12.75F, -6.125F, 27.9375F);
		handrail_window_right1.addChild(cube_r60);
		setRotationAngle(cube_r60, 0.0F, -1.2654F, 0.0F);
		cube_r60.setTextureOffset(0, 0).addCuboid(2.0F, 0.025F, -0.0075F, 2.0F, 0.0F, 0.0F, 0.2F, true);
		...
		cube_r61.setPivot(10.6875F, -6.95F, 10.55F);
		handrail_head_left.addChild(cube_r61);
		setRotationAngle(cube_r61, -0.8598F, 0.6048F, 3.0693F);
		cube_r61.setTextureOffset(0, 0).addCuboid(-0.2075F, 0.2F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);

		cube_r62 = new ModelPart(this);
		cube_r62.setPivot(12.375F, -7.3125F, 4.8125F);
		handrail_head_left.addChild(cube_r62);
		setRotationAngle(cube_r62, -1.399F, 1.1819F, -1.3833F);
		cube_r62.setTextureOffset(0, 0).addCuboid(-3.005F, 0.0025F, -0.0025F, 2.0F, 0.0F, 0.0F, 0.2F, false);

		cube_r63 = new ModelPart(this);
		cube_r63.setPivot(12.75F, -6.125F, 5.9375F);
		handrail_head_left.addChild(cube_r63);
		setRotationAngle(cube_r63, 0.0F, 1.2654F, 0.0F);
		cube_r63.setTextureOffset(0, 0).addCuboid(-4.0F, 0.025F, -0.0075F, 2.0F, 0.0F, 0.0F, 0.2F, false);
		...
		cube_r64.setPivot(-10.6875F, -6.95F, 10.55F);
		handrail_head_right.addChild(cube_r64);
		setRotationAngle(cube_r64, -0.8598F, -0.6048F, -3.0693F);
		cube_r64.setTextureOffset(0, 0).addCuboid(0.2075F, 0.2F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, false);

		cube_r65 = new ModelPart(this);
		cube_r65.setPivot(-12.375F, -7.3125F, 4.8125F);
		handrail_head_right.addChild(cube_r65);
		setRotationAngle(cube_r65, -1.399F, -1.1819F, 1.3833F);
		cube_r65.setTextureOffset(0, 0).addCuboid(1.075F, 0.0025F, -0.0025F, 2.0F, 0.0F, 0.0F, 0.2F, true);

		cube_r66 = new ModelPart(this);
		cube_r66.setPivot(-12.75F, -6.125F, 5.9375F);
		handrail_head_right.addChild(cube_r66);
		setRotationAngle(cube_r66, 0.0F, -1.2654F, 0.0F);
		cube_r66.setTextureOffset(0, 0).addCuboid(2.0F, 0.005F, -0.0075F, 2.0F, 0.0F, 0.0F, 0.2F, true);
		...
		cube_r67.setPivot(-0.5F, 0.0F, -18.0F);
		seat_left.addChild(cube_r67);
		setRotationAngle(cube_r67, 0.0F, 0.0F, 0.0873F);
		cube_r67.setTextureOffset(0, 0).addCuboid(13.0F, -7.0F, 10.0F, 7.0F, 1.0F, 18.0F, 0.0F, false);
		...
		cube_r68.setPivot(0.0F, 0.0F, -18.0F);
		seat_right.addChild(cube_r68);
		setRotationAngle(cube_r68, 0.0F, 0.0F, -0.0873F);
		cube_r68.setTextureOffset(0, 0).addCuboid(-20.0F, -7.0F, 10.0F, 7.0F, 1.0F, 18.0F, 0.0F, true);
		...
		head.setTextureOffset(0, 51).addCuboid(20.15F, -10.9F, -41.0F, 2.0F, 11.0F, 54.0F, 0.0F, true);
		...
		head_exterior.setTextureOffset(39, 91).addCuboid(16.8F, 3.0F, -41.0F, 4.0F, 3.0F, 17.0F, 0.0F, false);
		head_exterior.setTextureOffset(39, 91).addCuboid(-20.8F, 3.0F, -41.0F, 4.0F, 3.0F, 17.0F, 0.0F, true);
		...
		walls.setTextureOffset(0, 51).addCuboid(-22.15F, -9.9F, -41.0F, 2.0F, 11.0F, 54.0F, 0.0F, false);
		walls.setTextureOffset(0, 51).addCuboid(20.15F, -9.9F, -41.0F, 2.0F, 11.0F, 54.0F, 0.0F, true);
		...
		bottom_wall_right_r4.setTextureOffset(0, 51).addCuboid(-26.0068F, -7.0007F, 21.0F, 49.0F, 3.0F, 0.0F, 0.0F, true);
		...
		bottom_wall_left_r3.setTextureOffset(0, 51).addCuboid(-23.0032F, -7.0007F, 21.0F, 49.0F, 3.0F, 0.0F, 0.0F, false);
		...
		wall_right_2_r6.setTextureOffset(0, 51).addCuboid(22.9978F, -23.9959F, -38.0F, 2.0F, 29.0F, 54.0F, 0.0F, true);
		...
		wall_left_1_r6.setTextureOffset(0, 51).addCuboid(-24.9978F, -23.9959F, -38.0F, 2.0F, 29.0F, 54.0F, 0.0F, false);
		...
		train_barrier_1 = new ModelPart(this);
		train_barrier_1.setPivot(0.0F, 24.0F, 0.0F);
		train_barrier_1.setTextureOffset(0, 0).addCuboid(-20.0F, -19.0F, -6.0F, 0.0F, 19.0F, 12.0F, 0.0F, false);
		train_barrier_1.setTextureOffset(0, 0).addCuboid(20.0F, -19.0F, -6.0F, 0.0F, 19.0F, 12.0F, 0.0F, false);

		train_barrier_2 = new ModelPart(this);
		train_barrier_2.setPivot(0.0F, 24.0F, 0.0F);
		train_barrier_2.setTextureOffset(0, 0).addCuboid(-20.0F, -16.0F, -44.0F, 2.0F, 10.0F, 3.0F, 0.0F, false);
		train_barrier_2.setTextureOffset(0, 0).addCuboid(18.0F, -16.0F, -44.0F, 2.0F, 10.0F, 3.0F, 0.0F, true);
}
