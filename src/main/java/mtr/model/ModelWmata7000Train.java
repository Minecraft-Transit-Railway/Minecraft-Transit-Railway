...
public ModelWmata7000Train() {
		...
		walls_window.setTextureOffset(0, 51).addCuboid(-22.151F, -9.9F, -49.0F, 2.0F, 11.0F, 100.0F, 0.0F, false);
		walls_window.setTextureOffset(0, 51).addCuboid(20.151F, -9.9F, -49.0F, 2.0F, 11.0F, 100.0F, 0.0F, true);
		...
		wall_right_2_r1.setTextureOffset(0, 51).addCuboid(23.0F, -24.0F, -49.0F, 2.0F, 29.0F, 100.0F, 0.0F, true);
		...
		wall_left_1_r1.setTextureOffset(0, 51).addCuboid(-25.0F, -24.0F, -49.0F, 2.0F, 29.0F, 100.0F, 0.0F, false);
		...
		cube_r1.setPivot(-19.75F, -4.25F, 3.5F);
		...
		cube_r2.setPivot(19.75F, -4.25F, 3.5F);
		...
		cube_r3.setPivot(-19.75F, -4.25F, -3.5F);
		...
		cube_r4.setPivot(19.75F, -4.25F, -3.5F);
		...
		bottom_wall_right_r1.setTextureOffset(0, 51).addCuboid(-57.0F, -7.0F, 21.0F, 90.0F, 3.0F, 0.0F, 0.0F, true);
		...
		bottom_wall_left_r1.setTextureOffset(0, 51).addCuboid(-33.0F, -7.0F, 21.0F, 90.0F, 3.0F, 0.0F, 0.0F, false);
		...
		door_right_top_r1.setTextureOffset(84, 159).addCuboid(-22.5051F, -34.1305F, 0.0F, 0.0F, 26.0F, 12.0F, 0.0F, false);
		...
		door_left_top_r1.setTextureOffset(0, 136).addCuboid(-22.5172F, -34.1477F, -12.0F, 0.0F, 26.0F, 12.0F, 0.0F, false);
		...
		end.setTextureOffset(0, 60).addCuboid(-20.5F, 0.0F, -39.0F, 41.0F, 1.0F, 47.0F, 0.0F, false);
		end.setTextureOffset(0, 51).addCuboid(-22.151F, -10.9F, -43.0F, 2.0F, 11.0F, 56.0F, 0.0F, false);
		end.setTextureOffset(0, 51).addCuboid(20.151F, -10.9F, -43.0F, 2.0F, 11.0F, 56.0F, 0.0F, true);
		...
		wall_right_2_r3.setTextureOffset(0, 51).addCuboid(23.0F, -24.0F, -38.0F, 2.0F, 29.0F, 56.0F, 0.0F, true);
		...
		wall_left_1_r3.setTextureOffset(0, 51).addCuboid(-25.0F, -24.0F, -38.0F, 2.0F, 29.0F, 56.0F, 0.0F, false);
		...
		cube_r5.setPivot(1.0F, 0.0F, 0.0F);
		cab_door_back2.addChild(cube_r5);
		setRotationAngle(cube_r5, 0.0F, -1.5708F, 0.0F);
		cube_r5.setTextureOffset(121, 115).addCuboid(3.0F, -36.0F, -6.0F, 2.0F, 36.0F, 0.0F, 0.0F, false);

		cube_r6 = new ModelPart(this);
		cube_r6.setPivot(-1.0F, 0.0F, 0.0F);
		cab_door_back2.addChild(cube_r6);
		setRotationAngle(cube_r6, 0.0F, -1.5708F, 0.0F);
		cube_r6.setTextureOffset(121, 115).addCuboid(3.0F, -36.0F, 6.0F, 2.0F, 36.0F, 0.0F, 0.0F, false);

		cube_r7 = new ModelPart(this);
		cube_r7.setPivot(0.0F, -58.0F, 47.0F);
		cab_door_back2.addChild(cube_r7);
		setRotationAngle(cube_r7, 1.5708F, 0.0F, 0.0F);
		cube_r7.setTextureOffset(0, 33).addCuboid(-7.0F, -44.0F, -22.0F, 14.0F, 2.0F, 0.0F, 0.0F, false);
		...
		cube_r8.setPivot(-19.75F, -4.25F, -16.5F);
		end_bottom.addChild(cube_r8);
		setRotationAngle(cube_r8, 0.0F, 0.0F, 0.6981F);
		cube_r8.setTextureOffset(0, 0).addCuboid(-1.5F, -1.0F, -7.5F, 3.0F, 2.0F, 14.0F, 0.0F, true);

		cube_r9 = new ModelPart(this);
		cube_r9.setPivot(19.75F, -4.25F, -16.5F);
		end_bottom.addChild(cube_r9);
		setRotationAngle(cube_r9, 0.0F, 0.0F, -0.6981F);
		cube_r9.setTextureOffset(0, 0).addCuboid(-1.5F, -1.0F, -7.5F, 3.0F, 2.0F, 14.0F, 0.0F, false);

		end_exterior = new ModelPart(this);
		end_exterior.setPivot(0.0F, 24.0F, 0.0F);
		end_exterior.setTextureOffset(0, 51).addCuboid(-22.151F, -10.9F, -43.0F, 2.0F, 11.0F, 56.0F, 0.0F, false);
		end_exterior.setTextureOffset(0, 51).addCuboid(20.151F, -10.9F, -43.0F, 2.0F, 11.0F, 56.0F, 0.0F, true);
		...
		cube_r10.setPivot(1.0F, 0.0F, -20.0F);
		end_exterior.addChild(cube_r10);
		setRotationAngle(cube_r10, 0.0F, -1.5708F, 0.0F);
		cube_r10.setTextureOffset(121, 115).addCuboid(-23.0F, -36.0F, -6.0F, 2.0F, 36.0F, 0.0F, 0.0F, false);

		cube_r11 = new ModelPart(this);
		cube_r11.setPivot(-1.0F, 0.0F, -20.0F);
		end_exterior.addChild(cube_r11);
		setRotationAngle(cube_r11, 0.0F, -1.5708F, 0.0F);
		cube_r11.setTextureOffset(121, 115).addCuboid(-23.0F, -36.0F, 6.0F, 2.0F, 36.0F, 0.0F, 0.0F, false);

		cube_r12 = new ModelPart(this);
		cube_r12.setPivot(0.0F, -58.0F, -9.0F);
		end_exterior.addChild(cube_r12);
		setRotationAngle(cube_r12, 1.5708F, 0.0F, 0.0F);
		cube_r12.setTextureOffset(0, 33).addCuboid(-7.0F, -34.0F, -22.0F, 14.0F, 2.0F, 0.0F, 0.0F, false);
		...
		bottom_wall_right_r3.setTextureOffset(0, 51).addCuboid(-28.0F, -7.0F, 21.0F, 51.0F, 3.0F, 0.0F, 0.0F, true);
		...
		bottom_wall_left_r2.setTextureOffset(0, 51).addCuboid(-23.0F, -7.0F, 21.0F, 51.0F, 3.0F, 0.0F, 0.0F, false);
		...
		wall_left_1_r4.setTextureOffset(0, 51).addCuboid(-25.0F, -24.0F, -38.0F, 2.0F, 29.0F, 56.0F, 0.0F, false);
		...
		wall_right_2_r4.setTextureOffset(0, 51).addCuboid(23.0F, -24.0F, -38.0F, 2.0F, 29.0F, 56.0F, 0.0F, true);
		...
		cube_r13.setPivot(1.5F, 0.0F, -16.0F);
		end_seat_right.addChild(cube_r13);
		setRotationAngle(cube_r13, 0.0F, 0.0F, -0.0873F);
		cube_r13.setTextureOffset(0, 0).addCuboid(-20.0F, -7.0F, 17.0F, 7.0F, 1.0F, 12.0F, 0.0F, true);
		...
		cube_r14.setPivot(-0.5F, 0.0F, 0.0F);
		end_seat_right2.addChild(cube_r14);
		setRotationAngle(cube_r14, 0.0F, 0.0F, 0.0873F);
		cube_r14.setTextureOffset(0, 0).addCuboid(30.9315F, -8.5688F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		cube_r15.setPivot(-0.5F, 0.0F, 0.0F);
		end_seat_right3.addChild(cube_r15);
		setRotationAngle(cube_r15, 0.0F, 0.0F, 0.0873F);
		cube_r15.setTextureOffset(0, 0).addCuboid(32.9239F, -8.7431F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		cube_r16.setPivot(-2.5F, 0.0F, -20.0F);
		end_seat_left.addChild(cube_r16);
		...
		end_seat_left2.addChild(cube_r17);
		setRotationAngle(cube_r17, 0.0F, 0.0F, 0.0873F);
		cube_r17.setTextureOffset(0, 0).addCuboid(32.9239F, -8.7431F, 17.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		cube_r18.setPivot(-0.5F, 0.0F, 0.0F);
		end_seat_left3.addChild(cube_r18);
		setRotationAngle(cube_r18, 0.0F, 0.0F, 0.0873F);
		cube_r18.setTextureOffset(0, 0).addCuboid(32.9239F, -8.7431F, 17.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		handrail_end_right.setTextureOffset(0, 0).addCuboid(-11.0F, -39.0625F, 8.5F, 0.0F, 32.0F, 0.0F, 0.2F, true);

		cube_r19 = new ModelPart(this);
		cube_r19.setPivot(-10.6875F, -6.95F, 8.55F);
		handrail_end_right.addChild(cube_r19);
		setRotationAngle(cube_r19, -0.8598F, -0.6048F, -3.0693F);
		cube_r19.setTextureOffset(0, 0).addCuboid(0.2F, 0.2F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, false);

		cube_r20 = new ModelPart(this);
		cube_r20.setPivot(-12.375F, -7.3125F, 2.8125F);
		handrail_end_right.addChild(cube_r20);
		setRotationAngle(cube_r20, -1.399F, -1.1819F, 1.3833F);
		cube_r20.setTextureOffset(0, 0).addCuboid(1.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, true);

		cube_r21 = new ModelPart(this);
		cube_r21.setPivot(-12.75F, -6.125F, 3.9375F);
		handrail_end_right.addChild(cube_r21);
		setRotationAngle(cube_r21, 0.0F, -1.2654F, 0.0F);
		cube_r21.setTextureOffset(0, 0).addCuboid(2.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, true);
		...
		handrail_end_right2.setTextureOffset(0, 0).addCuboid(-11.0F, -39.3125F, 6.75F, 0.0F, 22.0F, 0.0F, 0.2F, true);

		cube_r22 = new ModelPart(this);
		cube_r22.setPivot(-10.75F, -17.1375F, 6.55F);
		handrail_end_right2.addChild(cube_r22);
		setRotationAngle(cube_r22, 0.0F, -1.5708F, 2.4871F);
		cube_r22.setTextureOffset(0, 0).addCuboid(0.2F, 0.2F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, false);
		...
		handrail_end_right3.setTextureOffset(0, 0).addCuboid(-11.0F, -39.0625F, -60.5F, 0.0F, 32.0F, 0.0F, 0.2F, true);
		handrail_end_right3.setTextureOffset(0, 0).addCuboid(-18.9375F, -13.625F, -60.5F, 0.0F, 0.0F, 1.0F, 0.2F, true);
		handrail_end_right3.setTextureOffset(0, 0).addCuboid(-12.5F, -9.3125F, -60.5F, 0.0F, 1.0F, 0.0F, 0.2F, true);
		handrail_end_right3.setTextureOffset(0, 0).addCuboid(-16.5F, -8.0625F, -60.5F, 4.0F, 0.0F, 0.0F, 0.2F, true);
		handrail_end_right3.setTextureOffset(0, 0).addCuboid(-16.5F, -12.0625F, -60.5F, 0.0F, 4.0F, 0.0F, 0.2F, true);

		cube_r23 = new ModelPart(this);
		cube_r23.setPivot(-12.5F, -9.5625F, -60.5F);
		handrail_end_right3.addChild(cube_r23);
		setRotationAngle(cube_r23, 0.0F, 0.0F, -1.0036F);
		cube_r23.setTextureOffset(0, 0).addCuboid(0.0F, -7.5F, 0.0F, 0.0F, 9.0F, 0.0F, 0.2F, true);

		cube_r24 = new ModelPart(this);
		cube_r24.setPivot(-10.6875F, -6.95F, -60.55F);
		handrail_end_right3.addChild(cube_r24);
		setRotationAngle(cube_r24, 0.8598F, 0.6048F, -3.0693F);
		cube_r24.setTextureOffset(0, 0).addCuboid(0.2F, 0.2F, 0.2F, 0.0F, 0.0F, 1.0F, 0.2F, false);

		cube_r25 = new ModelPart(this);
		cube_r25.setPivot(-12.375F, -7.3125F, -54.8125F);
		handrail_end_right3.addChild(cube_r25);
		setRotationAngle(cube_r25, 1.399F, 1.1819F, 1.3833F);
		cube_r25.setTextureOffset(0, 0).addCuboid(1.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, true);

		cube_r26 = new ModelPart(this);
		cube_r26.setPivot(-12.75F, -6.125F, -55.9375F);
		handrail_end_right3.addChild(cube_r26);
		setRotationAngle(cube_r26, 0.0F, 1.2654F, 0.0F);
		cube_r26.setTextureOffset(0, 0).addCuboid(2.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, true);
		...
		handrail_end_left.setTextureOffset(0, 0).addCuboid(11.0F, -39.0625F, 8.5F, 0.0F, 32.0F, 0.0F, 0.2F, false);

		cube_r27 = new ModelPart(this);
		cube_r27.setPivot(10.6875F, -6.95F, 8.55F);
		handrail_end_left.addChild(cube_r27);
		setRotationAngle(cube_r27, -0.8598F, 0.6048F, 3.0693F);
		cube_r27.setTextureOffset(0, 0).addCuboid(-0.2F, 0.2F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);

		cube_r28 = new ModelPart(this);
		cube_r28.setPivot(12.375F, -7.3125F, 2.8125F);
		handrail_end_left.addChild(cube_r28);
		setRotationAngle(cube_r28, -1.399F, 1.1819F, -1.3833F);
		cube_r28.setTextureOffset(0, 0).addCuboid(-3.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, false);

		cube_r29 = new ModelPart(this);
		cube_r29.setPivot(12.75F, -6.125F, 3.9375F);
		handrail_end_left.addChild(cube_r29);
		setRotationAngle(cube_r29, 0.0F, 1.2654F, 0.0F);
		cube_r29.setTextureOffset(0, 0).addCuboid(-4.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, false);
		...
		handrail_end_left2.setTextureOffset(0, 0).addCuboid(11.0F, -39.3125F, 6.75F, 0.0F, 22.0F, 0.0F, 0.2F, false);

		cube_r30 = new ModelPart(this);
		cube_r30.setPivot(10.75F, -17.1375F, 6.55F);
		handrail_end_left2.addChild(cube_r30);
		setRotationAngle(cube_r30, 0.0F, 1.5708F, -2.4871F);
		cube_r30.setTextureOffset(0, 0).addCuboid(-0.2F, 0.2F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);
		...
		handrail_end_left3.setTextureOffset(0, 0).addCuboid(11.0F, -39.0625F, -60.5F, 0.0F, 32.0F, 0.0F, 0.2F, false);
		handrail_end_left3.setTextureOffset(0, 0).addCuboid(18.9375F, -13.625F, -60.5F, 0.0F, 0.0F, 1.0F, 0.2F, false);
		handrail_end_left3.setTextureOffset(0, 0).addCuboid(12.5F, -9.3125F, -60.5F, 0.0F, 1.0F, 0.0F, 0.2F, false);
		handrail_end_left3.setTextureOffset(0, 0).addCuboid(12.5F, -8.0625F, -60.5F, 4.0F, 0.0F, 0.0F, 0.2F, false);
		handrail_end_left3.setTextureOffset(0, 0).addCuboid(16.5F, -12.0625F, -60.5F, 0.0F, 4.0F, 0.0F, 0.2F, false);

		cube_r31 = new ModelPart(this);
		cube_r31.setPivot(12.5F, -9.5625F, -60.5F);
		handrail_end_left3.addChild(cube_r31);
		setRotationAngle(cube_r31, 0.0F, 0.0F, 1.0036F);
		cube_r31.setTextureOffset(0, 0).addCuboid(0.0F, -7.5F, 0.0F, 0.0F, 9.0F, 0.0F, 0.2F, false);

		cube_r32 = new ModelPart(this);
		cube_r32.setPivot(10.6875F, -6.95F, -60.55F);
		handrail_end_left3.addChild(cube_r32);
		setRotationAngle(cube_r32, 0.8598F, -0.6048F, 3.0693F);
		cube_r32.setTextureOffset(0, 0).addCuboid(-0.2F, 0.2F, 0.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);

		cube_r33 = new ModelPart(this);
		cube_r33.setPivot(12.375F, -7.3125F, -54.8125F);
		handrail_end_left3.addChild(cube_r33);
		setRotationAngle(cube_r33, 1.399F, -1.1819F, -1.3833F);
		cube_r33.setTextureOffset(0, 0).addCuboid(-3.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, false);

		cube_r34 = new ModelPart(this);
		cube_r34.setPivot(12.75F, -6.125F, -55.9375F);
		handrail_end_left3.addChild(cube_r34);
		setRotationAngle(cube_r34, 0.0F, -1.2654F, 0.0F);
		cube_r34.setTextureOffset(0, 0).addCuboid(-4.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, false);
		...
		cube_r35.setPivot(-1.5F, 0.0F, -1.0F);
		win_seat_left.addChild(cube_r35);
		setRotationAngle(cube_r35, 0.0F, 0.0F, 0.0873F);
		cube_r35.setTextureOffset(0, 0).addCuboid(13.0F, -7.0F, 17.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		cube_r36.setPivot(1.5F, 0.0F, 0.0F);
		win_seat_right.addChild(cube_r36);
		setRotationAngle(cube_r36, 0.0F, 0.0F, -0.0873F);
		cube_r36.setTextureOffset(0, 0).addCuboid(-20.0F, -7.0F, 17.0F, 7.0F, 1.0F, 12.0F, 0.0F, true);
		...
		cube_r37.setPivot(-1.5F, 0.0F, 2.0F);
		win_seat_left6.addChild(cube_r37);
		setRotationAngle(cube_r37, 0.0F, 0.0F, 0.0873F);
		cube_r37.setTextureOffset(0, 0).addCuboid(13.0F, -7.0F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		cube_r38.setPivot(-0.5F, 0.0F, 0.0F);
		win_seat_left2.addChild(cube_r38);
		setRotationAngle(cube_r38, 0.0F, 0.0F, 0.0873F);
		cube_r38.setTextureOffset(0, 0).addCuboid(4.0342F, -6.2156F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		cube_r39.setPivot(-0.5F, 0.0F, 0.0F);
		win_seat_left3.addChild(cube_r39);
		setRotationAngle(cube_r39, 0.0F, 0.0F, 0.0873F);
		cube_r39.setTextureOffset(0, 0).addCuboid(2.0419F, -6.0413F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		win_seat_left4.addChild(cube_r40);
		setRotationAngle(cube_r40, 0.0F, 0.0F, 0.0873F);
		cube_r40.setTextureOffset(0, 0).addCuboid(23.9581F, -7.9587F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		win_seat_right2.addChild(cube_r41);
		setRotationAngle(cube_r41, 0.0F, 0.0F, 0.0873F);
		cube_r41.setTextureOffset(0, 0).addCuboid(3.0381F, -6.1284F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		win_seat_right3.addChild(cube_r42);
		setRotationAngle(cube_r42, 0.0F, 0.0F, 0.0873F);
		cube_r42.setTextureOffset(0, 0).addCuboid(5.0304F, -6.3028F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		win_seat_right4.addChild(cube_r43);
		setRotationAngle(cube_r43, 0.0F, 0.0F, 0.0873F);
		cube_r43.setTextureOffset(0, 0).addCuboid(20.9696F, -7.6972F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		win_seat_right5.addChild(cube_r44);
		setRotationAngle(cube_r44, 0.0F, 0.0F, 0.0873F);
		cube_r44.setTextureOffset(0, 0).addCuboid(20.9696F, -7.6972F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		win_seat_left5.addChild(cube_r45);
		setRotationAngle(cube_r45, 0.0F, 0.0F, 0.0873F);
		cube_r45.setTextureOffset(0, 0).addCuboid(20.9696F, -7.6972F, 16.0F, 7.0F, 1.0F, 12.0F, 0.0F, false);
		...
		handrail_window_left7.setTextureOffset(0, 0).addCuboid(11.0F, -39.0625F, -24.5F, 0.0F, 32.0F, 0.0F, 0.2F, false);

		cube_r46 = new ModelPart(this);
		cube_r46.setPivot(10.6875F, -6.95F, -24.55F);
		handrail_window_left7.addChild(cube_r46);
		setRotationAngle(cube_r46, 0.8598F, -0.6048F, 3.0693F);
		cube_r46.setTextureOffset(0, 0).addCuboid(-0.2F, 0.2F, 0.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);

		cube_r47 = new ModelPart(this);
		cube_r47.setPivot(12.375F, -7.3125F, -18.8125F);
		handrail_window_left7.addChild(cube_r47);
		setRotationAngle(cube_r47, 1.399F, -1.1819F, -1.3833F);
		cube_r47.setTextureOffset(0, 0).addCuboid(-3.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, false);

		cube_r48 = new ModelPart(this);
		cube_r48.setPivot(12.75F, -6.125F, -19.9375F);
		handrail_window_left7.addChild(cube_r48);
		setRotationAngle(cube_r48, 0.0F, -1.2654F, 0.0F);
		cube_r48.setTextureOffset(0, 0).addCuboid(-4.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, false);
		...
		handrail_window_left6.setTextureOffset(0, 0).addCuboid(11.0F, -39.0625F, 44.5F, 0.0F, 32.0F, 0.0F, 0.2F, false);
		handrail_window_left6.setTextureOffset(0, 0).addCuboid(18.9375F, -13.625F, 43.5F, 0.0F, 0.0F, 1.0F, 0.2F, false);
		handrail_window_left6.setTextureOffset(0, 0).addCuboid(12.5F, -9.3125F, 44.5F, 0.0F, 1.0F, 0.0F, 0.2F, false);
		handrail_window_left6.setTextureOffset(0, 0).addCuboid(12.5F, -8.0625F, 44.5F, 4.0F, 0.0F, 0.0F, 0.2F, false);
		handrail_window_left6.setTextureOffset(0, 0).addCuboid(16.5F, -12.0625F, 44.5F, 0.0F, 4.0F, 0.0F, 0.2F, false);

		cube_r49 = new ModelPart(this);
		cube_r49.setPivot(12.5F, -9.5625F, 44.5F);
		handrail_window_left6.addChild(cube_r49);
		setRotationAngle(cube_r49, 0.0F, 0.0F, 1.0036F);
		cube_r49.setTextureOffset(0, 0).addCuboid(0.0F, -7.5F, 0.0F, 0.0F, 9.0F, 0.0F, 0.2F, false);

		cube_r50 = new ModelPart(this);
		cube_r50.setPivot(10.6875F, -6.95F, 44.55F);
		handrail_window_left6.addChild(cube_r50);
		setRotationAngle(cube_r50, -0.8598F, 0.6048F, 3.0693F);
		cube_r50.setTextureOffset(0, 0).addCuboid(-0.2F, 0.2F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);

		cube_r51 = new ModelPart(this);
		cube_r51.setPivot(12.375F, -7.3125F, 38.8125F);
		handrail_window_left6.addChild(cube_r51);
		setRotationAngle(cube_r51, -1.399F, 1.1819F, -1.3833F);
		cube_r51.setTextureOffset(0, 0).addCuboid(-3.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, false);

		cube_r52 = new ModelPart(this);
		cube_r52.setPivot(12.75F, -6.125F, 39.9375F);
		handrail_window_left6.addChild(cube_r52);
		setRotationAngle(cube_r52, 0.0F, 1.2654F, 0.0F);
		cube_r52.setTextureOffset(0, 0).addCuboid(-4.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, false);
		...
		handrail_window_left5.setTextureOffset(0, 0).addCuboid(11.0F, -39.3125F, 30.75F, 0.0F, 22.0F, 0.0F, 0.2F, false);

		cube_r53 = new ModelPart(this);
		cube_r53.setPivot(10.75F, -17.1375F, 30.55F);
		handrail_window_left5.addChild(cube_r53);
		setRotationAngle(cube_r53, 0.0F, 1.5708F, -2.4871F);
		cube_r53.setTextureOffset(0, 0).addCuboid(-0.2F, 0.2F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);
		...
		handrail_window_left4.setTextureOffset(0, 0).addCuboid(11.0F, -39.3125F, 30.75F, 0.0F, 22.0F, 0.0F, 0.2F, false);

		cube_r54 = new ModelPart(this);
		cube_r54.setPivot(10.75F, -17.1375F, 30.55F);
		handrail_window_left4.addChild(cube_r54);
		setRotationAngle(cube_r54, 0.0F, 1.5708F, -2.4871F);
		cube_r54.setTextureOffset(0, 0).addCuboid(-0.2F, 0.2F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);
		...
		handrail_window_left3.setTextureOffset(0, 0).addCuboid(11.0F, -39.3125F, 30.75F, 0.0F, 22.0F, 0.0F, 0.2F, false);

		cube_r55 = new ModelPart(this);
		cube_r55.setPivot(10.75F, -17.1375F, 30.55F);
		handrail_window_left3.addChild(cube_r55);
		...
		handrail_window_left2.setTextureOffset(0, 0).addCuboid(11.0F, -39.0625F, -36.5F, 0.0F, 32.0F, 0.0F, 0.2F, false);
		handrail_window_left2.setTextureOffset(0, 0).addCuboid(18.9375F, -13.625F, -36.5F, 0.0F, 0.0F, 1.0F, 0.2F, false);
		handrail_window_left2.setTextureOffset(0, 0).addCuboid(12.5F, -9.3125F, -36.5F, 0.0F, 1.0F, 0.0F, 0.2F, false);
		handrail_window_left2.setTextureOffset(0, 0).addCuboid(12.5F, -8.0625F, -36.5F, 4.0F, 0.0F, 0.0F, 0.2F, false);
		handrail_window_left2.setTextureOffset(0, 0).addCuboid(16.5F, -12.0625F, -36.5F, 0.0F, 4.0F, 0.0F, 0.2F, false);

		cube_r56 = new ModelPart(this);
		cube_r56.setPivot(12.5F, -9.5625F, -36.5F);
		handrail_window_left2.addChild(cube_r56);
		setRotationAngle(cube_r56, 0.0F, 0.0F, 1.0036F);
		cube_r56.setTextureOffset(0, 0).addCuboid(0.0F, -7.5F, 0.0F, 0.0F, 9.0F, 0.0F, 0.2F, false);

		cube_r57 = new ModelPart(this);
		cube_r57.setPivot(10.6875F, -6.95F, -36.55F);
		handrail_window_left2.addChild(cube_r57);
		setRotationAngle(cube_r57, 0.8598F, -0.6048F, 3.0693F);
		cube_r57.setTextureOffset(0, 0).addCuboid(-0.2F, 0.2F, 0.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);

		cube_r58 = new ModelPart(this);
		cube_r58.setPivot(12.375F, -7.3125F, -30.8125F);
		handrail_window_left2.addChild(cube_r58);
		setRotationAngle(cube_r58, 1.399F, -1.1819F, -1.3833F);
		cube_r58.setTextureOffset(0, 0).addCuboid(-3.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, false);

		cube_r59 = new ModelPart(this);
		cube_r59.setPivot(12.75F, -6.125F, -31.9375F);
		handrail_window_left2.addChild(cube_r59);
		setRotationAngle(cube_r59, 0.0F, -1.2654F, 0.0F);
		cube_r59.setTextureOffset(0, 0).addCuboid(-4.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, false);
		...
		handrail_window_left1.setTextureOffset(0, 0).addCuboid(11.0F, -39.0625F, 32.5F, 0.0F, 32.0F, 0.0F, 0.2F, false);

		cube_r60 = new ModelPart(this);
		cube_r60.setPivot(10.6875F, -6.95F, 32.55F);
		handrail_window_left1.addChild(cube_r60);
		setRotationAngle(cube_r60, -0.8598F, 0.6048F, 3.0693F);
		cube_r60.setTextureOffset(0, 0).addCuboid(-0.2F, 0.2F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);

		cube_r61 = new ModelPart(this);
		cube_r61.setPivot(12.375F, -7.3125F, 26.8125F);
		handrail_window_left1.addChild(cube_r61);
		setRotationAngle(cube_r61, -1.399F, 1.1819F, -1.3833F);
		cube_r61.setTextureOffset(0, 0).addCuboid(-3.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, false);

		cube_r62 = new ModelPart(this);
		cube_r62.setPivot(12.75F, -6.125F, 27.9375F);
		handrail_window_left1.addChild(cube_r62);
		setRotationAngle(cube_r62, 0.0F, 1.2654F, 0.0F);
		cube_r62.setTextureOffset(0, 0).addCuboid(-4.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, false);
		...
		handrail_window_right5.setTextureOffset(0, 0).addCuboid(-11.0F, -39.3125F, 30.75F, 0.0F, 22.0F, 0.0F, 0.2F, true);

		cube_r63 = new ModelPart(this);
		cube_r63.setPivot(-10.75F, -17.1375F, 30.55F);
		handrail_window_right5.addChild(cube_r63);
		setRotationAngle(cube_r63, 0.0F, -1.5708F, 2.4871F);
		cube_r63.setTextureOffset(0, 0).addCuboid(0.2F, 0.2F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, false);
		...
		handrail_window_right4.setTextureOffset(0, 0).addCuboid(-11.0F, -39.3125F, 30.75F, 0.0F, 22.0F, 0.0F, 0.2F, true);

		cube_r64 = new ModelPart(this);
		cube_r64.setPivot(-10.75F, -17.1375F, 30.55F);
		handrail_window_right4.addChild(cube_r64);
		setRotationAngle(cube_r64, 0.0F, -1.5708F, 2.4871F);
		cube_r64.setTextureOffset(0, 0).addCuboid(0.2F, 0.2F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, false);
		...
		handrail_window_right3.setTextureOffset(0, 0).addCuboid(-11.0F, -39.3125F, 30.75F, 0.0F, 22.0F, 0.0F, 0.2F, true);
		...
		handrail_window_right2.setTextureOffset(0, 0).addCuboid(-11.0F, -39.0625F, -36.5F, 0.0F, 32.0F, 0.0F, 0.2F, true);
		handrail_window_right2.setTextureOffset(0, 0).addCuboid(-18.9375F, -13.625F, -36.5F, 0.0F, 0.0F, 1.0F, 0.2F, true);
		handrail_window_right2.setTextureOffset(0, 0).addCuboid(-12.5F, -9.3125F, -36.5F, 0.0F, 1.0F, 0.0F, 0.2F, true);
		handrail_window_right2.setTextureOffset(0, 0).addCuboid(-16.5F, -8.0625F, -36.5F, 4.0F, 0.0F, 0.0F, 0.2F, true);
		handrail_window_right2.setTextureOffset(0, 0).addCuboid(-16.5F, -12.0625F, -36.5F, 0.0F, 4.0F, 0.0F, 0.2F, true);
		...
		cube_r66.setTextureOffset(0, 0).addCuboid(0.0F, -7.5F, 0.0F, 0.0F, 9.0F, 0.0F, 0.2F, true);
		...
		cube_r67.setTextureOffset(0, 0).addCuboid(0.2F, 0.2F, 0.2F, 0.0F, 0.0F, 1.0F, 0.2F, false);
		...
		cube_r68.setTextureOffset(0, 0).addCuboid(1.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, true);
		...
		cube_r69.setTextureOffset(0, 0).addCuboid(2.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, true);
		...
		handrail_window_right1.setTextureOffset(0, 0).addCuboid(-11.0F, -39.0625F, 32.5F, 0.0F, 32.0F, 0.0F, 0.2F, true);
		...
		cube_r70.setTextureOffset(0, 0).addCuboid(0.2F, 0.2F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, false);
		...
		cube_r71.setTextureOffset(0, 0).addCuboid(1.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, true);
		...
		cube_r72.setTextureOffset(0, 0).addCuboid(2.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, true);
		...
		handrail_head_left.setTextureOffset(0, 0).addCuboid(11.0F, -39.0625F, 10.5F, 0.0F, 32.0F, 0.0F, 0.2F, false);
		...
		cube_r73.setTextureOffset(0, 0).addCuboid(-0.2F, 0.2F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, true);
		...
		cube_r74.setTextureOffset(0, 0).addCuboid(-3.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, false);
		...
		cube_r75.setTextureOffset(0, 0).addCuboid(-4.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, false);
		...
		handrail_head_right.setTextureOffset(0, 0).addCuboid(-11.0F, -39.0625F, 10.5F, 0.0F, 32.0F, 0.0F, 0.2F, true);
		...
		cube_r76.setTextureOffset(0, 0).addCuboid(0.2F, 0.2F, -1.2F, 0.0F, 0.0F, 1.0F, 0.2F, false);
		...
		cube_r77.setTextureOffset(0, 0).addCuboid(1.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, true);
		...
		cube_r78.setTextureOffset(0, 0).addCuboid(2.0F, 0.0F, 0.0F, 2.0F, 0.0F, 0.0F, 0.2F, true);
		...
		roof_head.setTextureOffset(98, 73).addCuboid(-17.5F, -39.0F, -41.0F, 35.0F, 0.0F, 54.0F, 0.0F, false);
		...
		head.setTextureOffset(98, 73).addCuboid(-22.0F, 0.0F, -36.0F, 44.0F, 1.0F, 44.0F, 0.0F, false);
		head.setTextureOffset(0, 51).addCuboid(-22.151F, -10.9F, -41.0F, 2.0F, 11.0F, 54.0F, 0.0F, false);
		head.setTextureOffset(0, 51).addCuboid(20.151F, -10.9F, -41.0F, 2.0F, 11.0F, 54.0F, 0.0F, true);
		...
		wall_right_2_r5.setTextureOffset(0, 51).addCuboid(23.0F, -24.0F, -38.0F, 2.0F, 29.0F, 54.0F, 0.0F, true);
		...
		wall_left_1_r5.setTextureOffset(0, 51).addCuboid(-25.0F, -24.0F, -38.0F, 2.0F, 29.0F, 54.0F, 0.0F, false);

		cube_r81 = new ModelPart(this);
		cube_r81.setPivot(0.0F, -58.0F, 16.0F);
		head.addChild(cube_r81);
		setRotationAngle(cube_r81, 1.5708F, 0.0F, 0.0F);
		cube_r81.setTextureOffset(0, 33).addCuboid(-7.0F, -27.0F, -22.0F, 14.0F, 5.0F, 0.0F, 0.0F, false);
		...
		cube_r82.setPivot(-19.75F, -4.25F, -14.5F);
		head_bottom.addChild(cube_r82);
		setRotationAngle(cube_r82, 0.0F, 0.0F, 0.6981F);
		cube_r82.setTextureOffset(0, 0).addCuboid(-1.5F, -1.0F, -12.5F, 3.0F, 2.0F, 19.0F, 0.0F, true);

		cube_r83 = new ModelPart(this);
		cube_r83.setPivot(19.75F, -4.25F, -16.5F);
		head_bottom.addChild(cube_r83);
		setRotationAngle(cube_r83, 0.0F, 0.0F, -0.6981F);
		cube_r83.setTextureOffset(0, 0).addCuboid(-1.5F, -1.0F, -10.5F, 3.0F, 2.0F, 19.0F, 0.0F, false);
		...
		cube_r84.setPivot(1.0F, 0.0F, 0.0F);
		cab_door_back.addChild(cube_r84);
		setRotationAngle(cube_r84, 0.0F, -1.5708F, 0.0F);
		cube_r84.setTextureOffset(121, 115).addCuboid(-5.0F, -36.0F, -6.0F, 5.0F, 36.0F, 0.0F, 0.0F, false);

		cube_r85 = new ModelPart(this);
		cube_r85.setPivot(-1.0F, 0.0F, 0.0F);
		cab_door_back.addChild(cube_r85);
		setRotationAngle(cube_r85, 0.0F, -1.5708F, 0.0F);
		cube_r85.setTextureOffset(121, 115).addCuboid(-5.0F, -36.0F, 6.0F, 5.0F, 36.0F, 0.0F, 0.0F, false);

		head_exterior = new ModelPart(this);
		head_exterior.setPivot(0.0F, 24.0F, 0.0F);
		head_exterior.setTextureOffset(0, 124).addCuboid(-21.75F, 0.0F, -41.0F, 1.0F, 3.0F, 49.0F, 0.0F, false);
		head_exterior.setTextureOffset(39, 91).addCuboid(20.75F, 0.0F, -41.0F, 1.0F, 3.0F, 49.0F, 0.0F, false);
		head_exterior.setTextureOffset(39, 91).addCuboid(16.875F, 3.0F, -41.0F, 4.0F, 3.0F, 17.0F, 0.0F, false);
		head_exterior.setTextureOffset(39, 91).addCuboid(-20.875F, 3.0F, -41.0F, 4.0F, 3.0F, 17.0F, 0.0F, true);

		buttom_panel_6_r2 = new ModelPart(this);
		buttom_panel_6_r2.setPivot(-21.5625F, 4.1F, -34.0F);
		...
		buttom_panel_5_r2.setPivot(21.5625F, 4.1F, -34.0F);
		...
		floor_5_r1.setPivot(-20.375F, 4.0F, -15.0F);
		...
		floor_4_r1.setPivot(20.375F, 4.0F, -15.0F);
		...
		walls.setTextureOffset(0, 51).addCuboid(-22.151F, -9.9F, -41.0F, 2.0F, 11.0F, 54.0F, 0.0F, false);
		walls.setTextureOffset(0, 51).addCuboid(20.151F, -9.9F, -41.0F, 2.0F, 11.0F, 54.0F, 0.0F, true);
		...
		bottom_wall_right_r4.setTextureOffset(0, 51).addCuboid(-26.0F, -7.0F, 21.0F, 49.0F, 3.0F, 0.0F, 0.0F, true);
		...
		bottom_wall_left_r3.setTextureOffset(0, 51).addCuboid(-23.0F, -7.0F, 21.0F, 49.0F, 3.0F, 0.0F, 0.0F, false);
		...
		wall_right_2_r6.setTextureOffset(0, 51).addCuboid(23.0F, -24.0F, -38.0F, 2.0F, 29.0F, 54.0F, 0.0F, true);
		...
		wall_left_1_r6.setTextureOffset(0, 51).addCuboid(-25.0F, -24.0F, -38.0F, 2.0F, 29.0F, 54.0F, 0.0F, false);
		...
		cube_r86.setPivot(0.0F, -59.0F, -7.0F);
		exteror_cab_front.addChild(cube_r86);
		setRotationAngle(cube_r86, 1.5708F, 0.0F, 0.0F);
		cube_r86.setTextureOffset(0, 33).addCuboid(-7.0F, -34.0F, -23.0F, 14.0F, 5.0F, 0.0F, 0.0F, false);
		...
		cube_r87.setPivot(1.0F, 0.0F, -18.0F);
		cab_door.addChild(cube_r87);
		...
		cube_r88.setPivot(-1.0F, 0.0F, -18.0F);
		cab_door.addChild(cube_r88);
		setRotationAngle(cube_r88, 0.0F, -1.5708F, 0.0F);
		cube_r88.setTextureOffset(121, 115).addCuboid(-23.0F, -36.0F, 6.0F, 5.0F, 36.0F, 0.0F, 0.0F, false);

		roof_window_light = new ModelPart(this);
		roof_window_light.setPivot(0.0F, 24.0F, 0.0F);
		roof_window_light.setTextureOffset(98, 73).addCuboid(11.75F, -38.5F, -50.0F, 2.0F, 0.0F, 100.0F, 0.0F, false);
		roof_window_light.setTextureOffset(98, 73).addCuboid(11.75F, -39.5F, -50.0F, 0.0F, 1.0F, 100.0F, 0.0F, false);
		roof_window_light.setTextureOffset(98, 73).addCuboid(13.75F, -39.5F, -50.0F, 0.0F, 1.0F, 100.0F, 0.0F, false);
		roof_window_light.setTextureOffset(98, 73).addCuboid(-13.75F, -38.5F, -50.0F, 2.0F, 0.0F, 100.0F, 0.0F, true);
		roof_window_light.setTextureOffset(98, 73).addCuboid(-11.75F, -39.5F, -50.0F, 0.0F, 1.0F, 100.0F, 0.0F, true);
		roof_window_light.setTextureOffset(98, 73).addCuboid(-13.75F, -39.5F, -50.0F, 0.0F, 1.0F, 100.0F, 0.0F, true);
		...
		roof_head_light.setTextureOffset(98, 73).addCuboid(11.75F, -38.5F, -6.0F, 2.0F, 0.0F, 19.0F, 0.0F, false);
		roof_head_light.setTextureOffset(98, 73).addCuboid(11.75F, -39.5F, -6.0F, 0.0F, 1.0F, 19.0F, 0.0F, false);
		roof_head_light.setTextureOffset(98, 73).addCuboid(13.75F, -39.5F, -6.0F, 0.0F, 1.0F, 19.0F, 0.0F, false);
		roof_head_light.setTextureOffset(98, 73).addCuboid(-13.75F, -38.5F, -6.0F, 2.0F, 0.0F, 19.0F, 0.0F, true);
		roof_head_light.setTextureOffset(98, 73).addCuboid(-11.75F, -39.5F, -6.0F, 0.0F, 1.0F, 19.0F, 0.0F, true);
		roof_head_light.setTextureOffset(98, 73).addCuboid(-13.75F, -39.5F, -6.0F, 0.0F, 1.0F, 19.0F, 0.0F, true);

		roof_end_light = new ModelPart(this);
		roof_end_light.setPivot(0.0F, 24.0F, 0.0F);
		roof_end_light.setTextureOffset(98, 73).addCuboid(11.75F, -38.5F, -39.0F, 2.0F, 0.0F, 52.0F, 0.0F, false);
		roof_end_light.setTextureOffset(98, 73).addCuboid(11.75F, -39.5F, -39.0F, 0.0F, 1.0F, 52.0F, 0.0F, false);
		roof_end_light.setTextureOffset(98, 73).addCuboid(13.75F, -39.5F, -39.0F, 0.0F, 1.0F, 52.0F, 0.0F, false);
		roof_end_light.setTextureOffset(98, 73).addCuboid(-13.75F, -38.5F, -39.0F, 2.0F, 0.0F, 52.0F, 0.0F, true);
		roof_end_light.setTextureOffset(98, 73).addCuboid(-11.75F, -39.5F, -39.0F, 0.0F, 1.0F, 52.0F, 0.0F, true);
		roof_end_light.setTextureOffset(98, 73).addCuboid(-13.75F, -39.5F, -39.0F, 0.0F, 1.0F, 52.0F, 0.0F, true);

		tail_lights = new ModelPart(this);
		tail_lights.setPivot(0.0F, 24.0F, 0.0F);
		tail_lights.setTextureOffset(0, 0).addCuboid(-19.0F, -10.0F, -41.25F, 4.0F, 4.0F, 0.0F, 0.0F, false);
		tail_lights.setTextureOffset(0, 0).addCuboid(15.0F, -10.0F, -41.25F, 4.0F, 4.0F, 0.0F, 0.0F, false);
		tail_lights.setTextureOffset(0, 0).addCuboid(-17.0F, -39.0F, -41.25F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		tail_lights.setTextureOffset(0, 0).addCuboid(14.0F, -39.0F, -41.25F, 3.0F, 3.0F, 0.0F, 0.0F, false);

		headlights = new ModelPart(this);
		headlights.setPivot(0.0F, 24.0F, 0.0F);
		headlights.setTextureOffset(0, 0).addCuboid(10.5F, -8.0F, -41.25F, 4.0F, 4.0F, 0.0F, 0.0F, false);
		headlights.setTextureOffset(0, 0).addCuboid(-14.5F, -8.0F, -41.25F, 4.0F, 4.0F, 0.0F, 0.0F, false);
		headlights.setTextureOffset(0, 0).addCuboid(-13.5F, -39.0F, -41.25F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		headlights.setTextureOffset(0, 0).addCuboid(10.5F, -39.0F, -41.25F, 3.0F, 3.0F, 0.0F, 0.0F, false);
		...
		top_roof_r1.setPivot(-0.5F, -8.5F, 11.0F);
		...
		top_roof_r2.setPivot(1.0F, -8.6F, 11.0F);
		...
		top_slant_right_r1.setPivot(-1.0F, -9.5F, 11.0F);
		roof_window_exterior.addChild(top_slant_right_r1);
		setRotationAngle(top_slant_right_r1, 0.0F, 0.0F, 1.309F);
		top_slant_right_r1.setTextureOffset(78, 46).addCuboid(-33.0F, 2.0F, -61.0F, 0.0F, 7.0F, 100.0F, 0.0F, true);

		top_roof_r3 = new ModelPart(this);
		top_roof_r3.setPivot(-1.0F, -8.6F, 11.0F);
		...
		top_roof_r4.setPivot(0.5F, -8.5F, 11.0F);
		...
		top_slant_right_r2.setPivot(1.0F, -9.5F, 11.0F);
		roof_window_exterior.addChild(top_slant_right_r2);
		setRotationAngle(top_slant_right_r2, 0.0F, 0.0F, -1.309F);
		top_slant_right_r2.setTextureOffset(78, 46).addCuboid(33.0F, 2.0F, -61.0F, 0.0F, 7.0F, 100.0F, 0.0F, false);
		...
		top_roof_r5.setPivot(-0.5F, -8.5F, -18.0F);
		roof_head_exterior.addChild(top_roof_r5);
		setRotationAngle(top_roof_r5, 0.0F, 0.0F, 1.6144F);
		top_roof_r5.setTextureOffset(80, 56).addCuboid(-33.0F, -3.0F, -23.0F, 0.0F, 4.0F, 54.0F, 0.0F, false);
		top_roof_r5.setTextureOffset(80, 64).addCuboid(-33.0F, -7.0F, -23.0F, 0.0F, 4.0F, 54.0F, 0.0F, false);

		top_roof_r6 = new ModelPart(this);
		top_roof_r6.setPivot(1.0F, -8.6F, -18.0F);
		roof_head_exterior.addChild(top_roof_r6);
		setRotationAngle(top_roof_r6, 0.0F, 0.0F, 1.6581F);
		top_roof_r6.setTextureOffset(80, 72).addCuboid(-33.0F, -8.0F, -23.0F, 0.0F, 4.0F, 54.0F, 0.0F, false);

		top_slant_right_r3 = new ModelPart(this);
		top_slant_right_r3.setPivot(-1.0F, -9.5F, -18.0F);
		roof_head_exterior.addChild(top_slant_right_r3);
		setRotationAngle(top_slant_right_r3, 0.0F, 0.0F, 1.309F);
		top_slant_right_r3.setTextureOffset(78, 46).addCuboid(-33.0F, 2.0F, -23.0F, 0.0F, 7.0F, 54.0F, 0.0F, true);

		top_roof_r7 = new ModelPart(this);
		top_roof_r7.setPivot(-1.0F, -8.6F, -18.0F);
		roof_head_exterior.addChild(top_roof_r7);
		setRotationAngle(top_roof_r7, 0.0F, 0.0F, -1.6581F);
		top_roof_r7.setTextureOffset(80, 72).addCuboid(33.0F, -8.0F, -23.0F, 0.0F, 4.0F, 54.0F, 0.0F, true);

		top_roof_r8 = new ModelPart(this);
		top_roof_r8.setPivot(0.5F, -8.5F, -18.0F);
		roof_head_exterior.addChild(top_roof_r8);
		setRotationAngle(top_roof_r8, 0.0F, 0.0F, -1.6144F);
		top_roof_r8.setTextureOffset(80, 64).addCuboid(33.0F, -7.0F, -23.0F, 0.0F, 4.0F, 54.0F, 0.0F, true);
		top_roof_r8.setTextureOffset(80, 56).addCuboid(33.0F, -3.0F, -23.0F, 0.0F, 4.0F, 54.0F, 0.0F, true);

		top_slant_right_r4 = new ModelPart(this);
		top_slant_right_r4.setPivot(1.0F, -9.5F, -18.0F);
		roof_head_exterior.addChild(top_slant_right_r4);
		setRotationAngle(top_slant_right_r4, 0.0F, 0.0F, -1.309F);
		top_slant_right_r4.setTextureOffset(78, 46).addCuboid(33.0F, 2.0F, -23.0F, 0.0F, 7.0F, 54.0F, 0.0F, false);
		...
		top_roof_r9.setPivot(-0.5F, -8.5F, -16.0F);
		roof_end_exterior.addChild(top_roof_r9);
		setRotationAngle(top_roof_r9, 0.0F, 0.0F, 1.6144F);
		top_roof_r9.setTextureOffset(80, 56).addCuboid(-33.0F, -3.0F, -27.0F, 0.0F, 4.0F, 56.0F, 0.0F, false);
		top_roof_r9.setTextureOffset(80, 64).addCuboid(-33.0F, -7.0F, -27.0F, 0.0F, 4.0F, 56.0F, 0.0F, false);

		top_roof_r10 = new ModelPart(this);
		top_roof_r10.setPivot(1.0F, -8.6F, -16.0F);
		roof_end_exterior.addChild(top_roof_r10);
		setRotationAngle(top_roof_r10, 0.0F, 0.0F, 1.6581F);
		top_roof_r10.setTextureOffset(80, 72).addCuboid(-33.0F, -8.0F, -27.0F, 0.0F, 4.0F, 56.0F, 0.0F, false);

		top_slant_right_r5 = new ModelPart(this);
		top_slant_right_r5.setPivot(-1.0F, -9.5F, -16.0F);
		roof_end_exterior.addChild(top_slant_right_r5);
		setRotationAngle(top_slant_right_r5, 0.0F, 0.0F, 1.309F);
		top_slant_right_r5.setTextureOffset(78, 46).addCuboid(-33.0F, 2.0F, -27.0F, 0.0F, 7.0F, 56.0F, 0.0F, true);

		top_roof_r11 = new ModelPart(this);
		top_roof_r11.setPivot(-1.0F, -8.6F, -16.0F);
		roof_end_exterior.addChild(top_roof_r11);
		setRotationAngle(top_roof_r11, 0.0F, 0.0F, -1.6581F);
		top_roof_r11.setTextureOffset(80, 72).addCuboid(33.0F, -8.0F, -27.0F, 0.0F, 4.0F, 56.0F, 0.0F, true);

		top_roof_r12 = new ModelPart(this);
		top_roof_r12.setPivot(0.5F, -8.5F, -16.0F);
		roof_end_exterior.addChild(top_roof_r12);
		setRotationAngle(top_roof_r12, 0.0F, 0.0F, -1.6144F);
		top_roof_r12.setTextureOffset(80, 64).addCuboid(33.0F, -7.0F, -27.0F, 0.0F, 4.0F, 56.0F, 0.0F, true);
		top_roof_r12.setTextureOffset(80, 56).addCuboid(33.0F, -3.0F, -27.0F, 0.0F, 4.0F, 56.0F, 0.0F, true);

		top_slant_right_r6 = new ModelPart(this);
		top_slant_right_r6.setPivot(1.0F, -9.5F, -16.0F);
		roof_end_exterior.addChild(top_slant_right_r6);
		setRotationAngle(top_slant_right_r6, 0.0F, 0.0F, -1.309F);
		top_slant_right_r6.setTextureOffset(78, 46).addCuboid(33.0F, 2.0F, -27.0F, 0.0F, 7.0F, 56.0F, 0.0F, false);
