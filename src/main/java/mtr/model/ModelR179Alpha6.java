...
public ModelR179Alpha6() {
		...
		window_curved_side_2_r1.setTextureOffset(79, 0).addCuboid(-0.5F, -0.5F, 0.5F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		...
		window_curved_side_1_r1.setTextureOffset(79, 0).addCuboid(-0.5F, -0.5F, 1.5F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		...
		window_curved_side_2_r2.setTextureOffset(79, 0).addCuboid(-1.5F, -1.5F, 0.5F, 2.0F, 2.0F, 2.0F, 0.0F, true);
		...
		window_curved_side_1_r2.setTextureOffset(79, 0).addCuboid(-1.5F, -1.5F, 1.5F, 2.0F, 2.0F, 2.0F, 0.0F, true);
		...
		window_curved_side_2_r3.setTextureOffset(79, 0).addCuboid(-1.5F, -1.5F, -2.5F, 2.0F, 2.0F, 2.0F, 0.0F, true);
		...
		window_curved_side_1_r3.setTextureOffset(79, 0).addCuboid(-1.5F, -1.5F, -3.5F, 2.0F, 2.0F, 2.0F, 0.0F, true);
		...
		window_curved_side_2_r4.setTextureOffset(79, 0).addCuboid(-0.5F, -0.5F, -2.5F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		...
		window_curved_side_1_r4.setTextureOffset(79, 0).addCuboid(-0.5F, -0.5F, -3.5F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		...
		handrail_middle_4_r1.setTextureOffset(45, 36).addCuboid(2.0F, -5.0F, 0.0F, 3.0F, 0.0F, 0.0F, 0.2F, false);
		...
		handrail_middle_3_r1.setTextureOffset(45, 36).addCuboid(0.0F, -5.0F, 0.0F, 5.0F, 0.0F, 0.0F, 0.2F, false);
		...
		roof_exterior.setTextureOffset(226, 281).addCuboid(-3.0F, -41.375F, -25.0F, 3.0F, 0.0F, 50.0F, 0.0F, false);
		...
		outer_roof_5_r1.setTextureOffset(0, 164).addCuboid(-0.7355F, -1.1097F, -19.5F, 7.0F, 0.0F, 50.0F, 0.0F, false);
		...
		outer_roof_4_r1.setTextureOffset(190, 140).addCuboid(-5.503F, -1.1228F, -19.5F, 6.0F, 0.0F, 50.0F, 0.0F, false);
		...
		outer_roof_3_r1.setTextureOffset(78, 230).addCuboid(-8.3154F, -1.7351F, -19.5F, 3.0F, 0.0F, 50.0F, 0.0F, false);
		...
		outer_roof_2_r1.setTextureOffset(268, 71).addCuboid(-8.1006F, -5.8625F, -19.5F, 2.0F, 0.0F, 50.0F, 0.0F, false);
		...
		outer_roof_1_r1.setTextureOffset(0, 304).addCuboid(-5.9967F, -8.6386F, -4.5F, 1.0F, 0.0F, 50.0F, 0.0F, false);
		...
		head_roof_right.setTextureOffset(460, 411).addCuboid(-0.9F, -20.075F, 8.1F, 2.0F, 0.0F, 40.0F, 0.0F, false);
		head_roof_right.setTextureOffset(534, 242).addCuboid(-6.95F, -21.925F, 8.1F, 1.0F, 0.0F, 40.0F, 0.0F, false);
		head_roof_right.setTextureOffset(517, 150).addCuboid(-17.15F, -24.125F, 8.1F, 9.0F, 0.0F, 40.0F, 0.0F, false);
		...
		inner_roof_4_r3.setTextureOffset(0, 0).addCuboid(-5.3F, 0.0F, -30.0F, 3.0F, 0.0F, 40.0F, 0.0F, false);
		...
		inner_roof_2_r3.setTextureOffset(525, 0).addCuboid(-4.1F, 0.0F, -30.0F, 6.0F, 0.0F, 40.0F, 0.0F, false);

		head_roof_left = new ModelPart(this);
		head_roof_left.setPivot(-16.95F, -12.875F, -6.1F);
		roof_head.addChild(head_roof_left);
		head_roof_left.setTextureOffset(118, 530).addCuboid(-1.1F, -20.075F, 8.1F, 2.0F, 0.0F, 40.0F, 0.0F, false);
		head_roof_left.setTextureOffset(537, 101).addCuboid(5.95F, -21.925F, 8.1F, 1.0F, 0.0F, 40.0F, 0.0F, false);
		head_roof_left.setTextureOffset(517, 203).addCuboid(8.15F, -24.125F, 8.1F, 9.0F, 0.0F, 40.0F, 0.0F, false);
		...
		inner_roof_4_r4.setTextureOffset(0, 39).addCuboid(2.3F, 0.0F, -30.0F, 3.0F, 0.0F, 40.0F, 0.0F, false);
		...
		inner_roof_2_r4.setTextureOffset(307, 526).addCuboid(-1.9F, 0.0F, -30.0F, 6.0F, 0.0F, 40.0F, 0.0F, false);
		...
		handrail_top_4_r1.setTextureOffset(13, 45).addCuboid(0.0F, -1.0F, 0.5F, 0.0F, 1.0F, 0.0F, 0.2F, true);
		...
		handrail_top_3_r1.setTextureOffset(35, 61).addCuboid(0.0F, 0.0F, -1.5F, 0.0F, 0.0F, 2.0F, 0.2F, true);
		...
		handrail_turn_3_r4.setTextureOffset(45, 39).addCuboid(0.0F, 0.0F, -0.5F, 0.0F, 0.0F, 1.0F, 0.2F, true);
		...
		handrail_turn_2_r4.setTextureOffset(45, 29).addCuboid(0.0F, 0.0F, -2.0F, 0.0F, 0.0F, 2.0F, 0.2F, true);
		...
		handrail_turn_1_r4.setTextureOffset(26, 0).addCuboid(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 3.0F, 0.2F, true);
		...
		handrail_top_8_r1.setTextureOffset(13, 45).addCuboid(0.0F, -1.0F, 0.5F, 0.0F, 1.0F, 0.0F, 0.2F, false);
		...
		handrail_top_3_r2.setTextureOffset(35, 61).addCuboid(0.0F, 0.0F, -1.5F, 0.0F, 0.0F, 2.0F, 0.2F, false);
		...
		handrail_turn_3_r5.setTextureOffset(45, 29).addCuboid(0.0F, 0.0F, -2.0F, 0.0F, 0.0F, 2.0F, 0.2F, false);
		...
		handrail_turn_2_r5.setTextureOffset(26, 0).addCuboid(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 3.0F, 0.2F, false);
		...
		handrail_turn_1_r5.setTextureOffset(45, 39).addCuboid(0.0F, 0.0F, -0.5F, 0.0F, 0.0F, 1.0F, 0.2F, false);
		...
		handle_1_r1.setTextureOffset(20, 53).addCuboid(-4.75F, -21.3769F, 98.3736F, 7.0F, 0.0F, 2.0F, 0.1F, false);
		...
		handle_2_r1.setTextureOffset(20, 53).addCuboid(13.25F, -21.3769F, 98.3736F, 7.0F, 0.0F, 2.0F, 0.1F, false);
		...
		handle_3_r1.setTextureOffset(20, 53).addCuboid(-4.75F, 22.4231F, 98.3736F, 7.0F, 0.0F, 2.0F, 0.1F, false);
		...
		end_handle_exterior_4.setTextureOffset(0, 0).addCuboid(2.0F, 11.818F, 3.0282F, 3.0F, 8.0F, 2.0F, 0.0F, false);
		...
		end_side_right.setTextureOffset(226, 281).addCuboid(0.0F, -41.375F, -40.0F, 3.0F, 0.0F, 7.0F, 0.0F, true);
		...
		outer_right_roof_5_r1.setTextureOffset(0, 164).addCuboid(-6.2645F, -1.1097F, -12.5F, 7.0F, 0.0F, 7.0F, 0.0F, true);
		...
		outer_right_roof_4_r1.setTextureOffset(190, 140).addCuboid(-0.497F, -1.1228F, -12.5F, 6.0F, 0.0F, 7.0F, 0.0F, true);
		...
		outer_right_roof_3_r1.setTextureOffset(78, 230).addCuboid(5.3154F, -1.7351F, -12.5F, 3.0F, 0.0F, 7.0F, 0.0F, true);
		...
		outer_right_roof_2_r1.setTextureOffset(268, 71).addCuboid(6.1006F, -5.8625F, -12.5F, 2.0F, 0.0F, 7.0F, 0.0F, true);
		...
		outer_right_roof_1_r1.setTextureOffset(0, 304).addCuboid(4.9967F, -8.6386F, -12.5F, 1.0F, 0.0F, 7.0F, 0.0F, true);
		...
		end_side_left.setTextureOffset(226, 281).addCuboid(-3.0F, -41.375F, -40.0F, 3.0F, 0.0F, 7.0F, 0.0F, false);
		...
		outer_left_roof_5_r1.setTextureOffset(0, 164).addCuboid(-0.7355F, -1.1097F, -12.5F, 7.0F, 0.0F, 7.0F, 0.0F, false);
		...
		outer_left_roof_4_r1.setTextureOffset(190, 140).addCuboid(-5.503F, -1.1228F, -12.5F, 6.0F, 0.0F, 7.0F, 0.0F, false);
		...
		outer_left_roof_3_r1.setTextureOffset(78, 230).addCuboid(-8.3154F, -1.7351F, -12.5F, 3.0F, 0.0F, 7.0F, 0.0F, false);
		...
		outer_left_roof_2_r1.setTextureOffset(268, 71).addCuboid(-8.1006F, -5.8625F, -12.5F, 2.0F, 0.0F, 7.0F, 0.0F, false);
		...
		outer_left_roof_1_r1.setTextureOffset(0, 304).addCuboid(-5.9967F, -8.6386F, -12.5F, 1.0F, 0.0F, 7.0F, 0.0F, false);
		...
		outer_roof_right.setTextureOffset(226, 281).addCuboid(0.1F, -38.675F, 17.0F, 3.0F, 0.0F, 69.0F, 0.0F, true);
		...
		outer_left_roof_5_r2.setTextureOffset(0, 164).addCuboid(-6.2645F, -1.1097F, -12.5F, 7.0F, 0.0F, 69.0F, 0.0F, true);
		...
		outer_left_roof_4_r2.setTextureOffset(190, 140).addCuboid(-0.497F, -1.1228F, -12.5F, 6.0F, 0.0F, 69.0F, 0.0F, true);
		...
		outer_left_roof_3_r2.setTextureOffset(78, 230).addCuboid(5.3154F, -1.7351F, -12.5F, 3.0F, 0.0F, 69.0F, 0.0F, true);
		...
		outer_left_roof_2_r2.setTextureOffset(268, 71).addCuboid(6.1006F, -5.8625F, -12.5F, 2.0F, 0.0F, 69.0F, 0.0F, true);
		...
		outer_left_roof_1_r2.setTextureOffset(0, 304).addCuboid(4.9967F, -8.6386F, -12.5F, 1.0F, 0.0F, 69.0F, 0.0F, true);

		outer_roof_left = new ModelPart(this);
		outer_roof_left.setPivot(0.1F, -2.7F, -35.0F);
		roof_end_exterior.addChild(outer_roof_left);
		outer_roof_left.setTextureOffset(226, 281).addCuboid(-3.1F, -38.675F, 17.0F, 3.0F, 0.0F, 69.0F, 0.0F, false);
		...
		outer_left_roof_5_r3.setTextureOffset(0, 164).addCuboid(-0.7355F, -1.1097F, -12.5F, 7.0F, 0.0F, 69.0F, 0.0F, false);
		...
		outer_left_roof_4_r3.setTextureOffset(190, 140).addCuboid(-5.503F, -1.1228F, -12.5F, 6.0F, 0.0F, 69.0F, 0.0F, false);
		...
		outer_left_roof_1_r3.setTextureOffset(0, 304).addCuboid(-5.9967F, -8.6386F, -12.5F, 1.0F, 0.0F, 69.0F, 0.0F, false);
		...
		head_light_roof_right.setTextureOffset(228, 534).addCuboid(10.0F, -31.8F, -6.0F, 1.0F, 0.0F, 40.0F, 0.0F, false);
		...
		inner_light_2_r3.setTextureOffset(49, 531).addCuboid(-3.3F, 2.575F, -6.0F, 1.0F, 0.0F, 40.0F, 0.0F, false);
		...
		inner_light_1_r3.setTextureOffset(484, 529).addCuboid(-3.3F, 0.0F, -6.0F, 2.0F, 0.0F, 40.0F, 0.0F, false);
		...
		head_light_roof_left.setTextureOffset(539, 39).addCuboid(-12.0F, -31.8F, -6.0F, 1.0F, 0.0F, 40.0F, 0.0F, false);
		...
		inner_light_2_r4.setTextureOffset(543, 305).addCuboid(2.3F, 2.575F, -6.0F, 1.0F, 0.0F, 40.0F, 0.0F, false);
		...
		inner_light_1_r4.setTextureOffset(527, 530).addCuboid(1.3F, 0.0F, -6.0F, 2.0F, 0.0F, 40.0F, 0.0F, false);
		...
		head.setTextureOffset(102, 164).addCuboid(19.3F, -13.0F, 2.0F, 2.0F, 15.0F, 9.0F, 0.0F, false);
		head.setTextureOffset(78, 164).addCuboid(-21.3F, -13.0F, 2.0F, 2.0F, 15.0F, 9.0F, 0.0F, false);
		head.setTextureOffset(341, 0).addCuboid(-19.5F, -37.0F, 2.1F, 13.0F, 37.0F, 0.0F, 0.0F, false);
		head.setTextureOffset(340, 211).addCuboid(6.5F, -37.0F, 2.1F, 13.0F, 37.0F, 0.0F, 0.0F, false);
		head.setTextureOffset(111, 152).addCuboid(-6.5F, -37.0F, 2.1F, 13.0F, 3.0F, 0.0F, 0.0F, false);
		head.setTextureOffset(370, 281).addCuboid(-21.0F, 0.0F, -20.0F, 42.0F, 1.0F, 28.0F, 0.0F, false);
		...
		front_cab_left_1_r1.setTextureOffset(0, 164).addCuboid(-1.925F, -25.0F, 28.0F, 2.0F, 23.0F, 9.0F, 0.0F, false);
		...
		front_cab_right_2_r1.setTextureOffset(32, 164).addCuboid(-0.075F, -25.0F, 28.0F, 2.0F, 23.0F, 9.0F, 0.0F, false);

		cab_door_back = new ModelPart(this);
		cab_door_back.setPivot(-6.5F, 0.0F, -2.5F);
		head.addChild(cab_door_back);
		cab_door_back.setTextureOffset(0, 374).addCuboid(0.0F, -34.0F, 4.6F, 13.0F, 34.0F, 0.0F, 0.0F, false);
		...
		end_wall_4_r1.setTextureOffset(19, 164).addCuboid(-0.925F, -23.0F, 57.1F, 1.0F, 21.0F, 2.0F, 0.0F, false);
		...
		end_wall_2_r1.setTextureOffset(51, 164).addCuboid(-0.075F, -23.0F, 57.1F, 1.0F, 21.0F, 2.0F, 0.0F, false);
		...
		bottom.setTextureOffset(127, 76).addCuboid(-21.5F, 0.0F, -18.0F, 43.0F, 3.0F, 2.0F, 0.0F, false);
		...
		front.setTextureOffset(32, 110).addCuboid(-7.2F, -42.0F, -22.025F, 14.0F, 9.0F, 0.0F, 0.0F, false);
		front.setTextureOffset(401, 403).addCuboid(6.05F, -33.0F, -22.275F, 0.0F, 35.0F, 6.0F, 0.0F, false);
		front.setTextureOffset(400, 0).addCuboid(-6.3F, -33.0F, -22.275F, 0.0F, 35.0F, 6.0F, 0.0F, false);
		...
		cab_door.setTextureOffset(224, 70).addCuboid(-6.5F, -32.0F, -16.9F, 13.0F, 33.0F, 0.0F, 0.0F, false);
		cab_door.setTextureOffset(159, 0).addCuboid(-8.0F, -25.0F, -22.4F, 16.0F, 18.0F, 0.0F, 0.0F, false);
		...
		handle_1_r2.setTextureOffset(20, 53).addCuboid(-4.75F, -22.3769F, 81.3736F, 7.0F, 0.0F, 2.0F, 0.1F, false);
		...
		handle_2_r2.setTextureOffset(20, 53).addCuboid(13.25F, -22.3769F, 81.3736F, 7.0F, 0.0F, 2.0F, 0.1F, false);
		...
		handle_3_r2.setTextureOffset(20, 53).addCuboid(-4.75F, -36.6269F, 81.3736F, 7.0F, 0.0F, 2.0F, 0.1F, false);
		...
		front_handle_exterior_4.setTextureOffset(0, 0).addCuboid(15.3166F, -38.9798F, 35.2707F, 0.0F, 8.0F, 1.0F, 0.1F, false);
		...
		front_handle_exterior_5.setTextureOffset(0, 0).addCuboid(15.3162F, -38.0211F, 35.2462F, 0.0F, 8.0F, 1.0F, 0.1F, false);
		...
		front_handle_exterior_6.setTextureOffset(0, 0).addCuboid(-81.1F, -60.0F, 4.1F, 0.0F, 8.0F, 1.0F, 0.1F, false);
		...
		front_handle_exterior_7.setTextureOffset(0, 0).addCuboid(2.0F, 11.1F, 0.2F, 3.0F, 8.0F, 2.0F, 0.0F, false);

		side_right = new ModelPart(this);
		side_right.setPivot(0.0F, 0.0F, 0.0F);
		head_exterior.addChild(side_right);
		side_right.setTextureOffset(0, 90).addCuboid(19.5F, -13.0F, 9.025F, 2.0F, 13.0F, 0.0F, 0.0F, false);
		side_right.setTextureOffset(266, 211).addCuboid(21.5F, 0.0F, -22.0F, 0.0F, 4.0F, 30.0F, 0.0F, false);
		side_right.setTextureOffset(0, 164).addCuboid(21.5F, -13.0F, -22.0F, 0.0F, 13.0F, 33.0F, 0.0F, false);
		side_right.setTextureOffset(226, 281).addCuboid(0.0F, -41.375F, -25.0F, 3.0F, 0.0F, 7.0F, 0.0F, true);
		...
		outer_right_roof_5_r2.setTextureOffset(0, 164).addCuboid(-6.2645F, -1.1097F, -12.5F, 7.0F, 0.0F, 7.0F, 0.0F, true);
		...
		outer_right_roof_4_r2.setTextureOffset(190, 140).addCuboid(-0.497F, -1.1228F, -12.5F, 6.0F, 0.0F, 7.0F, 0.0F, true);
		...
		outer_right_roof_3_r2.setTextureOffset(78, 230).addCuboid(5.3154F, -1.7351F, -12.5F, 3.0F, 0.0F, 7.0F, 0.0F, true);
		...
		outer_right_roof_2_r2.setTextureOffset(268, 71).addCuboid(6.1006F, -5.8625F, -12.5F, 2.0F, 0.0F, 7.0F, 0.0F, true);
		...
		outer_right_roof_1_r2.setTextureOffset(0, 304).addCuboid(4.9967F, -8.6386F, -12.5F, 1.0F, 0.0F, 7.0F, 0.0F, true);
		...
		side_left.setTextureOffset(5, 90).addCuboid(-21.5F, -13.0F, 9.025F, 2.0F, 13.0F, 0.0F, 0.0F, false);
		side_left.setTextureOffset(0, 266).addCuboid(-21.5F, 0.0F, -22.0F, 0.0F, 4.0F, 30.0F, 0.0F, false);
		side_left.setTextureOffset(127, 0).addCuboid(-21.5F, -13.0F, -22.0F, 0.0F, 13.0F, 33.0F, 0.0F, false);
		side_left.setTextureOffset(226, 281).addCuboid(-3.0F, -41.375F, -25.0F, 3.0F, 0.0F, 7.0F, 0.0F, false);
		...
		outer_left_roof_5_r4.setTextureOffset(0, 164).addCuboid(-0.7355F, -1.1097F, -12.5F, 7.0F, 0.0F, 7.0F, 0.0F, false);
		...
		outer_left_roof_4_r4.setTextureOffset(190, 140).addCuboid(-5.503F, -1.1228F, -12.5F, 6.0F, 0.0F, 7.0F, 0.0F, false);
		...
		outer_left_roof_3_r4.setTextureOffset(78, 230).addCuboid(-8.3154F, -1.7351F, -12.5F, 3.0F, 0.0F, 7.0F, 0.0F, false);
		...
		outer_left_roof_2_r4.setTextureOffset(268, 71).addCuboid(-8.1006F, -5.8625F, -12.5F, 2.0F, 0.0F, 7.0F, 0.0F, false);
		...
		outer_left_roof_1_r4.setTextureOffset(0, 304).addCuboid(-5.9967F, -8.6386F, -12.5F, 1.0F, 0.0F, 7.0F, 0.0F, false);
		...
		bottom_panel.setTextureOffset(285, 352).addCuboid(-21.5F, 3.0F, -21.0F, 43.0F, 0.0F, 27.0F, 0.0F, false);
		...
		headlight_2_r1.setPivot(-11.5F, -5.3978F, -24.4F);
		...
		headlight_1_r1.setPivot(11.5F, -6.3978F, -24.4F);
		...
		tail_light_2_r1.setPivot(-17.35F, -8.9978F, -22.8F);
		...
		tail_light_1_r1.setPivot(17.35F, -9.9978F, -22.8F);
		...
		letter_display.setTextureOffset(20, 8).addCuboid(-3.5F, -40.75F, -25.175F, 7.0F, 6.0F, 0.0F, 0.0F, false);
