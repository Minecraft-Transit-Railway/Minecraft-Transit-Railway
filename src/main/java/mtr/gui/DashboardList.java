...
public class DashboardList implements IGui {
	...
	public <T> DashboardList(AddChild addChild, OnClick onFind, OnClick onDrawArea, OnClick onEdit, Runnable onSort, OnClick onAdd, OnClick onDelete, GetList<T> getList, Supplier<String> getSearch, Consumer<String> setSearch) {
