...
public class EditStationScreen extends EditNameColorScreenBase<Station> {
	...
	public EditStationScreen(Station station, DashboardScreen dashboardScreen) {
		...
		exitParentList = new DashboardList(this::addDrawableChild, null, null, this::onEditExitParent, null, null, this::onDeleteExitParent, null, () -> ClientData.EXIT_PARENTS_SEARCH, text -> ClientData.EXIT_PARENTS_SEARCH = text);
		exitDestinationList = new DashboardList(this::addDrawableChild, null, null, this::onEditExitDestination, this::onSortExitDestination, null, this::onDeleteExitDestination, this::getExitDestinationList, () -> ClientData.EXIT_DESTINATIONS_SEARCH, text -> ClientData.EXIT_DESTINATIONS_SEARCH = text);
	}
