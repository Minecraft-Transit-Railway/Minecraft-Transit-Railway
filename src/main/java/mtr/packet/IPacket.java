...
public interface IPacket {
	...
	Identifier PACKET_OPEN_SCHEDULE_SENSOR_SCREEN = new Identifier(MTR.MOD_ID, "packet_open_schedule_sensor_screen");
	...
	Identifier PACKET_SCHEDULE_SENSOR_UPDATE = new Identifier(MTR.MOD_ID, "packet_schedule_sensor_update");
