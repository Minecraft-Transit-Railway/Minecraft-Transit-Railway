...
public class MTRClient implements ClientModInitializer, IPacket {
	...
	public void onInitializeClient() {
		...
		BlockEntityRendererRegistry.INSTANCE.register(MTR.PIDS_3_TILE_ENTITY, dispatcher -> new RenderPIDS<>(dispatcher, 2, 1.5F, 7.95F, 5, 7.1F, 29, true, true, false, 0xFC5268, 0x66A508, 1.32F, true));
