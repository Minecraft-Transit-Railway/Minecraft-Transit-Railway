...
public class MTRClient implements ClientModInitializer, IPacket {
	...
	public void onInitializeClient() {
		...
		BlockEntityRendererRegistry.INSTANCE.register(MTR.PIDS_3_TILE_ENTITY, dispatcher -> new RenderPIDS<>(dispatcher, 2, 1.5F, 8.0F, 6, 7.5F, 29, true, true, false, 0xFF5E69, 1.35F, 0x599307,true));
