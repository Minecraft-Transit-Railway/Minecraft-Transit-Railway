...
public class MTRClient implements ClientModInitializer, IPacket {
	...
	public void onInitializeClient() {
		...
		UtilitiesClient.registerNodeModifierPredicate(Items.RAIL_CONNECTOR_1_WOODEN);
		UtilitiesClient.registerNodeModifierPredicate(Items.RAIL_CONNECTOR_1_WOODEN_ONE_WAY);
		UtilitiesClient.registerNodeModifierPredicate(Items.RAIL_CONNECTOR_2_STONE);
		UtilitiesClient.registerNodeModifierPredicate(Items.RAIL_CONNECTOR_2_STONE_ONE_WAY);
		UtilitiesClient.registerNodeModifierPredicate(Items.RAIL_CONNECTOR_3_IRON);
		UtilitiesClient.registerNodeModifierPredicate(Items.RAIL_CONNECTOR_3_IRON_ONE_WAY);
		UtilitiesClient.registerNodeModifierPredicate(Items.RAIL_CONNECTOR_4_OBSIDIAN);
		UtilitiesClient.registerNodeModifierPredicate(Items.RAIL_CONNECTOR_4_OBSIDIAN_ONE_WAY);
		UtilitiesClient.registerNodeModifierPredicate(Items.RAIL_CONNECTOR_5_BLAZE);
		UtilitiesClient.registerNodeModifierPredicate(Items.RAIL_CONNECTOR_5_BLAZE_ONE_WAY);
		UtilitiesClient.registerNodeModifierPredicate(Items.RAIL_CONNECTOR_6_DIAMOND);
		UtilitiesClient.registerNodeModifierPredicate(Items.RAIL_CONNECTOR_6_DIAMOND_ONE_WAY);
		UtilitiesClient.registerNodeModifierPredicate(Items.RAIL_CONNECTOR_PLATFORM);
		UtilitiesClient.registerNodeModifierPredicate(Items.RAIL_CONNECTOR_SIDING);
		UtilitiesClient.registerNodeModifierPredicate(Items.RAIL_CONNECTOR_TURN_BACK);
		UtilitiesClient.registerNodeModifierPredicate(Items.RAIL_REMOVER);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_CONNECTOR_WHITE);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_CONNECTOR_ORANGE);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_CONNECTOR_MAGENTA);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_CONNECTOR_LIGHT_BLUE);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_CONNECTOR_YELLOW);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_CONNECTOR_LIME);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_CONNECTOR_PINK);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_CONNECTOR_GRAY);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_CONNECTOR_LIGHT_GRAY);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_CONNECTOR_CYAN);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_CONNECTOR_PURPLE);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_CONNECTOR_BLUE);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_CONNECTOR_BROWN);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_CONNECTOR_GREEN);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_CONNECTOR_RED);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_CONNECTOR_BLACK);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_REMOVER_WHITE);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_REMOVER_ORANGE);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_REMOVER_MAGENTA);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_REMOVER_LIGHT_BLUE);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_REMOVER_YELLOW);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_REMOVER_LIME);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_REMOVER_PINK);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_REMOVER_GRAY);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_REMOVER_LIGHT_GRAY);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_REMOVER_CYAN);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_REMOVER_PURPLE);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_REMOVER_BLUE);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_REMOVER_BROWN);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_REMOVER_GREEN);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_REMOVER_RED);
		UtilitiesClient.registerNodeModifierPredicate(Items.SIGNAL_REMOVER_BLACK);

		UtilitiesClient.registerTileEntityRenderer(MTR.ARRIVAL_PROJECTOR_1_SMALL_TILE_ENTITY, dispatcher -> new RenderPIDS<>(dispatcher, 12, 1, 15, 16, 14, 14, false, false, true, 0xFF9900, 0xFF9900));
		UtilitiesClient.registerTileEntityRenderer(MTR.ARRIVAL_PROJECTOR_1_MEDIUM_TILE_ENTITY, dispatcher -> new RenderPIDS<>(dispatcher, 12, -15, 15, 16, 30, 46, false, false, true, 0xFF9900, 0xFF9900));
		UtilitiesClient.registerTileEntityRenderer(MTR.ARRIVAL_PROJECTOR_1_LARGE_TILE_ENTITY, dispatcher -> new RenderPIDS<>(dispatcher, 16, -15, 15, 16, 46, 46, false, false, true, 0xFF9900, 0xFF9900));
		...
		UtilitiesClient.registerTileEntityRenderer(MTR.PIDS_1_TILE_ENTITY, dispatcher -> new RenderPIDS<>(dispatcher, BlockPIDS1.TileEntityBlockPIDS1.MAX_ARRIVALS, 1, 3.25F, 6, 2.5F, 30, true, false, false, 0xFF9900, 0xFF9900));
		UtilitiesClient.registerTileEntityRenderer(MTR.PIDS_2_TILE_ENTITY, dispatcher -> new RenderPIDS<>(dispatcher, BlockPIDS2.TileEntityBlockPIDS2.MAX_ARRIVALS, 1.5F, 7.5F, 6, 6.5F, 29, true, true, false, 0xFF9900, 0xFF9900));
		UtilitiesClient.registerTileEntityRenderer(MTR.PIDS_3_TILE_ENTITY, dispatcher -> new RenderPIDS<>(dispatcher, BlockPIDS3.TileEntityBlockPIDS3.MAX_ARRIVALS, 2.5F, 7.5F, 6, 6.5F, 27, true, false, false, 0xFF9900, 0x33CC00, 1.25F, true));
		...
		UtilitiesClient.registerTileEntityRenderer(MTR.SIGNAL_LIGHT_1, dispatcher -> new RenderSignalLight<>(dispatcher, true, false, 0xFF0000FF));
		UtilitiesClient.registerTileEntityRenderer(MTR.SIGNAL_LIGHT_2, dispatcher -> new RenderSignalLight<>(dispatcher, false, false, 0xFF0000FF));
		UtilitiesClient.registerTileEntityRenderer(MTR.SIGNAL_LIGHT_3, dispatcher -> new RenderSignalLight<>(dispatcher, true, true, 0xFF00FF00));
		UtilitiesClient.registerTileEntityRenderer(MTR.SIGNAL_LIGHT_4, dispatcher -> new RenderSignalLight<>(dispatcher, false, true, 0xFF00FF00));
		UtilitiesClient.registerTileEntityRenderer(MTR.SIGNAL_SEMAPHORE_1, dispatcher -> new RenderSignalSemaphore<>(dispatcher, true));
		UtilitiesClient.registerTileEntityRenderer(MTR.SIGNAL_SEMAPHORE_2, dispatcher -> new RenderSignalSemaphore<>(dispatcher, false));
