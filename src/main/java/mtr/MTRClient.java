...
public class MTRClient implements ClientModInitializer, IPacket {
	...
	public void onInitializeClient() {
		...
		ClientPlayNetworking.registerGlobalReceiver(PACKET_OPEN_PSD_FILTER_SCREEN, (minecraftClient, handler, packet, sender) -> PacketTrainDataGuiClient.openPSDFilterScreenS2C(minecraftClient, packet));
