...
public interface Blocks {
	...
	Block STATION_COLOR_CONCRETE = new BlockStationColor(FabricBlockSettings.of(Material.STONE, MaterialColor.IRON).requiresTool().hardness(2));
	...
	Block STATION_COLOR_DARK_PRISMARINE = new BlockStationColor(FabricBlockSettings.of(Material.STONE, MaterialColor.IRON).requiresTool().hardness(2));
	Block STATION_COLOR_DIORITE = new BlockStationColor(FabricBlockSettings.of(Material.STONE, MaterialColor.IRON).requiresTool().hardness(2));
	Block STATION_COLOR_IRON_BLOCK = new BlockStationColor(FabricBlockSettings.of(Material.METAL, MaterialColor.IRON).requiresTool().hardness(2));
	Block STATION_COLOR_METAL = new BlockStationColor(FabricBlockSettings.of(Material.METAL, MaterialColor.IRON).requiresTool().hardness(2));
	Block STATION_COLOR_PLANKS = new BlockStationColor(FabricBlockSettings.of(Material.WOOD, MaterialColor.IRON).hardness(2));
	Block STATION_COLOR_POLISHED_DIORITE = new BlockStationColor(FabricBlockSettings.of(Material.STONE, MaterialColor.IRON).requiresTool().hardness(2));
	...
	Block STATION_COLOR_STONE = new BlockStationColor(FabricBlockSettings.of(Material.STONE, MaterialColor.IRON).requiresTool().hardness(2));
	Block STATION_COLOR_STONE_BRICKS = new BlockStationColor(FabricBlockSettings.of(Material.STONE, MaterialColor.IRON).requiresTool().hardness(2));
