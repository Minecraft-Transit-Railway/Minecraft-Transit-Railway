...
public final class InitClient {
	...
	public static void init() {
		...
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_20, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_20_ONE_WAY, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_40, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_40_ONE_WAY, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_60, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_60_ONE_WAY, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_80, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_80_ONE_WAY, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_120, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_120_ONE_WAY, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_160, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_160_ONE_WAY, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_200, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_200_ONE_WAY, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_300, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_300_ONE_WAY, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_PLATFORM, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_SIDING, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_TURN_BACK, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_CABLE_CAR, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_CONNECTOR_RUNWAY, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.RAIL_REMOVER, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_CONNECTOR_WHITE, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_CONNECTOR_ORANGE, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_CONNECTOR_MAGENTA, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_CONNECTOR_LIGHT_BLUE, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_CONNECTOR_YELLOW, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_CONNECTOR_LIME, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_CONNECTOR_PINK, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_CONNECTOR_GRAY, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_CONNECTOR_LIGHT_GRAY, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_CONNECTOR_CYAN, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_CONNECTOR_PURPLE, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_CONNECTOR_BLUE, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_CONNECTOR_BROWN, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_CONNECTOR_GREEN, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_CONNECTOR_RED, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_CONNECTOR_BLACK, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_REMOVER_WHITE, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_REMOVER_ORANGE, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_REMOVER_MAGENTA, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_REMOVER_LIGHT_BLUE, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_REMOVER_YELLOW, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_REMOVER_LIME, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_REMOVER_PINK, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_REMOVER_GRAY, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_REMOVER_LIGHT_GRAY, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_REMOVER_CYAN, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_REMOVER_PURPLE, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_REMOVER_BLUE, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_REMOVER_BROWN, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_REMOVER_GREEN, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_REMOVER_RED, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.SIGNAL_REMOVER_BLACK, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.BRIDGE_CREATOR_3, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.BRIDGE_CREATOR_5, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.BRIDGE_CREATOR_7, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.BRIDGE_CREATOR_9, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_CREATOR_4_3, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_CREATOR_4_5, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_CREATOR_4_7, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_CREATOR_4_9, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_CREATOR_5_3, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_CREATOR_5_5, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_CREATOR_5_7, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_CREATOR_5_9, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_CREATOR_6_3, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_CREATOR_6_5, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_CREATOR_6_7, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_CREATOR_6_9, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_WALL_CREATOR_4_3, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_WALL_CREATOR_4_5, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_WALL_CREATOR_4_7, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_WALL_CREATOR_4_9, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_WALL_CREATOR_5_3, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_WALL_CREATOR_5_5, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_WALL_CREATOR_5_7, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_WALL_CREATOR_5_9, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_WALL_CREATOR_6_3, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_WALL_CREATOR_6_5, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_WALL_CREATOR_6_7, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.TUNNEL_WALL_CREATOR_6_9, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.LIFT_BUTTONS_LINK_CONNECTOR, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		RegistryClient.registerItemModelPredicate(Items.LIFT_BUTTONS_LINK_REMOVER, new Identifier(MTR.MOD_ID, "selected"), checkItemPredicateTag());
		...
		RegistryClient.setupPackets(new Identifier(MTR.MOD_ID, "packet"));
